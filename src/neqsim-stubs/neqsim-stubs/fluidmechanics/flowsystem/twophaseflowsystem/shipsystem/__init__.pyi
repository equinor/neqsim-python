...
class LNGship(neqsim.fluidmechanics.flowsystem.twophaseflowsystem.TwoPhaseFlowSystem):
    ...
    def getStandardISO6976(self) -> neqsim.standards.gasquality.Standard_ISO6976: ...
    ...
    def setStandardISO6976(self, standard_ISO6976: neqsim.standards.gasquality.Standard_ISO6976) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.fluidmechanics.flowsystem.twophaseflowsystem.shipsystem")``.
