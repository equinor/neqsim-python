...
import neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.equilibriumfluidboundary
import neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.finitevolumeboundary
import neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary
import neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary.filmmodelboundary.reactivefilmmodel.enhancementfactor
...
class FluidBoundaryInterface(java.lang.Cloneable):
    ...
    def getBulkSystemOpertions(self) -> neqsim.thermodynamicoperations.ThermodynamicOperations: ...
    def getEffectiveMassTransferCoefficient(self, int: int, int2: int) -> float: ...
    def getEnhancementFactor(self) -> neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary.filmmodelboundary.reactivefilmmodel.enhancementfactor.EnhancementFactor: ...
...
class FluidBoundary(FluidBoundaryInterface, java.io.Serializable):
    ...
    def getInterphaseHeatFlux(self, int: int) -> float: ...
    def getInterphaseMolarFlux(self, int: int) -> float: ...
    def getInterphaseOpertions(self) -> neqsim.thermodynamicoperations.ThermodynamicOperations: ...
    def getInterphaseSystem(self) -> neqsim.thermo.system.SystemInterface: ...
    def getMassTransferCoefficientMatrix(self) -> typing.MutableSequence[Jama.Matrix]: ...
    def heatTransSolve(self) -> None: ...
    def init(self) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc")``.

    FluidBoundary: typing.Type[FluidBoundary]
    FluidBoundaryInterface: typing.Type[FluidBoundaryInterface]
    equilibriumfluidboundary: neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.equilibriumfluidboundary.__module_protocol__
    finitevolumeboundary: neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.finitevolumeboundary.__module_protocol__
    nonequilibriumfluidboundary: neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary.__module_protocol__
