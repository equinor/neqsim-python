...
class NonEquilibriumFluidBoundary(neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.FluidBoundary):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary")``.

    NonEquilibriumFluidBoundary: typing.Type[NonEquilibriumFluidBoundary]
    filmmodelboundary: neqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary.filmmodelboundary.__module_protocol__
