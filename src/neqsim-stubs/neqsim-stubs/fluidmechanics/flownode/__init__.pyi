...
import java.lang
import jpype
import neqsim.fluidmechanics.flownode.fluidboundary
...
class FlowNodeInterface(java.lang.Cloneable):
    ...
    def getGeometry(self) -> neqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface: ...
    ...
    def getInterphaseSystem(self) -> neqsim.thermo.system.SystemInterface: ...
    def getInterphaseTransportCoefficient(self) -> neqsim.fluidmechanics.flownode.fluidboundary.interphasetransportcoefficient.InterphaseTransportCoefficientInterface: ...
    ...
    def getOperations(self) -> neqsim.thermodynamicoperations.ThermodynamicOperations: ...
    ...
    @typing.overload
    def getVelocityIn(self, int: int) -> neqsim.util.util.DoubleCloneable: ...
    @typing.overload
    def getVelocityIn(self) -> neqsim.util.util.DoubleCloneable: ...
    @typing.overload
    def getVelocityOut(self, int: int) -> neqsim.util.util.DoubleCloneable: ...
    @typing.overload
    def getVelocityOut(self) -> neqsim.util.util.DoubleCloneable: ...
    ...
    def setBulkSystem(self, systemInterface: neqsim.thermo.system.SystemInterface) -> None: ...
    ...
    def setGeometryDefinitionInterface(self, geometryDefinitionInterface: neqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface) -> None: ...
    def setInterphaseModelType(self, int: int) -> None: ...
    def setInterphaseSystem(self, systemInterface: neqsim.thermo.system.SystemInterface) -> None: ...
    ...
    @typing.overload
    def setVelocityIn(self, int: int, doubleCloneable: neqsim.util.util.DoubleCloneable) -> None: ...
    @typing.overload
    def setVelocityIn(self, double: float) -> None: ...
    @typing.overload
    def setVelocityIn(self, doubleCloneable: neqsim.util.util.DoubleCloneable) -> None: ...
    @typing.overload
    def setVelocityOut(self, int: int, double: float) -> None: ...
    @typing.overload
    def setVelocityOut(self, int: int, doubleCloneable: neqsim.util.util.DoubleCloneable) -> None: ...
    @typing.overload
    def setVelocityOut(self, double: float) -> None: ...
    @typing.overload
    def setVelocityOut(self, doubleCloneable: neqsim.util.util.DoubleCloneable) -> None: ...
...
class FlowNode(FlowNodeInterface, neqsim.thermo.ThermodynamicConstantsInterface):
    ...
    bulkSystem: neqsim.thermo.system.SystemInterface = ...
    velocityIn: typing.MutableSequence[neqsim.util.util.DoubleCloneable] = ...
    velocityOut: typing.MutableSequence[neqsim.util.util.DoubleCloneable] = ...
    superficialVelocity: typing.MutableSequence[float] = ...
    interphaseContactArea: float = ...
    velocity: typing.MutableSequence[float] = ...
    pipe: neqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, geometryDefinitionInterface: neqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface, double: float, double2: float): ...
    def calcFluxes(self) -> None: ...
    def calcNusseltNumber(self, double: float, int: int) -> float: ...
    def calcSherwoodNumber(self, double: float, int: int) -> float: ...
    def calcStantonNumber(self, double: float, int: int) -> float: ...
    ...
    def setInterphaseSystem(self, systemInterface: neqsim.thermo.system.SystemInterface) -> None: ...
    def setLengthOfNode(self, double: float) -> None: ...
    def setOperations(self, thermodynamicOperations: neqsim.thermodynamicoperations.ThermodynamicOperations) -> None: ...
    def setPhaseFraction(self, int: int, double: float) -> None: ...
    @typing.overload
    def setVelocity(self, double: float) -> None: ...
    @typing.overload
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.fluidmechanics.flownode")``.
    ...
    fluidboundary: neqsim.fluidmechanics.flownode.fluidboundary.__module_protocol__
    multiphasenode: neqsim.fluidmechanics.flownode.multiphasenode.__module_protocol__
    onephasenode: neqsim.fluidmechanics.flownode.onephasenode.__module_protocol__
    twophasenode: neqsim.fluidmechanics.flownode.twophasenode.__module_protocol__
