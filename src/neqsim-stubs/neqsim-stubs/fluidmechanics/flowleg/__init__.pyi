...
import java.io
import java.lang
import neqsim.fluidmechanics.flowleg.pipeleg
...
class FlowLegInterface:
    ...
    def setEquipmentGeometry(self, geometryDefinitionInterface: neqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.fluidmechanics.flowleg")``.

    FlowLeg: typing.Type[FlowLeg]
    FlowLegInterface: typing.Type[FlowLegInterface]
    pipeleg: neqsim.fluidmechanics.flowleg.pipeleg.__module_protocol__
