...
class PipelineMechanicalDesign(neqsim.process.mechanicaldesign.MechanicalDesign):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.mechanicaldesign.pipeline")``.
