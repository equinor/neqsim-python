...
class AbsorberMechanicalDesign(neqsim.process.mechanicaldesign.separator.SeparatorMechanicalDesign):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.mechanicaldesign.absorber")``.
