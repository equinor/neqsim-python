...
class SeparatorFireExposure:
    @staticmethod
    def applyFireHeating(separator: neqsim.process.equipment.separator.Separator, fireExposureResult: 'SeparatorFireExposure.FireExposureResult', double: float) -> float: ...
    @typing.overload
    @staticmethod
    def evaluate(separator: neqsim.process.equipment.separator.Separator, fireScenarioConfig: 'SeparatorFireExposure.FireScenarioConfig') -> 'SeparatorFireExposure.FireExposureResult': ...
    @typing.overload
    @staticmethod
    def evaluate(separator: neqsim.process.equipment.separator.Separator, fireScenarioConfig: 'SeparatorFireExposure.FireScenarioConfig', flare: neqsim.process.equipment.flare.Flare, double: float) -> 'SeparatorFireExposure.FireExposureResult': ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.util.fire")``.
