...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.util.example")``.
    ...
    IntegratedSafetySystemWithLogicExample: typing.Type[IntegratedSafetySystemWithLogicExample]
    ...
    SeparatorFireDepressurizationExample: typing.Type[SeparatorFireDepressurizationExample]
