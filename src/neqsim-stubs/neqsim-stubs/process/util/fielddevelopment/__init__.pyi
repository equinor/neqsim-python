...
class FacilityCapacity(java.io.Serializable):
    ...
    def analyzeOverFieldLife(self, productionForecast: 'ProductionProfile.ProductionForecast', streamInterface: neqsim.process.equipment.stream.StreamInterface) -> java.util.List['FacilityCapacity.CapacityPeriod']: ...
    def assess(self, streamInterface: neqsim.process.equipment.stream.StreamInterface, double: float, double2: float, string: typing.Union[java.lang.String, str]) -> 'FacilityCapacity.CapacityAssessment': ...
    ...
    def compareDebottleneckScenarios(self, streamInterface: neqsim.process.equipment.stream.StreamInterface, list: java.util.List['FacilityCapacity.DebottleneckOption'], double: float, double2: float, string: typing.Union[java.lang.String, str]) -> neqsim.process.util.optimization.ProductionOptimizer.ScenarioComparisonResult: ...
    def getFacility(self) -> neqsim.process.processmodel.ProcessSystem: ...
    ...
    class CapacityAssessment(java.io.Serializable):
        ...
        def getUtilizationRecords(self) -> java.util.List[neqsim.process.util.optimization.ProductionOptimizer.UtilizationRecord]: ...
...
class ProductionProfile(java.io.Serializable):
    ...
    def forecast(self, streamInterface: neqsim.process.equipment.stream.StreamInterface, declineParameters: 'ProductionProfile.DeclineParameters', double: float, double2: float, double3: float, double4: float, double5: float) -> 'ProductionProfile.ProductionForecast': ...
    def getFacility(self) -> neqsim.process.processmodel.ProcessSystem: ...
...
class SensitivityAnalysis(java.io.Serializable):
    ...
    def __init__(self, processSystem: neqsim.process.processmodel.ProcessSystem): ...
    @typing.overload
    def __init__(self, processSystem: neqsim.process.processmodel.ProcessSystem, random: java.util.Random): ...
    ...
    class UncertainParameter(java.io.Serializable):
        def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, distributionType: 'SensitivityAnalysis.DistributionType', string2: typing.Union[java.lang.String, str], biConsumer: typing.Union[java.util.function.BiConsumer[neqsim.process.processmodel.ProcessSystem, float], typing.Callable[[neqsim.process.processmodel.ProcessSystem, float], None]]): ...
        ...
        @staticmethod
        def lognormal(string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, biConsumer: typing.Union[java.util.function.BiConsumer[neqsim.process.processmodel.ProcessSystem, float], typing.Callable[[neqsim.process.processmodel.ProcessSystem, float], None]]) -> 'SensitivityAnalysis.UncertainParameter': ...
        @staticmethod
        ...
        def triangular(string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, biConsumer: typing.Union[java.util.function.BiConsumer[neqsim.process.processmodel.ProcessSystem, float], typing.Callable[[neqsim.process.processmodel.ProcessSystem, float], None]]) -> 'SensitivityAnalysis.UncertainParameter': ...
        @staticmethod
        def uniform(string: typing.Union[java.lang.String, str], double: float, double2: float, biConsumer: typing.Union[java.util.function.BiConsumer[neqsim.process.processmodel.ProcessSystem, float], typing.Callable[[neqsim.process.processmodel.ProcessSystem, float], None]]) -> 'SensitivityAnalysis.UncertainParameter': ...

class WellScheduler(java.io.Serializable):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, simpleReservoir: neqsim.process.equipment.reservoir.SimpleReservoir, processSystem: neqsim.process.processmodel.ProcessSystem): ...
    ...
    def getFacility(self) -> neqsim.process.processmodel.ProcessSystem: ...
    def getReservoir(self) -> neqsim.process.equipment.reservoir.SimpleReservoir: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.util.fielddevelopment")``.
