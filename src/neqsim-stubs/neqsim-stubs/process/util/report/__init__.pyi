...
import neqsim.process.util.report.safety
...
class Report:
    @typing.overload
    def __init__(self, processEquipmentBaseClass: neqsim.process.equipment.ProcessEquipmentBaseClass): ...
    @typing.overload
    def __init__(self, processModel: neqsim.process.processmodel.ProcessModel): ...
    @typing.overload
    def __init__(self, processModule: neqsim.process.processmodel.ProcessModule): ...
    @typing.overload
    def __init__(self, processModuleBaseClass: neqsim.process.processmodel.ProcessModuleBaseClass): ...
    @typing.overload
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.util.report")``.

    Report: typing.Type[Report]
    ReportConfig: typing.Type[ReportConfig]
    safety: neqsim.process.util.report.safety.__module_protocol__
