...
import neqsim.process.safety.dto
import typing
...
class DisposalNetwork(java.io.Serializable):
    def __init__(self): ...
    def evaluate(self, list: java.util.List['ProcessSafetyLoadCase']) -> neqsim.process.safety.dto.DisposalNetworkSummaryDTO: ...
    def mapSourceToDisposal(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    def registerDisposalUnit(self, flare: neqsim.process.equipment.flare.Flare) -> None: ...
...
class ProcessSafetyAnalyzer(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, processSystem: neqsim.process.processmodel.ProcessSystem, processSafetyResultRepository: typing.Union['ProcessSafetyResultRepository', typing.Callable]): ...
    ...
    @typing.overload
    def analyze(self) -> neqsim.process.safety.dto.DisposalNetworkSummaryDTO: ...
...
class ProcessSafetyScenario(java.io.Serializable):
    def applyTo(self, processSystem: neqsim.process.processmodel.ProcessSystem) -> None: ...
    @staticmethod
    ...
    def getCustomManipulators(self) -> java.util.Map[java.lang.String, java.util.function.Consumer[neqsim.process.equipment.ProcessEquipmentInterface]]: ...
    def getName(self) -> java.lang.String: ...
    ...
    class Builder:
        ...
        def customManipulator(self, string: typing.Union[java.lang.String, str], consumer: typing.Union[java.util.function.Consumer[neqsim.process.equipment.ProcessEquipmentInterface], typing.Callable[[neqsim.process.equipment.ProcessEquipmentInterface], None]]) -> 'ProcessSafetyScenario.Builder': ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.safety")``.
    ...
    dto: neqsim.process.safety.dto.__module_protocol__
