...
class HeaterInterface(neqsim.process.SimulationInterface):
...
class MultiStreamHeatExchangerInterface(neqsim.process.equipment.ProcessEquipmentInterface):
    def addInStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    ...
    def setFeedStream(self, int: int, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
...
class ReBoiler(neqsim.process.equipment.TwoPortEquipment):
...
class Heater(neqsim.process.equipment.TwoPortEquipment, HeaterInterface):
    @typing.overload
    ...
    def getMechanicalDesign(self) -> neqsim.process.mechanicaldesign.heatexchanger.HeatExchangerMechanicalDesign: ...
    ...
    @typing.overload
    def setOutPressure(self, double: float, string: typing.Union[java.lang.String, str]) -> None: ...
    def setOutStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    def setOutTP(self, double: float, double2: float) -> None: ...
    @typing.overload
    def setOutTemperature(self, double: float) -> None: ...
    @typing.overload
...
class HeatExchanger(Heater, HeatExchangerInterface):
    ...
    @typing.overload
    def setOutStream(self, int: int, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    @typing.overload
    def setOutStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    @typing.overload
    def setOutTemperature(self, double: float) -> None: ...
...
class MultiStreamHeatExchanger(Heater, MultiStreamHeatExchangerInterface):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], list: java.util.List[neqsim.process.equipment.stream.StreamInterface]): ...
    def addInStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    def calcThermalEffectiveness(self, double: float, double2: float) -> float: ...
    def displayResult(self) -> None: ...
    def getDeltaT(self) -> float: ...
...
class MultiStreamHeatExchanger2(Heater, MultiStreamHeatExchangerInterface):
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    def addInStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    def addInStreamMSHE(self, streamInterface: neqsim.process.equipment.stream.StreamInterface, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    def calcThermalEffectiveness(self, double: float, double2: float) -> float: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.equipment.heatexchanger")``.
