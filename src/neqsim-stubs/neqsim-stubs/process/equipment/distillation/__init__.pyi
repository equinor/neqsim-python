...
class DistillationInterface(neqsim.process.equipment.ProcessEquipmentInterface):
    def equals(self, object: typing.Any) -> bool: ...
    def hashCode(self) -> int: ...
    def setNumberOfTrays(self, int: int) -> None: ...

class TrayInterface(neqsim.process.equipment.ProcessEquipmentInterface):
...
class DistillationColumn(neqsim.process.equipment.ProcessEquipmentBaseClass, DistillationInterface):
    def __init__(self, string: typing.Union[java.lang.String, str], int: int, boolean: bool, boolean2: bool): ...
    @typing.overload
    def addFeedStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    @typing.overload
    def addFeedStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface, int: int) -> None: ...
    ...
    def getFeedStreams(self, int: int) -> java.util.List[neqsim.process.equipment.stream.StreamInterface]: ...
...
class SimpleTray(neqsim.process.equipment.mixer.Mixer, TrayInterface):
...
class Condenser(SimpleTray):
    ...
    def getProductOutStream(self) -> neqsim.process.equipment.stream.StreamInterface: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.equipment.distillation")``.
