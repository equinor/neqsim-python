...
class SimpleAdsorber(neqsim.process.equipment.ProcessEquipmentBaseClass):
    @typing.overload
    ...
    def getMechanicalDesign(self) -> neqsim.process.mechanicaldesign.adsorber.AdsorberMechanicalDesign: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.equipment.adsorber")``.
