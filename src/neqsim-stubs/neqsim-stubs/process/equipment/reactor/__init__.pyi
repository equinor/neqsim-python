...
class FurnaceBurner(neqsim.process.equipment.ProcessEquipmentBaseClass):
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    def getAirFuelRatioMass(self) -> float: ...
    def getAirInlet(self) -> neqsim.process.equipment.stream.StreamInterface: ...
    def getEmissionRatesKgPerHr(self) -> java.util.Map[java.lang.String, float]: ...
    def getFlameTemperature(self) -> float: ...
    def getFuelInlet(self) -> neqsim.process.equipment.stream.StreamInterface: ...
    ...
    def setAirInlet(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    ...
    def setFuelInlet(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
...
class GibbsReactor(neqsim.process.equipment.TwoPortEquipment):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
...
class GibbsReactorCO2(neqsim.process.equipment.TwoPortEquipment):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], streamInterface: neqsim.process.equipment.stream.StreamInterface): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.equipment.reactor")``.
