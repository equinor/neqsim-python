...
import neqsim.process.equipment.separator.sectiontype
...
class SeparatorInterface(neqsim.process.SimulationInterface):
    @typing.overload
...
class Separator(neqsim.process.equipment.ProcessEquipmentBaseClass, SeparatorInterface):
    ...
    @typing.overload
    def evaluateFireExposure(self, fireScenarioConfig: neqsim.process.util.fire.SeparatorFireExposure.FireScenarioConfig) -> neqsim.process.util.fire.SeparatorFireExposure.FireExposureResult: ...
    @typing.overload
    def evaluateFireExposure(self, fireScenarioConfig: neqsim.process.util.fire.SeparatorFireExposure.FireScenarioConfig, flare: neqsim.process.equipment.flare.Flare, double: float) -> neqsim.process.util.fire.SeparatorFireExposure.FireExposureResult: ...
    ...
    def getGas(self) -> neqsim.process.equipment.stream.StreamInterface: ...
    ...
    def getLiquid(self) -> neqsim.process.equipment.stream.StreamInterface: ...
    ...
    def getMechanicalDesign(self) -> neqsim.process.mechanicaldesign.separator.SeparatorMechanicalDesign: ...
    ...
    @typing.overload
    def getSeparatorSection(self, int: int) -> neqsim.process.equipment.separator.sectiontype.SeparatorSection: ...
    @typing.overload
    def getSeparatorSection(self, string: typing.Union[java.lang.String, str]) -> neqsim.process.equipment.separator.sectiontype.SeparatorSection: ...
    def getSeparatorSections(self) -> java.util.ArrayList[neqsim.process.equipment.separator.sectiontype.SeparatorSection]: ...
    def getThermoSystem(self) -> neqsim.thermo.system.SystemInterface: ...
...
class GasScrubber(Separator):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], streamInterface: neqsim.process.equipment.stream.StreamInterface): ...
    def getMechanicalDesign(self) -> neqsim.process.mechanicaldesign.separator.GasScrubberMechanicalDesign: ...
...
class Hydrocyclone(Separator):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], streamInterface: neqsim.process.equipment.stream.StreamInterface): ...
    def displayResult(self) -> None: ...
    def getOilOutStream(self) -> neqsim.process.equipment.stream.StreamInterface: ...
    def getWaterOutStream(self) -> neqsim.process.equipment.stream.StreamInterface: ...
    @typing.overload
    def run(self) -> None: ...
    @typing.overload
    def run(self, uUID: java.util.UUID) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.equipment.separator")``.
    ...
    sectiontype: neqsim.process.equipment.separator.sectiontype.__module_protocol__
