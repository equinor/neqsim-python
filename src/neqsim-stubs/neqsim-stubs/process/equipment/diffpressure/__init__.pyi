...
class Orifice(neqsim.process.equipment.TwoPortEquipment):
    @typing.overload
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.equipment.diffpressure")``.
