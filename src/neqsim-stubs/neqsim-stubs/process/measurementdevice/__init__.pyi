...
import neqsim.process.measurementdevice.online
import neqsim.process.measurementdevice.simpleflowregime
import neqsim.util
import typing



class MeasurementDeviceInterface(neqsim.util.NamedInterface, java.io.Serializable):
    def acknowledgeAlarm(self, double: float) -> neqsim.process.alarm.AlarmEvent: ...
    def displayResult(self) -> None: ...
    def equals(self, object: typing.Any) -> bool: ...
    def evaluateAlarm(self, double: float, double2: float, double3: float) -> java.util.List[neqsim.process.alarm.AlarmEvent]: ...
    def getAlarmConfig(self) -> neqsim.process.alarm.AlarmConfig: ...
    def getAlarmState(self) -> neqsim.process.alarm.AlarmState: ...
    ...
    def getOnlineSignal(self) -> neqsim.process.measurementdevice.online.OnlineSignal: ...
    def getOnlineValue(self) -> float: ...
    def getUnit(self) -> java.lang.String: ...
    def hashCode(self) -> int: ...
    def isLogging(self) -> bool: ...
    def isOnlineSignal(self) -> bool: ...
    def setAlarmConfig(self, alarmConfig: neqsim.process.alarm.AlarmConfig) -> None: ...
...
class MeasurementDeviceBaseClass(neqsim.util.NamedBaseClass, MeasurementDeviceInterface):
    ...
    def setOnlineSignal(self, onlineSignal: neqsim.process.measurementdevice.online.OnlineSignal) -> None: ...
...
class CompressorMonitor(MeasurementDeviceBaseClass):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], compressor: neqsim.process.equipment.compressor.Compressor): ...
    @typing.overload
...
class FlowInducedVibrationAnalyser(MeasurementDeviceBaseClass):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], pipeBeggsAndBrills: neqsim.process.equipment.pipeline.PipeBeggsAndBrills): ...
    @typing.overload
...
class LevelTransmitter(MeasurementDeviceBaseClass):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], separator: neqsim.process.equipment.separator.Separator): ...
    @typing.overload
...
class OilLevelTransmitter(MeasurementDeviceBaseClass):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], threePhaseSeparator: neqsim.process.equipment.separator.ThreePhaseSeparator): ...
    @typing.overload
...
class PushButton(MeasurementDeviceBaseClass):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], blowdownValve: neqsim.process.equipment.valve.BlowdownValve): ...
    def displayResult(self) -> None: ...
    def getLinkedBlowdownValve(self) -> neqsim.process.equipment.valve.BlowdownValve: ...
    def getLinkedLogics(self) -> java.util.List[neqsim.process.logic.ProcessLogic]: ...
    @typing.overload
    def getMeasuredValue(self) -> float: ...
    @typing.overload
    def getMeasuredValue(self, string: typing.Union[java.lang.String, str]) -> float: ...
    ...
    def linkToBlowdownValve(self, blowdownValve: neqsim.process.equipment.valve.BlowdownValve) -> None: ...
    def linkToLogic(self, processLogic: neqsim.process.logic.ProcessLogic) -> None: ...
    def push(self) -> None: ...
    def reset(self) -> None: ...
...
class StreamMeasurementDeviceBaseClass(MeasurementDeviceBaseClass):
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], streamInterface: neqsim.process.equipment.stream.StreamInterface): ...
...
class WellAllocator(StreamMeasurementDeviceBaseClass):
    ...
    @typing.overload
    def getMeasuredValue(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> float: ...
    def setExportGasStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
    def setExportOilStream(self, streamInterface: neqsim.process.equipment.stream.StreamInterface) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.measurementdevice")``.
    ...
    online: neqsim.process.measurementdevice.online.__module_protocol__
    simpleflowregime: neqsim.process.measurementdevice.simpleflowregime.__module_protocol__
