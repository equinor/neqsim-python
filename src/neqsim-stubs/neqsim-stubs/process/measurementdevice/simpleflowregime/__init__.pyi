...
class SevereSlugAnalyser(neqsim.process.measurementdevice.MeasurementDeviceBaseClass):
    @typing.overload
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], stream: neqsim.process.equipment.stream.Stream, double: float, double2: float, double3: float, double4: float): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], stream: neqsim.process.equipment.stream.Stream, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], stream: neqsim.process.equipment.stream.Stream, double: float, double2: float, double3: float, double4: float, double5: float, int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], systemInterface: neqsim.thermo.system.SystemInterface, pipe: Pipe, double: float, double2: float, double3: float, int: int): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.measurementdevice.simpleflowregime")``.
