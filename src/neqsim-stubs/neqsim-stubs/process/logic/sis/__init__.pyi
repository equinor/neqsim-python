...
class Detector:
    def __init__(self, string: typing.Union[java.lang.String, str], detectorType: 'Detector.DetectorType', alarmLevel: 'Detector.AlarmLevel', double: float, string2: typing.Union[java.lang.String, str]): ...
    ...
    class AlarmLevel(java.lang.Enum['Detector.AlarmLevel']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Detector.AlarmLevel': ...
        @staticmethod
    ...
    class DetectorType(java.lang.Enum['Detector.DetectorType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Detector.DetectorType': ...
        @staticmethod
        def values() -> typing.MutableSequence['Detector.DetectorType']: ...

class SafetyInstrumentedFunction(neqsim.process.logic.ProcessLogic):
    def __init__(self, string: typing.Union[java.lang.String, str], votingLogic: 'VotingLogic'): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.logic.sis")``.
