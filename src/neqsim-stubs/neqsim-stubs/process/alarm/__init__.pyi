...
class AlarmActionHandler(java.io.Serializable):
    @staticmethod
    def activateLogic(string: typing.Union[java.lang.String, str], alarmLevel: 'AlarmLevel', alarmEventType: 'AlarmEventType', processLogic: neqsim.process.logic.ProcessLogic) -> 'AlarmActionHandler': ...
    @staticmethod
    def activateLogicOnHIHI(string: typing.Union[java.lang.String, str], processLogic: neqsim.process.logic.ProcessLogic) -> 'AlarmActionHandler': ...
    @staticmethod
    def activateLogicOnLOLO(string: typing.Union[java.lang.String, str], processLogic: neqsim.process.logic.ProcessLogic) -> 'AlarmActionHandler': ...
    @staticmethod
...
class AlarmEvaluator:
    @staticmethod
    def evaluateAll(processAlarmManager: 'ProcessAlarmManager', processSystem: neqsim.process.processmodel.ProcessSystem, double: float, double2: float) -> java.util.List['AlarmEvent']: ...
    @staticmethod
    def evaluateAndDisplay(processAlarmManager: 'ProcessAlarmManager', list: java.util.List[neqsim.process.measurementdevice.MeasurementDeviceInterface], double: float, double2: float) -> java.util.List['AlarmEvent']: ...
    @staticmethod
    def evaluateDevices(processAlarmManager: 'ProcessAlarmManager', list: java.util.List[neqsim.process.measurementdevice.MeasurementDeviceInterface], double: float, double2: float) -> java.util.List['AlarmEvent']: ...
...
class ProcessAlarmManager(java.io.Serializable):
    ...
    def applyFrom(self, processAlarmManager: 'ProcessAlarmManager', list: java.util.List[neqsim.process.measurementdevice.MeasurementDeviceInterface]) -> None: ...
    def clearHistory(self) -> None: ...
    def equals(self, object: typing.Any) -> bool: ...
    def evaluateMeasurement(self, measurementDeviceInterface: neqsim.process.measurementdevice.MeasurementDeviceInterface, double: float, double2: float, double3: float) -> java.util.List[AlarmEvent]: ...
    ...
    def register(self, measurementDeviceInterface: neqsim.process.measurementdevice.MeasurementDeviceInterface) -> None: ...
    def registerActionHandler(self, alarmActionHandler: typing.Union[AlarmActionHandler, typing.Callable]) -> None: ...
    def registerAll(self, list: java.util.List[neqsim.process.measurementdevice.MeasurementDeviceInterface]) -> None: ...
    def removeActionHandler(self, alarmActionHandler: typing.Union[AlarmActionHandler, typing.Callable]) -> None: ...


class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.process.alarm")``.
