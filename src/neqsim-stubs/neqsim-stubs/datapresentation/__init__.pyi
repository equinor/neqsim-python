...
import java.lang
import jpype
import neqsim.datapresentation.filehandling
import neqsim.datapresentation.jfreechart
import typing
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.datapresentation")``.

    DataHandling: typing.Type[DataHandling]
    SampleXYDataSource: typing.Type[SampleXYDataSource]
    filehandling: neqsim.datapresentation.filehandling.__module_protocol__
    jfreechart: neqsim.datapresentation.jfreechart.__module_protocol__
