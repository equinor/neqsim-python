...
class NewtonSolveAB(java.io.Serializable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, tBPCharacterize: 'TBPCharacterize'): ...
...
class NewtonSolveCDplus(java.io.Serializable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, plusCharacterize: 'PlusCharacterize'): ...
    def setJac(self) -> None: ...
    def setfvec(self) -> None: ...
    def solve(self) -> None: ...
...
class PedersenPlusModelSolver(java.io.Serializable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, pedersenPlusModel: 'PlusFractionModel.PedersenPlusModel'): ...
...
class PseudoComponentCombiner:
    @staticmethod
    def characterizeToReference(systemInterface: neqsim.thermo.system.SystemInterface, systemInterface2: neqsim.thermo.system.SystemInterface) -> neqsim.thermo.system.SystemInterface: ...
    @typing.overload
    @staticmethod
    def combineReservoirFluids(int: int, collection: typing.Union[java.util.Collection[neqsim.thermo.system.SystemInterface], typing.Sequence[neqsim.thermo.system.SystemInterface], typing.Set[neqsim.thermo.system.SystemInterface]]) -> neqsim.thermo.system.SystemInterface: ...
    @typing.overload
    @staticmethod
    def combineReservoirFluids(int: int, *systemInterface: neqsim.thermo.system.SystemInterface) -> neqsim.thermo.system.SystemInterface: ...

class Recombine:
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, systemInterface2: neqsim.thermo.system.SystemInterface): ...
    def getGOR(self) -> float: ...
    def getOilDesnity(self) -> float: ...
    def getRecombinedSystem(self) -> neqsim.thermo.system.SystemInterface: ...
    def runRecombination(self) -> neqsim.thermo.system.SystemInterface: ...
...
class TBPModelInterface:
    ...
    def calcRacketZ(self, systemInterface: neqsim.thermo.system.SystemInterface, double: float, double2: float) -> float: ...
...
class LumpingModel(java.io.Serializable):
    ...
    class NoLumpingModel(neqsim.thermo.characterization.LumpingModel.StandardLumpingModel):
        def __init__(self, lumpingModel: 'LumpingModel'): ...
        def generateLumpedComposition(self, characterise: Characterise) -> None: ...
        def getFractionOfHeavyEnd(self, int: int) -> float: ...
    class PVTLumpingModel(neqsim.thermo.characterization.LumpingModel.StandardLumpingModel):
        def __init__(self, lumpingModel: 'LumpingModel'): ...
        def generateLumpedComposition(self, characterise: Characterise) -> None: ...
        def getFractionOfHeavyEnd(self, int: int) -> float: ...
...
class TBPfractionModel(java.io.Serializable):
    ...
    class LeeKesler(neqsim.thermo.characterization.TBPfractionModel.TBPBaseModel):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
        def calcAcentricFactor(self, double: float, double2: float) -> float: ...
        def calcPC(self, double: float, double2: float) -> float: ...
        def calcRacketZ(self, systemInterface: neqsim.thermo.system.SystemInterface, double: float, double2: float) -> float: ...
        def calcTC(self, double: float, double2: float) -> float: ...
    class PedersenTBPModelPR(neqsim.thermo.characterization.TBPfractionModel.PedersenTBPModelSRK):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
    class PedersenTBPModelPR2(neqsim.thermo.characterization.TBPfractionModel.PedersenTBPModelSRK):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
        def calcTB(self, double: float, double2: float) -> float: ...
    class PedersenTBPModelPRHeavyOil(neqsim.thermo.characterization.TBPfractionModel.PedersenTBPModelPR):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
    class PedersenTBPModelSRK(neqsim.thermo.characterization.TBPfractionModel.TBPBaseModel):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
        def calcPC(self, double: float, double2: float) -> float: ...
        def calcRacketZ(self, systemInterface: neqsim.thermo.system.SystemInterface, double: float, double2: float) -> float: ...
        def calcTB(self, double: float, double2: float) -> float: ...
        def calcTC(self, double: float, double2: float) -> float: ...
        def calcm(self, double: float, double2: float) -> float: ...
    class PedersenTBPModelSRKHeavyOil(neqsim.thermo.characterization.TBPfractionModel.PedersenTBPModelSRK):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
    class RiaziDaubert(neqsim.thermo.characterization.TBPfractionModel.PedersenTBPModelSRK):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
        def calcAcentricFactor(self, double: float, double2: float) -> float: ...
    ...
    class TBPBaseModel(TBPModelInterface, java.lang.Cloneable, java.io.Serializable):
        ...
        def isCalcm(self) -> bool: ...
        def setBoilingPoint(self, double: float) -> None: ...
    class TwuModel(neqsim.thermo.characterization.TBPfractionModel.TBPBaseModel):
        def __init__(self, tBPfractionModel: 'TBPfractionModel'): ...
        def calcCriticalVolume(self, double: float, double2: float) -> float: ...
        def calcPC(self, double: float, double2: float) -> float: ...
        def calcRacketZ(self, systemInterface: neqsim.thermo.system.SystemInterface, double: float, double2: float) -> float: ...
...
class WaxCharacterise(java.io.Serializable, java.lang.Cloneable):
    ...
    class PedersenWaxModel(neqsim.thermo.characterization.WaxCharacterise.WaxBaseModel):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.thermo.characterization")``.
