...
import neqsim.thermo.component.attractiveeosterm
import neqsim.thermo.component.repulsiveeosterm
import neqsim.thermo.phase
import typing



class ComponentInterface(neqsim.thermo.ThermodynamicConstantsInterface, java.lang.Cloneable):
    def Finit(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    ...
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def fugcoefDiffPresNumeric(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def fugcoefDiffTempNumeric(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    ...
    def getAttractiveTerm(self) -> neqsim.thermo.component.attractiveeosterm.AttractiveTermInterface: ...
    ...
    @typing.overload
    def getChemicalPotential(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialIdealReference(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialdNTV(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialdP(self) -> float: ...
    def getChemicalPotentialdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    ...
    def getElements(self) -> neqsim.thermo.atomelement.Element: ...
    ...
    def getMolality(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def getMolarMass(self) -> float: ...
    @typing.overload
    def getMolarMass(self, string: typing.Union[java.lang.String, str]) -> float: ...
    def getMolarity(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    ...
    def logfugcoefdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> typing.MutableSequence[float]: ...
    def logfugcoefdNi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int) -> float: ...
    def logfugcoefdP(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def logfugcoefdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
...
class Component(ComponentInterface):
    ...
    def getChemicalPotentialdP(self) -> float: ...
    @typing.overload
    def getChemicalPotentialdP(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getChemicalPotentialdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getComponentName(self) -> java.lang.String: ...
    def getComponentNumber(self) -> int: ...
    ...
    def getFormulae(self) -> java.lang.String: ...
    def getFugacityCoefficient(self) -> float: ...
    def getFugacitydN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getGibbsEnergy(self, double: float, double2: float) -> float: ...
    def getGibbsEnergyOfFormation(self) -> float: ...
    def getGresTP(self, double: float) -> float: ...
    def getHID(self, double: float) -> float: ...
...
class ComponentEosInterface(ComponentInterface):
    ...
    def dFdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
...
class ComponentCPAInterface(ComponentEosInterface):
    def dFCPAdNdXi(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdVdXi(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdXi(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdXidXj(self, int: int, int2: int, int3: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
...
class ComponentEos(Component, ComponentEosInterface):
    ...
    def getAiT(self) -> float: ...
    def getAij(self, int: int) -> float: ...
    def getAresnTV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getAttractiveParameter(self) -> neqsim.thermo.component.attractiveeosterm.AttractiveTermInterface: ...
    def getAttractiveTerm(self) -> neqsim.thermo.component.attractiveeosterm.AttractiveTermInterface: ...
    def getBder(self) -> float: ...
    def getBi(self) -> float: ...
    def getBij(self, int: int) -> float: ...
    ...
    def getdBdndT(self) -> float: ...
    def getdBdndn(self, int: int) -> float: ...
    def getdUdSdnV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getdUdVdnS(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getdUdnSV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getdUdndnSV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def init(self, double: float, double2: float, double3: float, double4: float, int: int) -> None: ...
    def logfugcoefdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> typing.MutableSequence[float]: ...
    def logfugcoefdNi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int) -> float: ...
    def logfugcoefdP(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def logfugcoefdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def setAder(self, double: float) -> None: ...
    def setAttractiveParameter(self, attractiveTermInterface: neqsim.thermo.component.attractiveeosterm.AttractiveTermInterface) -> None: ...
    def setAttractiveTerm(self, int: int) -> None: ...
    def setBder(self, double: float) -> None: ...
    def seta(self, double: float) -> None: ...
    def setb(self, double: float) -> None: ...
...
class ComponentGE(Component, ComponentGEInterface):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def fugcoefDiffPres(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def fugcoefDiffTemp(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray3: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], stringArray: typing.Union[typing.List[typing.MutableSequence[java.lang.String]], jpype.JArray]) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
...
class ComponentHydrate(Component):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def calcCKI(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calcChemPotEmpty(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    def calcChemPotIdealWater(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    def calcYKI(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def delt(self, double: float, double2: float, int: int, int2: int, componentInterface: ComponentInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    @typing.overload
    ...
    def getPot(self, double: float, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getSphericalCoreRadiusHydrate(self) -> float: ...
    def potIntegral(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    ...
    def setSolidRefFluidPhase(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
...
class ComponentHydrateKluda(Component):
    ...
    def calcCKI(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calcYKI(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def delt(self, int: int, double: float, double2: float, int2: int, int3: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dfugdt(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    ...
    def getPot(self, int: int, double: float, int2: int, int3: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def potIntegral(self, int: int, int2: int, int3: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def setRefFug(self, int: int, double: float) -> None: ...
...
class ComponentDesmukhMather(ComponentGE):
    ...
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray3: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], stringArray: typing.Union[typing.List[typing.MutableSequence[java.lang.String]], jpype.JArray]) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
...
class ComponentGEUniquac(ComponentGE):
    ...
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    @typing.overload
    def fugcoefDiffPres(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoefDiffPres(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    @typing.overload
    def fugcoefDiffTemp(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoefDiffTemp(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
...
class ComponentGEWilson(ComponentGE):
    ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    def getCharEnergyParamter(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray3: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], stringArray: typing.Union[typing.List[typing.MutableSequence[java.lang.String]], jpype.JArray]) -> float: ...
    def getWilsonActivityCoefficient(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getWilsonInteractionEnergy(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
...
class ComponentGeDuanSun(ComponentGE):
    ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray3: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], stringArray: typing.Union[typing.List[typing.MutableSequence[java.lang.String]], jpype.JArray]) -> float: ...
    def getGammaNRTL(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType, doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray], doubleArray2: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> float: ...
    def getGammaPitzer(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType, double3: float) -> float: ...
    def getLngamma(self) -> float: ...
    def getq(self) -> float: ...
    def getr(self) -> float: ...
...
class ComponentHydrateGF(ComponentHydrate):
    ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def fugcoef2(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...

class ComponentHydratePVTsim(ComponentHydrate):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def calcCKI(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calcDeltaChemPot(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, int2: int) -> float: ...
    def calcYKI(self, int: int, int2: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
...
class ComponentBWRS(ComponentSrk):
    ...
    def getELdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def getFexpdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def getFpoldn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def getGammaBWRS(self) -> float: ...
    def getRhoc(self) -> float: ...
    def getdRhodn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def init(self, double: float, double2: float, double3: float, double4: float, int: int) -> None: ...
    ...
    def setRefPhaseBWRS(self, phaseBWRSEos: neqsim.thermo.phase.PhaseBWRSEos) -> None: ...
...
class ComponentCSPsrk(ComponentSrk):
    ...
    def getRefPhaseBWRS(self) -> neqsim.thermo.phase.PhaseCSPsrkEos: ...
    def init(self, double: float, double2: float, double3: float, double4: float, int: int) -> None: ...
    def setF_scale_mix_i(self, double: float) -> None: ...
    def setH_scale_mix_i(self, double: float) -> None: ...
    def setRefPhaseBWRS(self, phaseCSPsrkEos: neqsim.thermo.phase.PhaseCSPsrkEos) -> None: ...
...
class ComponentGEUnifac(ComponentGEUniquac):
    ...
    def calclnGammak(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
    ...
    def getQ(self) -> float: ...
    def getR(self) -> float: ...
    def getUnifacGroup(self, int: int) -> neqsim.thermo.atomelement.UNIFACgroup: ...
    def getUnifacGroup2(self, int: int) -> neqsim.thermo.atomelement.UNIFACgroup: ...
    def getUnifacGroups(self) -> typing.MutableSequence[neqsim.thermo.atomelement.UNIFACgroup]: ...
    def getUnifacGroups2(self) -> java.util.ArrayList[neqsim.thermo.atomelement.UNIFACgroup]: ...
    def setQ(self, double: float) -> None: ...
    def setR(self, double: float) -> None: ...
    def setUnifacGroups(self, arrayList: java.util.ArrayList[neqsim.thermo.atomelement.UNIFACgroup]) -> None: ...
...
class ComponentModifiedFurstElectrolyteEos(ComponentSrk):
    ...
    def FLRN(self) -> float: ...
    def Finit(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    def calcGammaLRdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcSolventdiElectricdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcSolventdiElectricdndT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcSolventdiElectricdndn(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def calcXLRdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calca(self) -> float: ...
    def calcb(self) -> float: ...
    def calcdiElectricdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdiElectricdndT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdiElectricdndV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdiElectricdndn(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def clone(self) -> 'ComponentModifiedFurstElectrolyteEos': ...
    def dAlphaLRdndn(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dEpsIonicdNi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dEpsIonicdNidV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dEpsdNi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dEpsdNidV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFBorndN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFBorndNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFBorndNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFLRdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFLRdNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFLRdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFLRdNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFSR2dN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFSR2dNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFSR2dNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFSR2dNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
...
class ComponentPCSAFT(ComponentSrk):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def Finit(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    def calcF1dispSumTermdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcF2dispSumTermdn(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdahsSAFTdi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdghsSAFTdi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdmSAFTdi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdnSAFTdi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def clone(self) -> 'ComponentPCSAFT': ...
    def dF_DISP1_SAFTdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dF_DISP2_SAFTdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dF_HC_SAFTdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
...
class ComponentPRvolcor(ComponentPR):
    ...
    def getFC(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def getVolumeCorrection(self) -> float: ...
    def getc(self) -> float: ...
...
class ComponentPrCPA(ComponentPR, ComponentCPAInterface):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def calc_lngi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calc_lngi2(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calca(self) -> float: ...
    def calcb(self) -> float: ...
    def clone(self) -> 'ComponentPrCPA': ...
    def dFCPAdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
...
class ComponentSolid(ComponentSrk):
    ...
    @typing.overload
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def fugcoef2(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
...
class ComponentSrkCPA(ComponentSrk, ComponentCPAInterface):
    @typing.overload
    def __init__(self, int: int, double: float, double2: float, double3: float, double4: float, double5: float, phaseInterface: neqsim.thermo.phase.PhaseInterface): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface): ...
    def calc_hCPAdn(self) -> float: ...
    def calc_lngi(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calc_lngidV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calc_lngij(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def calca(self) -> float: ...
    def calcb(self) -> float: ...
    def clone(self) -> 'ComponentSrkCPA': ...
    def dFCPAdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFCPAdNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFCPAdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFCPAdNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFCPAdNdXi(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdNdXidXdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdVdXi(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdXi(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdXidXj(self, int: int, int2: int, int3: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFCPAdXidni(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def dFdN(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdN(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFdNdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdV(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
...
class ComponentGEUnifacPSRK(ComponentGEUnifac):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def calcaij(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def calcaijdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def calclnGammak(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calclnGammakdT(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    @typing.overload
    def getGamma(self) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
...
class ComponentGEUnifacUMRPRU(ComponentGEUnifac):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def calcGammaNumericalDerivatives(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> None: ...
    def calcSum2Comp(self) -> None: ...
    def calcSum2CompdTdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calcTempExpaij(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calcUnifacGroupParams(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calcUnifacGroupParamsdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calcaij(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def calcaijdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def calcaijdTdT(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def calclnGammak(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calclnGammakdTdT(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def calclnGammakdn(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface, int2: int) -> None: ...
    @typing.overload
    def getGamma(self) -> float: ...
    @typing.overload
    def getGamma(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
...
class ComponentWonWax(ComponentSolid):
    ...
    def fugcoef(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def fugcoef2(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getWonActivityCoefficient(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getWonParam(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
    def getWonVolume(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> float: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.thermo.component")``.
    ...
    attractiveeosterm: neqsim.thermo.component.attractiveeosterm.__module_protocol__
    repulsiveeosterm: neqsim.thermo.component.repulsiveeosterm.__module_protocol__
