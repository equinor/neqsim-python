...
class PhaseInterface(neqsim.thermo.ThermodynamicConstantsInterface, java.lang.Cloneable):
    def FB(self) -> float: ...
    def FBB(self) -> float: ...
    def FBD(self) -> float: ...
    def FBT(self) -> float: ...
    ...
    def getComponentWithIndex(self, int: int) -> neqsim.thermo.component.ComponentInterface: ...
    def getComponents(self) -> typing.MutableSequence[neqsim.thermo.component.ComponentInterface]: ...
    ...
    def getMixingRule(self) -> neqsim.thermo.mixingrule.MixingRulesInterface: ...
    def getMixingRuleType(self) -> neqsim.thermo.mixingrule.MixingRuleTypeInterface: ...
    ...
    def getPhysicalProperties(self) -> neqsim.physicalproperties.system.PhysicalProperties: ...
    def getPhysicalPropertyModel(self) -> neqsim.physicalproperties.system.PhysicalPropertyModel: ...
    @typing.overload
    ...
    def getWtFraction(self, systemInterface: neqsim.thermo.system.SystemInterface) -> float: ...
    ...
    def getcomponentArray(self) -> typing.MutableSequence[neqsim.thermo.component.ComponentInterface]: ...
    ...
    def resetMixingRule(self, mixingRuleTypeInterface: typing.Union[neqsim.thermo.mixingrule.MixingRuleTypeInterface, typing.Callable]) -> None: ...
    def resetPhysicalProperties(self) -> None: ...
    def setAttractiveTerm(self, int: int) -> None: ...
    def setBeta(self, double: float) -> None: ...
    def setComponentArray(self, componentInterfaceArray: typing.Union[typing.List[neqsim.thermo.component.ComponentInterface], jpype.JArray]) -> None: ...
    ...
    @typing.overload
    def setPhysicalProperties(self, physicalPropertyModel: neqsim.physicalproperties.system.PhysicalPropertyModel) -> None: ...
    @typing.overload
    ...
    def setPpm(self, physicalPropertyModel: neqsim.physicalproperties.system.PhysicalPropertyModel) -> None: ...
...
class Phase(PhaseInterface):
    ...
    componentArray: typing.MutableSequence[neqsim.thermo.component.ComponentInterface] = ...
    calcMolarVolume: bool = ...
    physicalPropertyHandler: neqsim.physicalproperties.PhysicalPropertyHandler = ...
    chemSyst: bool = ...
...
class PhaseEosInterface(PhaseInterface):
    ...
    def getEosMixingRule(self) -> neqsim.thermo.mixingrule.EosMixingRulesInterface: ...
...
class PhaseCPAInterface(PhaseEosInterface):
    def getCpaMixingRule(self) -> neqsim.thermo.mixingrule.CPAMixingRulesInterface: ...
...
class PhaseDefault(Phase):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, componentInterface: neqsim.thermo.component.ComponentInterface): ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float, int: int) -> None: ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int) -> None: ...
    def getGibbsEnergy(self) -> float: ...
    def getMixingRule(self) -> neqsim.thermo.mixingrule.EosMixingRulesInterface: ...
    @typing.overload
    def getMolarVolume(self, string: typing.Union[java.lang.String, str]) -> float: ...
    @typing.overload
    def getMolarVolume(self) -> float: ...
    ...
    def molarVolume(self, double: float, double2: float, double3: float, double4: float, phaseType: PhaseType) -> float: ...
    def resetMixingRule(self, mixingRuleTypeInterface: typing.Union[neqsim.thermo.mixingrule.MixingRuleTypeInterface, typing.Callable]) -> None: ...
    def setComponentType(self, componentInterface: neqsim.thermo.component.ComponentInterface) -> None: ...
    @typing.overload
    def setMixingRule(self, int: int) -> None: ...
    @typing.overload
    def setMixingRule(self, mixingRuleTypeInterface: typing.Union[neqsim.thermo.mixingrule.MixingRuleTypeInterface, typing.Callable]) -> None: ...
...
class PhaseIdealGas(Phase, neqsim.thermo.ThermodynamicConstantsInterface):
    def __init__(self): ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float, int: int) -> None: ...
    @typing.overload
...
class PhaseModifiedFurstElectrolyteEos(PhaseSrkEos):
    ...
    def getElectrolyteMixingRule(self) -> neqsim.thermo.mixingrule.ElectrolyteMixingRulesInterface: ...
...
class PhasePrCPA(PhasePrEos, PhaseCPAInterface):
    cpaSelect: neqsim.thermo.mixingrule.CPAMixingRuleHandler = ...
    cpamix: neqsim.thermo.mixingrule.CPAMixingRulesInterface = ...
    def __init__(self): ...
    def FCPA(self) -> float: ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float, int: int) -> None: ...
...
class PhasePrEosvolcor(PhasePrEos):
    ...
    def getc(self) -> float: ...
    def getcij(self, componentEosInterface: neqsim.thermo.component.ComponentEosInterface, componentEosInterface2: neqsim.thermo.component.ComponentEosInterface) -> float: ...
    def getcijT(self, componentEosInterface: neqsim.thermo.component.ComponentEosInterface, componentEosInterface2: neqsim.thermo.component.ComponentEosInterface) -> float: ...
    def getcijTT(self, componentPRvolcor: neqsim.thermo.component.ComponentPRvolcor, componentPRvolcor2: neqsim.thermo.component.ComponentPRvolcor) -> float: ...
    @typing.overload
    def init(self) -> None: ...
    @typing.overload
    def init(self, double: float, int: int, int2: int, double2: float) -> None: ...
...
class PhaseSrkEosvolcor(PhaseSrkEos):
    ...
    def getcij(self, componentEosInterface: neqsim.thermo.component.ComponentEosInterface, componentEosInterface2: neqsim.thermo.component.ComponentEosInterface) -> float: ...
    def getcijT(self, componentEosInterface: neqsim.thermo.component.ComponentEosInterface, componentEosInterface2: neqsim.thermo.component.ComponentEosInterface) -> float: ...
    def getcijTT(self, componentSrkvolcor: neqsim.thermo.component.ComponentSrkvolcor, componentSrkvolcor2: neqsim.thermo.component.ComponentSrkvolcor) -> float: ...
    @typing.overload
    def init(self) -> None: ...
    @typing.overload
    def init(self, double: float, int: int, int2: int, double2: float) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.thermo.phase")``.
