...
class Element(neqsim.thermo.ThermodynamicConstantsInterface):
...
class UNIFACgroup(neqsim.thermo.ThermodynamicConstantsInterface, java.lang.Comparable['UNIFACgroup']):
    QMixdN: typing.MutableSequence[float] = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, int: int, int2: int): ...
    def calcQComp(self, componentGEUnifac: neqsim.thermo.component.ComponentGEUnifac) -> float: ...
    def calcQMix(self, phaseGEUnifac: neqsim.thermo.phase.PhaseGEUnifac) -> float: ...
    def calcQMixdN(self, phaseGEUnifac: neqsim.thermo.phase.PhaseGEUnifac) -> typing.MutableSequence[float]: ...
    def calcXComp(self, componentGEUnifac: neqsim.thermo.component.ComponentGEUnifac) -> float: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.thermo.atomelement")``.
