...
class SystemInterface(java.lang.Cloneable, java.io.Serializable):
    ...
    @typing.overload
    def addComponent(self, componentInterface: neqsim.thermo.component.ComponentInterface) -> None: ...
    @typing.overload
    ...
    def getCharacterization(self) -> neqsim.thermo.characterization.Characterise: ...
    def getChemicalReactionOperations(self) -> neqsim.chemicalreactions.ChemicalReactionOperations: ...
    ...
    @typing.overload
    def getComponent(self, int: int) -> neqsim.thermo.component.ComponentInterface: ...
    @typing.overload
    def getComponent(self, string: typing.Union[java.lang.String, str]) -> neqsim.thermo.component.ComponentInterface: ...
    ...
    def getGasPhase(self) -> neqsim.thermo.phase.PhaseInterface: ...
    ...
    def getInterphaseProperties(self) -> neqsim.physicalproperties.interfaceproperties.InterphasePropertiesInterface: ...
    @typing.overload
    ...
    def getLiquidPhase(self) -> neqsim.thermo.phase.PhaseInterface: ...
    def getLiquidVolume(self) -> float: ...
    def getLowestGibbsEnergyPhase(self) -> neqsim.thermo.phase.PhaseInterface: ...
    def getMass(self, string: typing.Union[java.lang.String, str]) -> float: ...
    def getMaxNumberOfPhases(self) -> int: ...
    def getMixingRule(self) -> neqsim.thermo.mixingrule.MixingRuleTypeInterface: ...
    ...
    def getOilAssayCharacterisation(self) -> neqsim.thermo.characterization.OilAssayCharacterisation: ...
    ...
    @typing.overload
    def getPhase(self, int: int) -> neqsim.thermo.phase.PhaseInterface: ...
    @typing.overload
    def getPhase(self, string: typing.Union[java.lang.String, str]) -> neqsim.thermo.phase.PhaseInterface: ...
    @typing.overload
    def getPhase(self, phaseType: neqsim.thermo.phase.PhaseType) -> neqsim.thermo.phase.PhaseInterface: ...
    ...
    @typing.overload
    def getPhaseIndex(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> int: ...
    @typing.overload
    def getPhaseNumberOfPhase(self, phaseType: neqsim.thermo.phase.PhaseType) -> int: ...
    @typing.overload
    def getPhaseNumberOfPhase(self, string: typing.Union[java.lang.String, str]) -> int: ...
    def getPhaseOfType(self, string: typing.Union[java.lang.String, str]) -> neqsim.thermo.phase.PhaseInterface: ...
    def getPhases(self) -> typing.MutableSequence[neqsim.thermo.phase.PhaseInterface]: ...
    @typing.overload
    ...
    @typing.overload
    def getStandard(self) -> neqsim.standards.StandardInterface: ...
    @typing.overload
    def getStandard(self, string: typing.Union[java.lang.String, str]) -> neqsim.standards.StandardInterface: ...
    ...
    def getWaxCharacterisation(self) -> neqsim.thermo.characterization.WaxCharacterise: ...
    def getWaxModel(self) -> neqsim.thermo.characterization.WaxModelInterface: ...
    ...
    @typing.overload
    def hasPhaseType(self, phaseType: neqsim.thermo.phase.PhaseType) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def initPhysicalProperties(self, physicalPropertyType: neqsim.physicalproperties.PhysicalPropertyType) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def phaseToSystem(self, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> 'SystemInterface': ...
    ...
    def replacePhase(self, int: int, phaseInterface: neqsim.thermo.phase.PhaseInterface) -> None: ...
    def reset(self) -> None: ...
    ...
    def setAllPhaseType(self, phaseType: neqsim.thermo.phase.PhaseType) -> None: ...
    ...
    @typing.overload
    def setForceSinglePhase(self, phaseType: neqsim.thermo.phase.PhaseType) -> None: ...
    ...
    @typing.overload
    def setMixingRule(self, mixingRuleTypeInterface: typing.Union[neqsim.thermo.mixingrule.MixingRuleTypeInterface, typing.Callable]) -> None: ...
    @typing.overload
    ...
    def setPhase(self, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int) -> None: ...
    def setPhaseIndex(self, int: int, int2: int) -> None: ...
    @typing.overload
    def setPhaseType(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setPhaseType(self, int: int, phaseType: neqsim.thermo.phase.PhaseType) -> None: ...
    @typing.overload
    def setPhysicalPropertyModel(self, int: int) -> None: ...
    @typing.overload
    def setPhysicalPropertyModel(self, physicalPropertyModel: neqsim.physicalproperties.system.PhysicalPropertyModel) -> None: ...
    @typing.overload
...
class SystemThermo(SystemInterface):
    characterization: neqsim.thermo.characterization.Characterise = ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.thermo.system")``.
