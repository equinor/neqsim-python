...
class Viscosity(neqsim.physicalproperties.methods.gasphysicalproperties.GasPhysicalPropertyMethod, neqsim.physicalproperties.methods.methodinterface.ViscosityInterface):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.physicalproperties.methods.gasphysicalproperties.viscosity")``.
