...
import java.util
import jpype
import neqsim.statistics.experimentalsamplecreation.readdatafromfile.wettedwallcolumnreader
import typing
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.statistics.experimentalsamplecreation.readdatafromfile")``.
    ...
    wettedwallcolumnreader: neqsim.statistics.experimentalsamplecreation.readdatafromfile.wettedwallcolumnreader.__module_protocol__
