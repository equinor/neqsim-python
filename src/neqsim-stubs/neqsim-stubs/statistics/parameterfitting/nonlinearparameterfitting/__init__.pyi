...
class LevenbergMarquardt(neqsim.statistics.parameterfitting.StatisticsBaseClass):
    def __init__(self): ...
...
class LevenbergMarquardtFunction(neqsim.statistics.parameterfitting.BaseFunction):
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.statistics.parameterfitting.nonlinearparameterfitting")``.
