...
class FunctionInterface(java.lang.Cloneable):
    ...
    def setThermodynamicSystem(self, systemInterface: neqsim.thermo.system.SystemInterface) -> None: ...
...
class SampleValue(java.lang.Cloneable):
    system: neqsim.thermo.system.SystemInterface = ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.statistics.parameterfitting")``.
    ...
    nonlinearparameterfitting: neqsim.statistics.parameterfitting.nonlinearparameterfitting.__module_protocol__
