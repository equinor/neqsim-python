...
class TuningInterface:
    def getSimulation(self) -> neqsim.pvtsimulation.simulation.SimulationInterface: ...
    def run(self) -> None: ...
...
class BaseTuningClass(TuningInterface):
    ...
    def __init__(self, simulationInterface: neqsim.pvtsimulation.simulation.SimulationInterface): ...
    def getSimulation(self) -> neqsim.pvtsimulation.simulation.SimulationInterface: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.pvtsimulation.modeltuning")``.
