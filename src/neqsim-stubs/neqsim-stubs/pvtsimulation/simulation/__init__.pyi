...
class SimulationInterface:
    def getBaseThermoSystem(self) -> neqsim.thermo.system.SystemInterface: ...
    def getOptimizer(self) -> neqsim.statistics.parameterfitting.nonlinearparameterfitting.LevenbergMarquardt: ...
...
class BasePVTsimulation(SimulationInterface):
    ...
    temperature: float = ...
    optimizer: neqsim.statistics.parameterfitting.nonlinearparameterfitting.LevenbergMarquardt = ...
...
class SwellingTest(BasePVTsimulation):
    ...
    def setInjectionGas(self, systemInterface: neqsim.thermo.system.SystemInterface) -> None: ...
    def setPressures(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.pvtsimulation.simulation")``.
