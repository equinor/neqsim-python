...
import neqsim.thermodynamicoperations.flashops.saturationops
import org.jfree.chart
import typing



class Flash(neqsim.thermodynamicoperations.BaseOperation):
...
class RachfordRice(java.io.Serializable):
    ...
    def calcBetaS(self, systemInterface: neqsim.thermo.system.SystemInterface) -> float: ...
...
class SysNewtonRhapsonPHflash(neqsim.thermo.ThermodynamicConstantsInterface):
    @typing.overload
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, int: int, int2: int): ...
    @typing.overload
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, int: int, int2: int, int3: int): ...
    def init(self) -> None: ...
...
class PHflash(Flash):
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, double: float, int: int): ...
    def calcdQdT(self) -> float: ...
    def calcdQdTT(self) -> float: ...
    def getJFreeChart(self, string: typing.Union[java.lang.String, str]) -> org.jfree.chart.JFreeChart: ...
    def run(self) -> None: ...
...
class dTPflash(TPflash):
    def __init__(self, systemInterface: neqsim.thermo.system.SystemInterface, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]): ...
    def run(self) -> None: ...


class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.thermodynamicoperations.flashops")``.
    ...
    saturationops: neqsim.thermodynamicoperations.flashops.saturationops.__module_protocol__
