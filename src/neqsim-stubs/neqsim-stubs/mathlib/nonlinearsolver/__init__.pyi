...
class NumericalDerivative(java.io.Serializable):
    @staticmethod
    def fugcoefDiffPres(componentInterface: neqsim.thermo.component.ComponentInterface, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    @staticmethod
    def fugcoefDiffTemp(componentInterface: neqsim.thermo.component.ComponentInterface, phaseInterface: neqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float, phaseType: neqsim.thermo.phase.PhaseType) -> float: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("neqsim.mathlib.nonlinearsolver")``.
