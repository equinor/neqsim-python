...
import jneqsim.thermodynamicoperations.flashops.reactiveflash
...
class Flash(jneqsim.thermodynamicoperations.BaseOperation):
    ...
    def getLastStabilityAnalysisFailureMessage(self) -> java.lang.String: ...
    def getLastStabilityOutcome(self) -> java.lang.String: ...
    def getLastTangentPlaneDistances(self) -> typing.MutableSequence[float]: ...
    ...
    def hasLastStabilityAnalysisFailed(self) -> bool: ...
...
class RachfordRice(java.io.Serializable):
    ...
    def calcBetaS(self, systemInterface: jneqsim.thermo.system.SystemInterface) -> float: ...
...
class SysNewtonRhapsonPHflash(jneqsim.thermo.ThermodynamicConstantsInterface):
    ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, int: int, int2: int, int3: int): ...
    def init(self) -> None: ...
...
class CriticalPointFlash(Flash):
    ...
    def getCriticalEigenVector(self) -> org.ejml.simple.SimpleMatrix: ...
    def run(self) -> None: ...
...
class OptimizedVUflash(Flash):
    ...
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, double: float, double2: float): ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, double: float, double2: float, boolean: bool): ...
    def getJFreeChart(self, string: typing.Union[java.lang.String, str]) -> org.jfree.chart.JFreeChart: ...
    def getLastIterationCount(self) -> int: ...
    def isLastRunConverged(self) -> bool: ...
    def run(self) -> None: ...
    def solveQ(self) -> float: ...
    def wasColdFallbackUsed(self) -> bool: ...
...
class TVfractionFlash(Flash):
    ...
    def isUseVolumeCorrection(self) -> bool: ...
    def run(self) -> None: ...
    def setUseVolumeCorrection(self, boolean: bool) -> None: ...
    def solveQ(self) -> float: ...
...
class TPHydrateFlash(TPflash):
    ...
    def isGasHydrateOnlyMode(self) -> bool: ...
    def isHydrateFormed(self) -> bool: ...
    def run(self) -> None: ...
    def setGasHydrateOnlyMode(self, boolean: bool) -> None: ...

class TPflashSAFT(TPflash):
    @typing.overload
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface): ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, boolean: bool): ...
...
class TPmultiflash(TPflash):
    ...
    def stabilityAnalysisEnhanced(self) -> None: ...
...
class dTPflash(TPflash):
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]): ...
    def run(self) -> None: ...

class TPHybridEosGeFlash(TPmultiflash):
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, hybridEosGeFlashModel: jneqsim.thermo.system.HybridEosGeFlashModel): ...
    def calcE(self) -> None: ...
    def calcQ(self) -> float: ...
    def run(self) -> None: ...
    def setXY(self) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    PVFflash: typing.Type[PVFflash]
    PVflash: typing.Type[PVflash]
    ...
    THflash: typing.Type[THflash]
    TPHybridEosGeFlash: typing.Type[TPHybridEosGeFlash]
    TPHydrateFlash: typing.Type[TPHydrateFlash]
    TPflash: typing.Type[TPflash]
    TPflashSAFT: typing.Type[TPflashSAFT]
    ...
    VUflashPureEOSCG: typing.Type[VUflashPureEOSCG]
    VUflashQfunc: typing.Type[VUflashQfunc]
    VUflashSingleComp: typing.Type[VUflashSingleComp]
    dTPflash: typing.Type[dTPflash]
    reactiveflash: jneqsim.thermodynamicoperations.flashops.reactiveflash.__module_protocol__
    saturationops: jneqsim.thermodynamicoperations.flashops.saturationops.__module_protocol__
