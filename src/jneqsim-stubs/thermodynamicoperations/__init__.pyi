...
class ThermodynamicOperations(java.io.Serializable, java.lang.Cloneable):
    ...
    @typing.overload
    def asphalteneOnsetTemperature(
    ...
    def calcImobilePhaseHydrateTemperature(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        doubleArray2: typing.Union[typing.List[float], jpype.JArray],
    ) -> typing.MutableSequence[float]: ...
    ...
    @typing.overload
    def calcPTphaseEnvelopeWithQualityLines(
        self, boolean: bool, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> None: ...
    @typing.overload
    def calcPTphaseEnvelopeWithQualityLines(
    ...
    def calcSaltSaturation(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    @typing.overload
    def calcSolidComlexTemperature(self) -> None: ...
    @typing.overload
    def calcSolidComlexTemperature(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ) -> None: ...
    ...
    @typing.overload
    def capillaryDewPointTemperatureFlash(
        self, double: float, double2: float
    ) -> None: ...
    ...
    def flash(
        self,
        flashType: "ThermodynamicOperations.FlashType",
        double: float,
        double2: float,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ...
    @typing.overload
    def freezingPointTemperatureFlash(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    ...
    def getEnvelopeSegments(
        self,
    ) -> java.util.List[
        jneqsim.thermodynamicoperations.phaseenvelopeops.multicomponentenvelopeops.EnvelopeSegment
    ]: ...
    ...
    def hydrateInhibitorConcentration(
        self, string: typing.Union[java.lang.String, str], double: float
    ) -> None: ...
    def hydrateInhibitorConcentrationSet(
        self, string: typing.Union[java.lang.String, str], double: float
    ) -> None: ...
    @typing.overload
    ...
    def propertyFlash(
        ...
        list4: java.util.List[java.util.List[float]],
    ) -> jneqsim.api.ioc.CalculationResult: ...
    ...
    class FlashType(java.lang.Enum["ThermodynamicOperations.FlashType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str],
        ) -> "ThermodynamicOperations.FlashType": ...
        @staticmethod
...
class __module_protocol__(Protocol):
    ...
    chemicalequilibrium: (
        jneqsim.thermodynamicoperations.chemicalequilibrium.__module_protocol__
    )
    flashops: jneqsim.thermodynamicoperations.flashops.__module_protocol__
    phaseenvelopeops: (
        jneqsim.thermodynamicoperations.phaseenvelopeops.__module_protocol__
    )
    propertygenerator: (
        jneqsim.thermodynamicoperations.propertygenerator.__module_protocol__
    )
