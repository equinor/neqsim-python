...
import jneqsim.thermodynamicoperations.chemicalequilibrium
import jneqsim.thermodynamicoperations.flashops
import jneqsim.thermodynamicoperations.flashops.saturationops
import jneqsim.thermodynamicoperations.phaseenvelopeops
import jneqsim.thermodynamicoperations.phaseenvelopeops.multicomponentenvelopeops
import jneqsim.thermodynamicoperations.propertygenerator
...
class ThermodynamicOperations(java.io.Serializable, java.lang.Cloneable):
    ...
    @typing.overload
    def PVFflash(self, double: float) -> None: ...
    @typing.overload
    def PVFflash(self, double: float, double2: float, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def PVflash(self, double: float) -> None: ...
    @typing.overload
    def PVflash(self, double: float, string: typing.Union[java.lang.String, str]) -> None: ...
    def PVrefluxFlash(self, double: float, int: int) -> None: ...
    @typing.overload
    def THflash(self, double: float) -> None: ...
    @typing.overload
    def THflash(self, double: float, string: typing.Union[java.lang.String, str]) -> None: ...
    ...
    def TPgradientFlash(self, double: float, double2: float) -> jneqsim.thermo.system.SystemInterface: ...
    @typing.overload
    def TSflash(self, double: float) -> None: ...
    @typing.overload
    def TSflash(self, double: float, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def TUflash(self, double: float) -> None: ...
    @typing.overload
    def TUflash(self, double: float, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def VUflash(self, double: float, double2: float, boolean: bool) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def VUflash(self, double: float, double2: float, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], boolean: bool) -> None: ...
    def addData(self, string: typing.Union[java.lang.String, str], doubleArray: typing.Union[typing.List[typing.MutableSequence[float]], jpype.JArray]) -> None: ...
    ...
    @typing.overload
    def asphalteneOnsetPressure(self) -> float: ...
    @typing.overload
    def asphalteneOnsetPressure(self, double: float, double2: float) -> float: ...
    @typing.overload
    def asphalteneOnsetTemperature(self) -> float: ...
    @typing.overload
    def asphalteneOnsetTemperature(self, double: float, double2: float, double3: float) -> float: ...
    @typing.overload
    ...
    @typing.overload
    def calcPTphaseEnvelopeWithQualityLines(self, boolean: bool, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    @typing.overload
    def calcPTphaseEnvelopeWithQualityLines(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    def calcPTphaseEnvelopeWithStabilityAnalysis(self) -> None: ...
    def calcPloadingCurve(self) -> None: ...
    def calcSaltSaturation(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def calcSaltSaturationWithDiagnostics(self, string: typing.Union[java.lang.String, str]) -> jneqsim.thermodynamicoperations.flashops.saturationops.SaltSaturationResult: ...
    @typing.overload
    ...
    @typing.overload
    def capillaryDewPointTemperatureFlash(self, double: float) -> None: ...
    @typing.overload
    def capillaryDewPointTemperatureFlash(self, double: float, double2: float) -> None: ...
    ...
    def displayResult(self) -> None: ...
    def electrolytePhaseBoundaryPressureFlash(self, phaseType: jneqsim.thermo.phase.PhaseType, double: float, double2: float, double3: float, int: int) -> jneqsim.thermodynamicoperations.flashops.saturationops.ElectrolytePhaseBoundaryResult: ...
    def electrolytePhaseBoundaryTemperatureFlash(self, phaseType: jneqsim.thermo.phase.PhaseType, double: float, double2: float, double3: float, int: int) -> jneqsim.thermodynamicoperations.flashops.saturationops.ElectrolytePhaseBoundaryResult: ...
    def equilibrateScales(self, multiSaltPrecipitationResult: jneqsim.thermodynamicoperations.flashops.saturationops.MultiSaltPrecipitationResult) -> jneqsim.thermodynamicoperations.flashops.saturationops.MultiSaltPrecipitationResult: ...
    ...
    def freezingPointTemperatureFlashResult(self) -> jneqsim.thermodynamicoperations.flashops.saturationops.FreezingPointResult: ...
    def gasHydrateTPflash(self) -> None: ...
    @typing.overload
    def get(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[float]: ...
    @typing.overload
    def get(self, string: typing.Union[java.lang.String, str], doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> typing.MutableSequence[float]: ...
    ...
    def getEnvelopeSegments(self) -> java.util.List[jneqsim.thermodynamicoperations.phaseenvelopeops.multicomponentenvelopeops.EnvelopeSegment]: ...
    def getJfreeChart(self) -> org.jfree.chart.JFreeChart: ...
    def getOperation(self) -> OperationInterface: ...
    @typing.overload
    def getRelativeScalePotential(self, int: int, string: typing.Union[java.lang.String, str]) -> float: ...
    @typing.overload
    def getRelativeScalePotential(self, string: typing.Union[java.lang.String, str]) -> float: ...
    def getResultTable(self) -> typing.MutableSequence[typing.MutableSequence[java.lang.String]]: ...
    ...
    @typing.overload
    def hydrateTPflash(self) -> None: ...
    @typing.overload
    def hydrateTPflash(self, boolean: bool) -> None: ...
    def isRunAsThread(self) -> bool: ...
    def precipitateScale(self, string: typing.Union[java.lang.String, str]) -> jneqsim.thermodynamicoperations.flashops.saturationops.SaltPrecipitationResult: ...
    def precipitateScales(self, *string: typing.Union[java.lang.String, str]) -> jneqsim.thermodynamicoperations.flashops.saturationops.MultiSaltPrecipitationResult: ...
    def printToFile(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def propertyFlash(self, list: java.util.List[float], list2: java.util.List[float], int: int, list3: java.util.List[typing.Union[java.lang.String, str]], list4: java.util.List[java.util.List[float]]) -> jneqsim.api.ioc.CalculationResult: ...
    def qualifyCalciumSulfatePhaseBoundary(self) -> jneqsim.thermodynamicoperations.flashops.saturationops.CalciumSulfatePhaseBoundaryQualification: ...
    def reactivePHflash(self, double: float, int: int) -> None: ...
    def reactivePSflash(self, double: float) -> None: ...
    def reactiveTPflash(self) -> None: ...
    def run(self) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.thermodynamicoperations")``.
    ...
    chemicalequilibrium: jneqsim.thermodynamicoperations.chemicalequilibrium.__module_protocol__
    flashops: jneqsim.thermodynamicoperations.flashops.__module_protocol__
    phaseenvelopeops: jneqsim.thermodynamicoperations.phaseenvelopeops.__module_protocol__
    propertygenerator: jneqsim.thermodynamicoperations.propertygenerator.__module_protocol__
