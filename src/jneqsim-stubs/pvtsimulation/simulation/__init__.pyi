...
class ConstantMassExpansion(BasePVTsimulation):
    ...
    def calculateRelativeVolumeDeviation(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
...
class MMPCalculator(BasePVTsimulation):
    ...
    def run(self) -> None: ...
    def setMethod(
        self, calculationMethod: "MMPCalculator.CalculationMethod"
    ) -> None: ...
    ...
    class CalculationMethod(java.lang.Enum["MMPCalculator.CalculationMethod"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "MMPCalculator.CalculationMethod": ...
        @staticmethod
    ...
    class MiscibilityMechanism(java.lang.Enum["MMPCalculator.MiscibilityMechanism"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "MMPCalculator.MiscibilityMechanism": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["MMPCalculator.MiscibilityMechanism"]
        ): ...
...
class MultiStageSeparatorTest(BasePVTsimulation):
    ...
    def getStageResults(
        self,
    ) -> java.util.List["MultiStageSeparatorTest.SeparatorStageResult"]: ...
    def getStockTankAPIGravity(self) -> float: ...
    def getStockTankOilDensity(self) -> float: ...
    def getTotalGOR(self) -> float: ...
    @typing.overload
    def optimizeFirstStageSeparator(
        self,
    ) -> "MultiStageSeparatorTest.OptimizationResult": ...
    @typing.overload
    def optimizeFirstStageSeparator(
        self,
        double: float,
...
class SolutionGasWaterRatio(BasePVTsimulation):
    ...
    @typing.overload
    def setCalculationMethod(
        self, calculationMethod: "SolutionGasWaterRatio.CalculationMethod"
    ) -> None: ...
    @typing.overload
    ...
    class CalculationMethod(java.lang.Enum["SolutionGasWaterRatio.CalculationMethod"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "SolutionGasWaterRatio.CalculationMethod": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["SolutionGasWaterRatio.CalculationMethod"]
        ): ...
