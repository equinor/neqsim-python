...
class ChemicalReactionOperations(jneqsim.thermo.ThermodynamicConstantsInterface, java.lang.Cloneable):
    ...
    def getElementBalanceResiduals(self) -> java.util.Map[java.lang.String, float]: ...
    ...
    def getNormalizedReactivePhaseChargeResidual(self) -> float: ...
    def getReactionDataSource(self) -> jneqsim.chemicalreactions.chemicalreaction.ChemicalReactionDataSource: ...
    def getReactionList(self) -> jneqsim.chemicalreactions.chemicalreaction.ChemicalReactionList: ...
    def getReactionLogResiduals(self) -> java.util.Map[java.lang.String, float]: ...
    def getReactivePhaseChargeMoles(self) -> float: ...
