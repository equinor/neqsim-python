...
class ChemicalEquilibrium(java.io.Serializable):
    ...
    def isUseFullMMatrix(self) -> bool: ...
    def printComp(self) -> None: ...
    def setConvergenceTolerance(self, double: float) -> None: ...
    def setMaxIterations(self, int: int) -> None: ...
    def setUseAdaptiveDerivatives(self, boolean: bool) -> None: ...
    def setUseFugacityDerivatives(self, boolean: bool) -> None: ...
    def setUseFullMMatrix(self, boolean: bool) -> None: ...
    def solve(self) -> bool: ...
    def step(self) -> float: ...
