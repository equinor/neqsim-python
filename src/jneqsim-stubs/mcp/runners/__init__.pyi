...
class __module_protocol__(Protocol):
    ...
    UtilityDesignRunner: typing.Type[UtilityDesignRunner]
    ...
    WellIntegrityRunner: typing.Type[WellIntegrityRunner]
