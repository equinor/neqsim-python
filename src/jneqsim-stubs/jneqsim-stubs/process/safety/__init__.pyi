...
class DisposalNetwork(java.io.Serializable):
    def __init__(self): ...
    def evaluate(
        self, list: java.util.List["ProcessSafetyLoadCase"]
    ) -> jneqsim.process.safety.dto.DisposalNetworkSummaryDTO: ...
    def mapSourceToDisposal(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ) -> None: ...
    def registerDisposalUnit(
        self, flare: jneqsim.process.equipment.flare.Flare
    ) -> None: ...
...
class ProcessSafetyAnalysisSummary(java.io.Serializable):
    def __init__(
        self,
        string: typing.Union[java.lang.String, str],
        set: java.util.Set[typing.Union[java.lang.String, str]],
        string2: typing.Union[java.lang.String, str],
        map: typing.Union[
            java.util.Map[
        ...
        map2: typing.Union[
            java.util.Map[
                ...
                "ProcessSafetyAnalysisSummary.UnitKpiSnapshot",
            ],
            typing.Mapping[
                typing.Union[java.lang.String, str],
                "ProcessSafetyAnalysisSummary.UnitKpiSnapshot",
    ...
    def getUnitKpis(
        ...
        java.lang.String, "ProcessSafetyAnalysisSummary.UnitKpiSnapshot"
    ]: ...
...
class ProcessSafetyAnalyzer(java.io.Serializable):
    ...
    def __init__(
        ...
        processSafetyResultRepository: typing.Union[
            "ProcessSafetyResultRepository", typing.Callable
        ],
    ): ...
    ...
    def analyze(
        ...
        collection: typing.Union[
            java.util.Collection["ProcessSafetyScenario"],
            typing.Sequence["ProcessSafetyScenario"],
            typing.Set["ProcessSafetyScenario"],
        ],
    ) -> java.util.List[ProcessSafetyAnalysisSummary]: ...
    @typing.overload
    def analyze(
        self, processSafetyScenario: "ProcessSafetyScenario"
...
class ProcessSafetyLoadCase(java.io.Serializable):
    ...
    def addReliefSource(
        self,
        string: typing.Union[java.lang.String, str],
        reliefSourceLoad: "ProcessSafetyLoadCase.ReliefSourceLoad",
    ) -> None: ...
    def getName(self) -> java.lang.String: ...
    def getReliefLoads(
        self,
    ) -> java.util.Map[java.lang.String, "ProcessSafetyLoadCase.ReliefSourceLoad"]: ...
...
class ProcessSafetyResultRepository:
    ...
    def save(
        self, processSafetyAnalysisSummary: ProcessSafetyAnalysisSummary
    ) -> None: ...
...
class ProcessSafetyScenario(java.io.Serializable):
    ...
    def getControllerSetPointOverrides(
        self,
    ) -> java.util.Map[java.lang.String, float]: ...
    def getCustomManipulators(
        self,
    ) -> java.util.Map[
        java.lang.String,
    ...
    class Builder:
        ...
        def blockOutlets(
            self,
            collection: typing.Union[
                java.util.Collection[typing.Union[java.lang.String, str]],
                typing.Sequence[typing.Union[java.lang.String, str]],
                typing.Set[typing.Union[java.lang.String, str]],
            ],
        ) -> "ProcessSafetyScenario.Builder": ...
        def build(self) -> "ProcessSafetyScenario": ...
        def controllerSetPoint(
            self, string: typing.Union[java.lang.String, str], double: float
        ) -> "ProcessSafetyScenario.Builder": ...
        def customManipulator(
            self,
            string: typing.Union[java.lang.String, str],
            consumer: typing.Union[
                ...
                typing.Callable[
                    [jneqsim.process.equipment.ProcessEquipmentInterface], None
                ],
            ],
        ) -> "ProcessSafetyScenario.Builder": ...
        def utilityLoss(
