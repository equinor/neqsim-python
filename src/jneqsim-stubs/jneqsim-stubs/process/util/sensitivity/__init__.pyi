...
class ProcessSensitivityAnalyzer(java.io.Serializable):
    ...
    def computeFiniteDifferencesOnly(self) -> jneqsim.process.util.uncertainty.SensitivityMatrix: ...
    def generateReport(self, sensitivityMatrix: jneqsim.process.util.uncertainty.SensitivityMatrix) -> java.lang.String: ...
    def reset(self) -> 'ProcessSensitivityAnalyzer': ...
    def withCentralDifferences(self, boolean: bool) -> 'ProcessSensitivityAnalyzer': ...
    @typing.overload
    def withInput(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'ProcessSensitivityAnalyzer': ...
    @typing.overload
    def withInput(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ProcessSensitivityAnalyzer': ...
    @typing.overload
    def withOutput(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'ProcessSensitivityAnalyzer': ...
    @typing.overload
    def withOutput(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ProcessSensitivityAnalyzer': ...
