...
class ProcessEvent(java.io.Serializable):
    ...
    def getProperty(
        self,
        string: typing.Union[java.lang.String, str],
        class_: typing.Type[_getProperty_1__T],
    ) -> _getProperty_1__T: ...
...
class ProcessEventBus(java.io.Serializable):
    ...
    def getEventsBySeverity(
        self, severity: ProcessEvent.Severity, int: int
    ) -> java.util.List[ProcessEvent]: ...
    def getEventsByType(
        self, eventType: ProcessEvent.EventType, int: int
    ) -> java.util.List[ProcessEvent]: ...
    ...
    def subscribe(
        self,
        eventType: ProcessEvent.EventType,
        processEventListener: typing.Union["ProcessEventListener", typing.Callable],
    ) -> None: ...
    @typing.overload
    def subscribe(
        self,
