...
class SensitivityMatrix(java.io.Serializable):
    ...
    def getMostInfluentialInputs(
        self,
    ) -> java.util.Map[java.lang.String, java.lang.String]: ...
    def getNormalizedSensitivities(
        self,
...
class UncertaintyAnalyzer:
    ...
    @typing.overload
    def addInputUncertainty(
        self, string: typing.Union[java.lang.String, str], double: float
    ) -> None: ...
    @typing.overload
    def addInputUncertainty(
        self, inputUncertainty: "UncertaintyAnalyzer.InputUncertainty"
    ) -> None: ...
    def addOutputVariable(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    ...
    class InputUncertainty:
        ...
        def __init__(
            ...
            string: typing.Union[java.lang.String, str],
            double: float,
            distributionType: "UncertaintyAnalyzer.InputUncertainty.DistributionType",
        ): ...
        def getDistribution(
            self,
        ) -> "UncertaintyAnalyzer.InputUncertainty.DistributionType": ...
        def getStandardDeviation(self) -> float: ...
        def getVariableName(self) -> java.lang.String: ...

        class DistributionType(
            java.lang.Enum["UncertaintyAnalyzer.InputUncertainty.DistributionType"]
        ):
            NORMAL: typing.ClassVar[
                "UncertaintyAnalyzer.InputUncertainty.DistributionType"
            ] = ...
            UNIFORM: typing.ClassVar[
                "UncertaintyAnalyzer.InputUncertainty.DistributionType"
            ] = ...
            TRIANGULAR: typing.ClassVar[
                "UncertaintyAnalyzer.InputUncertainty.DistributionType"
            ] = ...
            LOGNORMAL: typing.ClassVar[
                "UncertaintyAnalyzer.InputUncertainty.DistributionType"
            ] = ...
...
class UncertaintyResult(java.io.Serializable):
    ...
    def __init__(
        ...
        map: typing.Union[
            java.util.Map[
                ...
                jneqsim.process.measurementdevice.vfm.UncertaintyBounds,
            ],
            typing.Mapping[
                typing.Union[java.lang.String, str],
                jneqsim.process.measurementdevice.vfm.UncertaintyBounds,
    ...
    def getAllUncertainties(
        self,
    ) -> java.util.Map[
        java.lang.String, jneqsim.process.measurementdevice.vfm.UncertaintyBounds
    ]: ...
    def getConvergenceMetric(self) -> float: ...
    def getMonteCarloSamples(self) -> int: ...
    def getMostUncertainOutput(self) -> java.lang.String: ...
    def getOutputsExceedingThreshold(
        self, double: float
    ) -> java.util.Map[
        java.lang.String, jneqsim.process.measurementdevice.vfm.UncertaintyBounds
    ]: ...
