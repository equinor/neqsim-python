...
class WellFlowlineNetwork(jneqsim.process.equipment.ProcessEquipmentBaseClass):
    ...
    def addBranch(
        ...
        wellFlow: jneqsim.process.equipment.reservoir.WellFlow,
        pipeBeggsAndBrills: jneqsim.process.equipment.pipeline.PipeBeggsAndBrills,
        manifoldNode: "WellFlowlineNetwork.ManifoldNode",
    ) -> "WellFlowlineNetwork.Branch": ...
    @typing.overload
    def addBranch(
        self,
    ...
    def connectManifolds(
        self,
        manifoldNode: "WellFlowlineNetwork.ManifoldNode",
        manifoldNode2: "WellFlowlineNetwork.ManifoldNode",
        pipeBeggsAndBrills: jneqsim.process.equipment.pipeline.PipeBeggsAndBrills,
    ) -> None: ...
    def createManifold(
    ...
    def getTerminalManifoldPressure(
        self, string: typing.Union[java.lang.String, str]
    ) -> float: ...
    @typing.overload
    def run(self) -> None: ...
