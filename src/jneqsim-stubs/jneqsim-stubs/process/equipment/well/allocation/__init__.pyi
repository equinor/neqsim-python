...
class AllocationResult(java.io.Serializable):
    ...
    def getWellAllocation(self, string: typing.Union[java.lang.String, str]) -> java.util.Map[java.lang.String, float]: ...
...
class WellProductionAllocator(java.io.Serializable):
    ...
    def addWell(self, string: typing.Union[java.lang.String, str]) -> 'WellProductionAllocator.WellData': ...
    def allocate(self, double: float, double2: float, double3: float) -> AllocationResult: ...
    def getName(self) -> java.lang.String: ...
    def getWell(self, string: typing.Union[java.lang.String, str]) -> 'WellProductionAllocator.WellData': ...
    def getWellCount(self) -> int: ...
    def getWellNames(self) -> java.util.List[java.lang.String]: ...
    def setAllocationMethod(self, allocationMethod: 'WellProductionAllocator.AllocationMethod') -> None: ...
    ...
    class AllocationMethod(java.lang.Enum['WellProductionAllocator.AllocationMethod']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'WellProductionAllocator.AllocationMethod': ...
        @staticmethod
        def values() -> typing.MutableSequence['WellProductionAllocator.AllocationMethod']: ...
    class WellData(java.io.Serializable):
        ...
        def setTestRates(self, double: float, double2: float, double3: float) -> None: ...
        def setVFMRates(self, double: float, double2: float, double3: float) -> None: ...
        def setWeight(self, double: float) -> None: ...
        def setWellStream(self, streamInterface: jneqsim.process.equipment.stream.StreamInterface) -> None: ...
