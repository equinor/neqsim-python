...
class ProcessGraph(java.io.Serializable):
    ...
    def analyzeTearStreamSensitivity(
        self, list: java.util.List["ProcessNode"]
    ) -> "ProcessGraph.SensitivityAnalysisResult": ...
    ...
    def selectTearStreamsForFastConvergence(
        self,
    ) -> "ProcessGraph.TearStreamResult": ...
    ...
    class TearStreamResult(java.io.Serializable):
        def getSccToTearStreamMap(
            self,
        ) -> java.util.Map[java.util.List["ProcessNode"], ProcessEdge]: ...
...
class ProcessModelGraph(java.io.Serializable):
    ...
    ) -> java.util.List["ProcessModelGraph.InterSystemConnection"]: ...
    ...
    def getIndependentSubSystems(
        self,
    ) -> java.util.List["ProcessModelGraph.SubSystemGraph"]: ...
    def getInterSystemConnectionCount(self) -> int: ...
    def getInterSystemConnections(
        self,
    ) -> java.util.List["ProcessModelGraph.InterSystemConnection"]: ...
    ...
    def getNodeToSubSystemMap(
        self,
    ) -> java.util.Map["ProcessNode", java.lang.String]: ...
    def getStatistics(self) -> java.util.Map[java.lang.String, typing.Any]: ...
    def getSubSystem(
        self, string: typing.Union[java.lang.String, str]
    ) -> "ProcessModelGraph.SubSystemGraph": ...
    def getSubSystemByIndex(self, int: int) -> "ProcessModelGraph.SubSystemGraph": ...
    def getSubSystemCalculationOrder(
        self,
    ) -> java.util.List["ProcessModelGraph.SubSystemGraph"]: ...
    def getSubSystemCount(self) -> int: ...
    def getSubSystemDependencies(
        self,
    ) -> java.util.Map[java.lang.String, java.util.Set[java.lang.String]]: ...
    def getSubSystemGraphs(
        self,
    ) -> java.util.List["ProcessModelGraph.SubSystemGraph"]: ...
    def getSummary(self) -> java.lang.String: ...
    ...
    def partitionForParallelExecution(self) -> ProcessGraph.ParallelPartition: ...
    def partitionSubSystemsForParallelExecution(
        self,
    ) -> "ProcessModelGraph.ModuleParallelPartition": ...
    def toString(self) -> java.lang.String: ...
    ...
    class ModuleParallelPartition(java.io.Serializable):
        ...
        def getLevels(
            self,
        ) -> java.util.List[java.util.List["ProcessModelGraph.SubSystemGraph"]]: ...
        def getMaxParallelism(self) -> int: ...
        def toString(self) -> java.lang.String: ...
