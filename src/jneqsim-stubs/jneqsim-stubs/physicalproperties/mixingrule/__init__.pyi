...
class PhysicalPropertyMixingRuleInterface(java.lang.Cloneable):
    ...
    def initMixingRules(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> None: ...
    def setViscosityGij(self, double: float, int: int, int2: int) -> None: ...

class PhysicalPropertyMixingRule(PhysicalPropertyMixingRuleInterface, jneqsim.thermo.ThermodynamicConstantsInterface):
