...
class PhysicalPropertyMixingRule(
    PhysicalPropertyMixingRuleInterface, jneqsim.thermo.ThermodynamicConstantsInterface
):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.physicalproperties.mixingrule")``.

    PhysicalPropertyMixingRule: typing.Type[PhysicalPropertyMixingRule]
    PhysicalPropertyMixingRuleInterface: typing.Type[
