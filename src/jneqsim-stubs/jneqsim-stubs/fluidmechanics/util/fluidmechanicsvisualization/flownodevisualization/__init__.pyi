...
class __module_protocol__(Protocol):
    ...
    onephaseflownodevisualization: (
        jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flownodevisualization.onephaseflownodevisualization.__module_protocol__
    )
    twophaseflownodevisualization: (
        jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flownodevisualization.twophaseflownodevisualization.__module_protocol__
    )
