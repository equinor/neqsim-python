...
class StirredCellSystem(jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.TwoPhaseFlowSystem):
    def __init__(self): ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.stirredcellsystem")``.
