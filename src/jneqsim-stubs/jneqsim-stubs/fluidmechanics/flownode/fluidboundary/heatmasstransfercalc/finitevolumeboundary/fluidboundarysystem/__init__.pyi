...
class FluidBoundarySystemInterface:
    def addBoundary(self, fluidBoundaryInterface: jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.FluidBoundaryInterface) -> None: ...
    ...
    def getNode(self, int: int) -> jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.finitevolumeboundary.fluidboundarynode.FluidBoundaryNodeInterface: ...
...
class __module_protocol__(Protocol):
    ...
    fluidboundarynonreactive: jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.finitevolumeboundary.fluidboundarysystem.fluidboundarynonreactive.__module_protocol__
    fluidboundarysystemreactive: jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.finitevolumeboundary.fluidboundarysystem.fluidboundarysystemreactive.__module_protocol__
