...
class __module_protocol__(Protocol):
    ...
    heatmasstransfercalc: (
        jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.__module_protocol__
    )
    interphasetransportcoefficient: (
        jneqsim.fluidmechanics.flownode.fluidboundary.interphasetransportcoefficient.__module_protocol__
    )
