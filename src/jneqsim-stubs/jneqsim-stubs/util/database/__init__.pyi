...
class AspenIP21Database(jneqsim.util.util.FileSystemSettings, java.io.Serializable):
    def __init__(self): ...
    @typing.overload
...
class NeqSimBlobDatabase(jneqsim.util.util.FileSystemSettings, java.io.Serializable):
...
class NeqSimDataBase(jneqsim.util.util.FileSystemSettings, java.io.Serializable, java.lang.AutoCloseable):
    dataBasePath: typing.ClassVar[java.lang.String] = ...
    def __init__(self): ...
    def close(self) -> None: ...
    @staticmethod
...
class NeqSimExperimentDatabase(jneqsim.util.util.FileSystemSettings, java.io.Serializable):
    dataBasePath: typing.ClassVar[java.lang.String] = ...
...
class NeqSimFluidDataBase(jneqsim.util.util.FileSystemSettings, java.io.Serializable):
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.util.database")``.
