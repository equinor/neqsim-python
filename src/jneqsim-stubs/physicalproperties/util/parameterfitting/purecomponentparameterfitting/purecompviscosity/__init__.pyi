...
class __module_protocol__(Protocol):
    ...
    chungmethod: (
        jneqsim.physicalproperties.util.parameterfitting.purecomponentparameterfitting.purecompviscosity.chungmethod.__module_protocol__
    )
    linearliquidmodel: (
        jneqsim.physicalproperties.util.parameterfitting.purecomponentparameterfitting.purecompviscosity.linearliquidmodel.__module_protocol__
    )
