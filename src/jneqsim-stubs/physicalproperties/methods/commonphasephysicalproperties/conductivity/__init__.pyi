...
class ChungDenseConductivityMethod(Conductivity, jneqsim.thermo.ThermodynamicConstantsInterface):
    def __init__(self, physicalProperties: jneqsim.physicalproperties.system.PhysicalProperties): ...
    def calcConductivity(self) -> float: ...

class FrictionTheoryConductivityMethod(Conductivity, jneqsim.thermo.ThermodynamicConstantsInterface):
