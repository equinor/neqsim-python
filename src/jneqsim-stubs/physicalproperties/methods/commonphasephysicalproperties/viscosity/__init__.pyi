...
class Viscosity(jneqsim.physicalproperties.methods.commonphasephysicalproperties.CommonPhysicalPropertyMethod, jneqsim.physicalproperties.methods.methodinterface.ViscosityInterface):
...
class FrictionTheoryViscosityMethod(Viscosity, jneqsim.thermo.ThermodynamicConstantsInterface):
    pureComponentViscosity: typing.MutableSequence[float] = ...
...
class PFCTViscosityMethod(Viscosity):
    def __init__(self, physicalProperties: jneqsim.physicalproperties.system.PhysicalProperties): ...
    def calcViscosity(self) -> float: ...
    def clone(self) -> 'PFCTViscosityMethod': ...
...
class PFCTViscosityMethodHeavyOil(Viscosity):
    def __init__(self, physicalProperties: jneqsim.physicalproperties.system.PhysicalProperties): ...
    def calcViscosity(self) -> float: ...
    def clone(self) -> 'PFCTViscosityMethodHeavyOil': ...
    def getCspViscosityCorrectionFactors(self) -> typing.MutableSequence[float]: ...
    def getRefComponentViscosity(self, double: float, double2: float) -> float: ...
    def setCspViscosityCorrectionFactor(self, int: int, double: float) -> None: ...
    def setCspViscosityCorrectionFactors(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
...
class PFCTViscosityMethodMod86(Viscosity):
    def __init__(self, physicalProperties: jneqsim.physicalproperties.system.PhysicalProperties): ...
    def calcViscosity(self) -> float: ...
    def clone(self) -> 'PFCTViscosityMethodMod86': ...
    def getCspViscosityCorrectionFactors(self) -> typing.MutableSequence[float]: ...
    def getRefComponentViscosity(self, double: float, double2: float) -> float: ...
    def setCspViscosityCorrectionFactor(self, int: int, double: float) -> None: ...
    def setCspViscosityCorrectionFactors(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
