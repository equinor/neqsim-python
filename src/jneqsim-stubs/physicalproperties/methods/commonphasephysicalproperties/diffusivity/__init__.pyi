...
class Diffusivity(
    ...
    jneqsim.physicalproperties.methods.methodinterface.DiffusivityInterface,
):
    def __init__(
    ...
    def getMaxwellStefanBinaryDiffusionCoefficient(
        self, int: int, int2: int
    ) -> float: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.physicalproperties.methods.commonphasephysicalproperties.diffusivity")``.
