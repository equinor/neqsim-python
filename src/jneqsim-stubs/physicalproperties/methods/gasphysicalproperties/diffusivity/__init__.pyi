...
class Diffusivity(
    ...
    def setUseDiffusionLJOverride(self, boolean: bool) -> None: ...

class FullerSchettlerGiddingsDiffusivity(Diffusivity):
    def __init__(
        self, physicalProperties: jneqsim.physicalproperties.system.PhysicalProperties
    ): ...
    def calcBinaryDiffusionCoefficient(
...
class __module_protocol__(Protocol):
    ...
    FullerSchettlerGiddingsDiffusivity: typing.Type[FullerSchettlerGiddingsDiffusivity]
