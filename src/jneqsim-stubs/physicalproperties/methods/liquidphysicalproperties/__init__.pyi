...
class LiquidPhysicalPropertyMethod(
...
class __module_protocol__(Protocol):
    ...
    conductivity: (
        jneqsim.physicalproperties.methods.liquidphysicalproperties.conductivity.__module_protocol__
    )
    density: (
        jneqsim.physicalproperties.methods.liquidphysicalproperties.density.__module_protocol__
    )
    diffusivity: (
        jneqsim.physicalproperties.methods.liquidphysicalproperties.diffusivity.__module_protocol__
    )
    viscosity: (
        jneqsim.physicalproperties.methods.liquidphysicalproperties.viscosity.__module_protocol__
    )
