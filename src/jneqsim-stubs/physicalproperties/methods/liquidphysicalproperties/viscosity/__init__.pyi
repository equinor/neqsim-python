...
class Viscosity(jneqsim.physicalproperties.methods.liquidphysicalproperties.LiquidPhysicalPropertyMethod, jneqsim.physicalproperties.methods.methodinterface.ViscosityInterface):
...
class AmineViscosity(Viscosity):
    ...
    class AmineType(java.lang.Enum['AmineViscosity.AmineType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'AmineViscosity.AmineType': ...
        @staticmethod
