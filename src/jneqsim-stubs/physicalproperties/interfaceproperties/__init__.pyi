...
class InterphasePropertiesInterface(java.lang.Cloneable):
    ...
    @typing.overload
    def getAdsorptionCalc(self, string: typing.Union[java.lang.String, str]) -> jneqsim.physicalproperties.interfaceproperties.solidadsorption.AdsorptionInterface: ...
    @typing.overload
    def getAdsorptionCalc(self) -> typing.MutableSequence[jneqsim.physicalproperties.interfaceproperties.solidadsorption.AdsorptionInterface]: ...
    ...
    def getSurfaceTensionModel(self, int: int) -> jneqsim.physicalproperties.interfaceproperties.surfacetension.SurfaceTensionInterface: ...
    @typing.overload
    def init(self) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def initAdsorption(self, isothermType: jneqsim.physicalproperties.interfaceproperties.solidadsorption.IsothermType) -> None: ...
    def setAdsorptionCalc(self, adsorptionInterfaceArray: typing.Union[typing.List[jneqsim.physicalproperties.interfaceproperties.solidadsorption.AdsorptionInterface], jpype.JArray]) -> None: ...
    @typing.overload
...
class __module_protocol__(Protocol):
    ...
    solidadsorption: jneqsim.physicalproperties.interfaceproperties.solidadsorption.__module_protocol__
    surfacetension: jneqsim.physicalproperties.interfaceproperties.surfacetension.__module_protocol__
