...
class GTSurfaceTensionODE(org.apache.commons.math3.ode.FirstOrderDifferentialEquations):
    ...
    abstol: float = ...
    maxit: int = ...
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, int: int, int2: int, int3: int, double: float): ...
...
class SurfaceTension(jneqsim.physicalproperties.interfaceproperties.InterfaceProperties, SurfaceTensionInterface):
    @typing.overload
    def __init__(self): ...
    @typing.overload
...
class GTSurfaceTension(SurfaceTension):
    ...
    def calcSurfaceTension(self, int: int, int2: int) -> float: ...
    @staticmethod
    def solveFullDensityProfile(systemInterface: jneqsim.thermo.system.SystemInterface, int: int, int2: int) -> float: ...
    @staticmethod
    def solveWithRefcomp(systemInterface: jneqsim.thermo.system.SystemInterface, int: int, int2: int, int3: int) -> float: ...
