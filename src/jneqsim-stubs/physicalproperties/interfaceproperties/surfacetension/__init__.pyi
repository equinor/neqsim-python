...
class GTSurfaceTensionFullGT:
    ...
    @staticmethod
    def linspace(
        double: float, double2: float, int: int
...
class SurfaceTension(
    jneqsim.physicalproperties.interfaceproperties.InterfaceProperties,
    SurfaceTensionInterface,
):
    @typing.overload
    def __init__(self): ...
    @typing.overload
...
class CDFTSurfaceTension(SurfaceTension):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface): ...
    def calcSurfaceTension(self, int: int, int2: int) -> float: ...
    def getAttractiveRangeFactor(self) -> float: ...
    def getNGrid(self) -> int: ...
    def isUsePredictiveMode(self) -> bool: ...
    def setAttractiveRangeFactor(self, double: float) -> None: ...
    def setNGrid(self, int: int) -> None: ...
    def setUsePredictiveMode(self, boolean: bool) -> None: ...
...
class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.physicalproperties.interfaceproperties.surfacetension")``.

    CDFTSurfaceTension: typing.Type[CDFTSurfaceTension]
