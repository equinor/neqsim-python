...
class PhysicalProperties(java.lang.Cloneable, jneqsim.thermo.ThermodynamicConstantsInterface):
    ...
    def getCspViscosityCorrectionFactors(self) -> typing.MutableSequence[float]: ...
    def getCspViscosityParameters(self) -> typing.MutableSequence[float]: ...
    ...
    def isLBCViscosityModel(self) -> bool: ...
    def isPFCTViscosityModel(self) -> bool: ...
    ...
    def setCspViscosityCorrectionFactor(self, int: int, double: float) -> None: ...
    def setCspViscosityCorrectionFactors(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
    def setCspViscosityParameter(self, int: int, double: float) -> None: ...
    def setCspViscosityParameters(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> None: ...
