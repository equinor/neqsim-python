...
class PhysicalProperties(
    java.lang.Cloneable, jneqsim.thermo.ThermodynamicConstantsInterface
):
    conductivityCalc: (
    ...
    def getMixingRule(
        self,
    ) -> jneqsim.physicalproperties.mixingrule.PhysicalPropertyMixingRuleInterface: ...
...
class __module_protocol__(Protocol):
    ...
    commonphasephysicalproperties: (
        jneqsim.physicalproperties.system.commonphasephysicalproperties.__module_protocol__
    )
    gasphysicalproperties: (
        jneqsim.physicalproperties.system.gasphysicalproperties.__module_protocol__
    )
    liquidphysicalproperties: (
        jneqsim.physicalproperties.system.liquidphysicalproperties.__module_protocol__
    )
    solidphysicalproperties: (
        jneqsim.physicalproperties.system.solidphysicalproperties.__module_protocol__
    )
