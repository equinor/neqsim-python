...
class __module_protocol__(Protocol):
    ...
    experimentalequipmentdata: jneqsim.statistics.experimentalequipmentdata.__module_protocol__
    experimentalsamplecreation: jneqsim.statistics.experimentalsamplecreation.__module_protocol__
