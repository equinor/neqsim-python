...
class __module_protocol__(Protocol):
    ...
    packings: jneqsim.fluidmechanics.geometrydefinitions.internalgeometry.packings.__module_protocol__
    wall: jneqsim.fluidmechanics.geometrydefinitions.internalgeometry.wall.__module_protocol__
