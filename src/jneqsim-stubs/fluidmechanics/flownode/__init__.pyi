...
class InterfacialAreaCalculator:
    ...
    @staticmethod
    def calculateAnnularAreaWithEntrainment(
        double: float,
        double2: float,
        double3: float,
        double4: float,
    ...
    @staticmethod
    def calculateEnhancedInterfacialArea(
        flowPattern: FlowPattern,
        double: float,
        double2: float,
        double3: float,
    ...
    @staticmethod
    def calculateStratifiedWavyArea(
        double: float,
        double2: float,
        double3: float,
        double4: float,
    ...
    @staticmethod
    def getExpectedInterfacialAreaRange(
        flowPattern: FlowPattern, double: float
...
class MassTransferCoefficientCalculator:
    @staticmethod
    def applyMarangoniCorrection(
        double: float, double2: float, double3: float, double4: float
    ) -> float: ...
    @staticmethod
    def calculateDittusBoelterSherwood(double: float, double2: float) -> float: ...
    @staticmethod
    def calculateEnhancedLiquidMassTransferCoefficient(
        flowPattern: FlowPattern,
        double: float,
        double2: float,
        double3: float,
    ...
    @staticmethod
    def calculateLiquidMassTransferCoefficientWithTurbulence(
        flowPattern: FlowPattern,
        double: float,
        double2: float,
        double3: float,
    ...
    @staticmethod
    def estimateTurbulentIntensity(
        flowPattern: FlowPattern, double: float
    ) -> float: ...
    @staticmethod
    def getExpectedMassTransferCoefficientRange(
        flowPattern: FlowPattern, int: int
    ) -> typing.MutableSequence[float]: ...
    @staticmethod
    def validateAgainstLiterature(
        double: float, flowPattern: FlowPattern, int: int
    ) -> bool: ...
