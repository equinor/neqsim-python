...
class WaxDepositionFlowNode(
    jneqsim.fluidmechanics.flownode.multiphasenode.MultiPhaseFlowNode
):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    ...
    def clone(
        ...
        jneqsim.fluidmechanics.flownode.twophasenode.twophasepipeflownode.StratifiedFlowNode
    ): ...
