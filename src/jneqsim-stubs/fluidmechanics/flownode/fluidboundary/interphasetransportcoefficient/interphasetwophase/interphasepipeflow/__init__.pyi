...
class InterphaseDropletFlow(
    ...
    def calcAbramzonSirignanoF(self, double: float) -> float: ...
    ...
    def getSpaldingMassTransferNumber(self) -> float: ...
    def isUseAbramzonSirignano(self) -> bool: ...
    def setSpaldingMassTransferNumber(self, double: float) -> None: ...
