...
class __module_protocol__(Protocol):
    ...
    interphasepipeflow: (
        jneqsim.fluidmechanics.flownode.fluidboundary.interphasetransportcoefficient.interphaseonephase.interphasepipeflow.__module_protocol__
    )
