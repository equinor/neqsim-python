...
class __module_protocol__(Protocol):
    ...
    shipsystem: jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.shipsystem.__module_protocol__
    stirredcellsystem: jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.stirredcellsystem.__module_protocol__
    twophasepipeflowsystem: jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.twophasepipeflowsystem.__module_protocol__
    twophasereactorflowsystem: jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.twophasereactorflowsystem.__module_protocol__
