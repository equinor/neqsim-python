...
class FlowSystemInterface:
    ...
    def getDisplay(self) -> jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flowsystemvisualization.FlowSystemVisualizationInterface: ...
    ...
    def setEquipmentGeometry(self, geometryDefinitionInterfaceArray: typing.Union[typing.List[jneqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface], jpype.JArray]) -> None: ...
    ...
    def setInletThermoSystem(self, systemInterface: jneqsim.thermo.system.SystemInterface) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    onephaseflowsystem: jneqsim.fluidmechanics.flowsystem.onephaseflowsystem.__module_protocol__
    twophaseflowsystem: jneqsim.fluidmechanics.flowsystem.twophaseflowsystem.__module_protocol__
