...
class __module_protocol__(Protocol):
    ...
    onephaseflowvisualization: (
        jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flowsystemvisualization.onephaseflowvisualization.__module_protocol__
    )
    twophaseflowvisualization: (
        jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flowsystemvisualization.twophaseflowvisualization.__module_protocol__
    )
