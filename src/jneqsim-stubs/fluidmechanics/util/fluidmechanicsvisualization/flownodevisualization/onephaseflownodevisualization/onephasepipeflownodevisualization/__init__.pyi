...
class OnePhasePipeFlowNodeVisualization(jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flownodevisualization.onephaseflownodevisualization.OnePhaseFlowNodeVisualization):
    def __init__(self): ...
