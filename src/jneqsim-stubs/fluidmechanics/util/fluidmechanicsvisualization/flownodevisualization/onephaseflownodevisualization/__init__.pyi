...
class OnePhaseFlowNodeVisualization(
...
class __module_protocol__(Protocol):
    ...
    onephasepipeflownodevisualization: (
        jneqsim.fluidmechanics.util.fluidmechanicsvisualization.flownodevisualization.onephaseflownodevisualization.onephasepipeflownodevisualization.__module_protocol__
    )
