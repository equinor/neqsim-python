...
class ElectrolyzerCostEstimate(jneqsim.process.costestimation.UnitCostEstimateBaseClass):
    def __init__(self, electrolyzerMechanicalDesign: jneqsim.process.mechanicaldesign.electrolyzer.ElectrolyzerMechanicalDesign): ...
