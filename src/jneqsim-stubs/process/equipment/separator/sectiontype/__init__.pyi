...
class SeparatorSection(jneqsim.util.NamedBaseClass):
    ...
    def getMechanicalDesign(
        self,
    ) -> jneqsim.process.mechanicaldesign.separator.sectiontype.SepDesignSection: ...
...
class ManwaySection(SeparatorSection):
    ...
    def getMechanicalDesign(
        self,
    ) -> jneqsim.process.mechanicaldesign.separator.sectiontype.MechManwaySection: ...
...
class MeshSection(SeparatorSection):
    ...
    def getMechanicalDesign(
        self,
    ) -> jneqsim.process.mechanicaldesign.separator.sectiontype.MecMeshSection: ...
...
class NozzleSection(SeparatorSection):
    ...
    def getMechanicalDesign(
        self,
    ) -> jneqsim.process.mechanicaldesign.separator.sectiontype.MechNozzleSection: ...
...
class ValveSection(SeparatorSection):
    ...
    def getMechanicalDesign(
        ...
        jneqsim.process.mechanicaldesign.separator.sectiontype.DistillationTraySection
    ): ...
...
class VaneSection(SeparatorSection):
    ...
    def getMechanicalDesign(
        self,
    ) -> jneqsim.process.mechanicaldesign.separator.sectiontype.MechVaneSection: ...
