...
class AUSMPlusFluxCalculator(java.io.Serializable):
    ...
    def calcPhaseFlux(
        self,
        phaseState: "AUSMPlusFluxCalculator.PhaseState",
        phaseState2: "AUSMPlusFluxCalculator.PhaseState",
        double: float,
    ) -> "AUSMPlusFluxCalculator.PhaseFlux": ...
    ...
    def calcTwoFluidFlux(
        self,
        phaseState: "AUSMPlusFluxCalculator.PhaseState",
        phaseState2: "AUSMPlusFluxCalculator.PhaseState",
        phaseState3: "AUSMPlusFluxCalculator.PhaseState",
        phaseState4: "AUSMPlusFluxCalculator.PhaseState",
        double: float,
    ) -> "AUSMPlusFluxCalculator.TwoFluidFlux": ...
    def calcUpwindFlux(
        self,
        phaseState: "AUSMPlusFluxCalculator.PhaseState",
        phaseState2: "AUSMPlusFluxCalculator.PhaseState",
...
class ConservativeStateLimiter:
    @staticmethod
    def enforceThreePhaseMassPositivity(
...
class MUSCLReconstructor(java.io.Serializable):
    ...
    ) -> typing.MutableSequence["MUSCLReconstructor.ReconstructedPair"]: ...
    def setLimiterType(
        self, slopeLimiter: "MUSCLReconstructor.SlopeLimiter"
    ) -> None: ...
    ...
    class SlopeLimiter(java.lang.Enum["MUSCLReconstructor.SlopeLimiter"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "MUSCLReconstructor.SlopeLimiter": ...
        @staticmethod
...
class TimeIntegrator(java.io.Serializable):
    ...
    def step(
        ...
        rHSFunction: typing.Union["TimeIntegrator.RHSFunction", typing.Callable],
        double2: float,
    ...
    def stepIMEXPressureCorrection(
        self,
        doubleArray: typing.Union[
            typing.List[typing.MutableSequence[float]], jpype.JArray
        ],
