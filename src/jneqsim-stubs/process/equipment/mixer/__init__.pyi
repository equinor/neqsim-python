...
class Mixer(jneqsim.process.equipment.ProcessEquipmentBaseClass, MixerInterface, jneqsim.process.equipment.capacity.CapacityConstrainedEquipment):
    ...
    def clearOutletPressureSpecification(self) -> None: ...
    ...
    def getInletPressureSpread(self) -> float: ...
    ...
    def getPressureMismatchTolerance(self) -> float: ...
    ...
    def isPressureMismatch(self) -> bool: ...
    @typing.overload
    ...
    def setPressureMismatchTolerance(self, double: float) -> None: ...
