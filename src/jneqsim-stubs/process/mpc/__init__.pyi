...
class ControllerDataExchange(java.io.Serializable):
    ...
    def updateInputsWithQuality(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        doubleArray2: typing.Union[typing.List[float], jpype.JArray],
        doubleArray3: typing.Union[typing.List[float], jpype.JArray],
        qualityStatusArray: typing.Union[
            typing.List["ControllerDataExchange.QualityStatus"], jpype.JArray
        ],
        qualityStatusArray2: typing.Union[
            typing.List["ControllerDataExchange.QualityStatus"], jpype.JArray
        ],
        qualityStatusArray3: typing.Union[
            typing.List["ControllerDataExchange.QualityStatus"], jpype.JArray
        ],
    ) -> None: ...
    def updateLimits(
    ...
    class ControllerOutput(java.io.Serializable):
        def __init__(
            ...
            executionStatus: "ControllerDataExchange.ExecutionStatus",
            string: typing.Union[java.lang.String, str],
            instant: typing.Union[java.time.Instant, datetime.datetime],
        ): ...
        def getCvPredictions(
            self,
    ...
    class ExecutionStatus(java.lang.Enum["ControllerDataExchange.ExecutionStatus"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "ControllerDataExchange.ExecutionStatus": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ControllerDataExchange.ExecutionStatus"]
        ): ...
    ...
    class QualityStatus(java.lang.Enum["ControllerDataExchange.QualityStatus"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "ControllerDataExchange.QualityStatus": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ControllerDataExchange.QualityStatus"]
        ): ...
...
class IndustrialMPCExporter(java.io.Serializable):
    ...
    def exportComprehensiveConfiguration(
    ...
    def exportStepResponseCSV(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def exportStepResponseModel(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def exportTransferFunctions(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def exportVariableConfiguration(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
...
class NonlinearPredictor(java.io.Serializable):
    ...
    def addCV(
        self, controlledVariable: "ControlledVariable"
    ) -> "NonlinearPredictor": ...
    def addMV(
        self, manipulatedVariable: "ManipulatedVariable"
    ) -> "NonlinearPredictor": ...
    def clear(self) -> "NonlinearPredictor": ...
    def getPredictionHorizon(self) -> int: ...
    def getSampleTimeSeconds(self) -> float: ...
    def predict(
        self, mVTrajectory: "NonlinearPredictor.MVTrajectory"
    ) -> "NonlinearPredictor.PredictionResult": ...
    def predictConstant(
        self, *double: float
    ) -> "NonlinearPredictor.PredictionResult": ...
    ...
    class MVTrajectory(java.io.Serializable):
        ...
        ) -> "NonlinearPredictor.MVTrajectory": ...
...
class ProcessDerivativeCalculator:
    ...
    def setMethod(
        self, derivativeMethod: "ProcessDerivativeCalculator.DerivativeMethod"
    ) -> "ProcessDerivativeCalculator": ...
    ...
    class DerivativeMethod(
        ...
        FORWARD_DIFFERENCE: typing.ClassVar[
            "ProcessDerivativeCalculator.DerivativeMethod"
        ] = ...
        CENTRAL_DIFFERENCE: typing.ClassVar[
            "ProcessDerivativeCalculator.DerivativeMethod"
        ] = ...
        CENTRAL_DIFFERENCE_SECOND_ORDER: typing.ClassVar[
            "ProcessDerivativeCalculator.DerivativeMethod"
        ] = ...
        _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
        @typing.overload
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ProcessDerivativeCalculator.DerivativeMethod"]
        ): ...
    ...
    class VariableType(java.lang.Enum["ProcessDerivativeCalculator.VariableType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "ProcessDerivativeCalculator.VariableType": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ProcessDerivativeCalculator.VariableType"]
        ): ...
...
class ProcessLinearizer:
    ...
    def addDV(
        self, disturbanceVariable: "DisturbanceVariable"
    ) -> "ProcessLinearizer": ...
    def addMV(
        self, manipulatedVariable: "ManipulatedVariable"
    ) -> "ProcessLinearizer": ...
    ...
    def linearizeMultiplePoints(
        self, int: int, double: float
    ) -> java.util.List[LinearizationResult]: ...
...
class SoftSensorExporter(java.io.Serializable):
    def __init__(self, processSystem: jneqsim.process.processmodel.ProcessSystem): ...
    def addCompositionEstimator(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
        string3: typing.Union[java.lang.String, str],
    ) -> "SoftSensorExporter": ...
    def addCompressibilitySensor(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ) -> "SoftSensorExporter": ...
    def addCustomSensor(
        ...
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
        sensorType: "SoftSensorExporter.SensorType",
        string3: typing.Union[java.lang.String, str],
    ) -> "SoftSensorExporter.SoftSensorDefinition": ...
    def addDensitySensor(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
        string3: typing.Union[java.lang.String, str],
    ) -> "SoftSensorExporter": ...
    def addHeatCapacitySensor(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
        string3: typing.Union[java.lang.String, str],
    ) -> "SoftSensorExporter": ...
    def addMolecularWeightSensor(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ) -> "SoftSensorExporter": ...
    ...
    def getSensors(
        self,
    ) -> java.util.List["SoftSensorExporter.SoftSensorDefinition"]: ...
    def setApplicationName(
        self, string: typing.Union[java.lang.String, str]
    ) -> "SoftSensorExporter": ...
    def setTagPrefix(
...
class StateSpaceExporter(java.io.Serializable):
    ...
    @typing.overload
    def __init__(
        self, stepResponseMatrix: "StepResponseGenerator.StepResponseMatrix"
    ): ...
    ...
    def exportStepCoefficients(
        self, string: typing.Union[java.lang.String, str], int: int
    ) -> None: ...
    def getStateSpaceModel(self) -> "StateSpaceExporter.StateSpaceModel": ...
    def setStepResponseMatrix(
        self, stepResponseMatrix: "StepResponseGenerator.StepResponseMatrix"
    ) -> "StateSpaceExporter": ...
    def toDiscreteStateSpace(
        self, double: float
    ) -> "StateSpaceExporter.StateSpaceModel": ...
        ...
        def __init__(
            ...
            map: typing.Union[
                java.util.Map[
                    ...
                    typing.Union[
                        java.util.Map[
                            typing.Union[java.lang.String, str], StepResponse
                        ],
                        typing.Mapping[
                            typing.Union[java.lang.String, str], StepResponse
                        ],
...
class SubrModlExporter(java.io.Serializable):
    ...
    def populateFromMPC(
        self, processLinkedMPC: ProcessLinkedMPC
    ) -> "SubrModlExporter": ...
    def setApplicationName(
        self, string: typing.Union[java.lang.String, str]
    ) -> "SubrModlExporter": ...
...
class StateVariable(MPCVariable):
    def __init__(
        self,
        string: typing.Union[java.lang.String, str],
        processEquipmentInterface: jneqsim.process.equipment.ProcessEquipmentInterface,
