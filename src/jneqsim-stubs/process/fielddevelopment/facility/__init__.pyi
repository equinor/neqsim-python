...
class BlockConfig(java.io.Serializable):
    ...
    def getDoubleParameter(self, string: typing.Union[java.lang.String, str], double: float) -> float: ...
    def getIntParameter(self, string: typing.Union[java.lang.String, str], int: int) -> int: ...
    def getName(self) -> java.lang.String: ...
    _getParameter__T = typing.TypeVar('_getParameter__T')  # <T>
    def getParameter(self, string: typing.Union[java.lang.String, str], t: _getParameter__T) -> _getParameter__T: ...
    ...
    @typing.overload
    @staticmethod
    def of(blockType: 'BlockType', string: typing.Union[java.lang.String, str]) -> 'BlockConfig': ...
    @typing.overload
    @staticmethod
    def of(blockType: 'BlockType', map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Any], typing.Mapping[typing.Union[java.lang.String, str], typing.Any]]) -> 'BlockConfig': ...
    @staticmethod
...
class ConceptToProcessLinker(java.io.Serializable):
    def __init__(self): ...
    def generateProcessSystem(self, fieldConcept: jneqsim.process.fielddevelopment.concept.FieldConcept, fidelityLevel: 'ConceptToProcessLinker.FidelityLevel') -> jneqsim.process.processmodel.ProcessSystem: ...
    def getTotalCoolingMW(self, processSystem: jneqsim.process.processmodel.ProcessSystem) -> float: ...
    def getTotalHeatingMW(self, processSystem: jneqsim.process.processmodel.ProcessSystem) -> float: ...
    def getTotalPowerMW(self, processSystem: jneqsim.process.processmodel.ProcessSystem) -> float: ...
    def getUtilitySummary(self, processSystem: jneqsim.process.processmodel.ProcessSystem) -> java.lang.String: ...
    def setCompressionEfficiency(self, double: float) -> None: ...
    def setExportGasPressure(self, double: float) -> None: ...
    def setHpSeparatorPressure(self, double: float) -> None: ...
    def setInletTemperature(self, double: float) -> None: ...
    def setLpSeparatorPressure(self, double: float) -> None: ...
    class FidelityLevel(java.lang.Enum['ConceptToProcessLinker.FidelityLevel']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ConceptToProcessLinker.FidelityLevel': ...
        @staticmethod
        def values() -> typing.MutableSequence['ConceptToProcessLinker.FidelityLevel']: ...
    class ProcessTemplate(java.lang.Enum['ConceptToProcessLinker.ProcessTemplate']):
        OIL_PROCESSING: typing.ClassVar['ConceptToProcessLinker.ProcessTemplate'] = ...
        GAS_PROCESSING: typing.ClassVar['ConceptToProcessLinker.ProcessTemplate'] = ...
        GAS_CONDENSATE: typing.ClassVar['ConceptToProcessLinker.ProcessTemplate'] = ...
        HEAVY_OIL: typing.ClassVar['ConceptToProcessLinker.ProcessTemplate'] = ...
        TIEBACK_PROCESSING: typing.ClassVar['ConceptToProcessLinker.ProcessTemplate'] = ...
        _valueOf_0__T = typing.TypeVar('_valueOf_0__T', bound=java.lang.Enum)  # <T>
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_0__T], string: typing.Union[java.lang.String, str]) -> _valueOf_0__T: ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ConceptToProcessLinker.ProcessTemplate': ...
        @staticmethod
        def values() -> typing.MutableSequence['ConceptToProcessLinker.ProcessTemplate']: ...
...
class FacilityBuilder(java.io.Serializable):
    ...
    @staticmethod
    def autoGenerate(fieldConcept: jneqsim.process.fielddevelopment.concept.FieldConcept) -> 'FacilityBuilder': ...
    def build(self) -> 'FacilityConfig': ...
    def designMargin(self, double: float) -> 'FacilityBuilder': ...
    @staticmethod
    def forConcept(fieldConcept: jneqsim.process.fielddevelopment.concept.FieldConcept) -> 'FacilityBuilder': ...
    def includeFlare(self, boolean: bool) -> 'FacilityBuilder': ...
    def includePowerGeneration(self, boolean: bool) -> 'FacilityBuilder': ...
    def name(self, string: typing.Union[java.lang.String, str]) -> 'FacilityBuilder': ...
    def withRedundancy(self, string: typing.Union[java.lang.String, str], int: int) -> 'FacilityBuilder': ...
...
class __module_protocol__(Protocol):
    ...
    ConceptToProcessLinker: typing.Type[ConceptToProcessLinker]
