...
class InjectionStrategy(java.io.Serializable):
    ...
    class StrategyType(java.lang.Enum["InjectionStrategy.StrategyType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "InjectionStrategy.StrategyType": ...
        @staticmethod
...
class InjectionWellModel(java.io.Serializable):
    ...
    def setSurfaceInjectionPressure(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> "InjectionWellModel": ...
    def setThermalStressReduction(
    ...
    def setWellType(
        self, injectionType: "InjectionWellModel.InjectionType"
    ) -> "InjectionWellModel": ...
    def setWellboreRadius(self, double: float) -> "InjectionWellModel": ...

    class InjectionPattern(java.io.Serializable):
        def __init__(
            self, patternType: "InjectionWellModel.InjectionPattern.PatternType"
        ): ...
        ...
        class PatternType(
            java.lang.Enum["InjectionWellModel.InjectionPattern.PatternType"]
        ):
            FIVE_SPOT: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            INVERTED_FIVE_SPOT: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            LINE_DRIVE: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            STAGGERED_LINE_DRIVE: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            SEVEN_SPOT: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            NINE_SPOT: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            PERIPHERAL: typing.ClassVar[
                "InjectionWellModel.InjectionPattern.PatternType"
            ] = ...
            _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
            @typing.overload
    ...
    class InjectionType(java.lang.Enum["InjectionWellModel.InjectionType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "InjectionWellModel.InjectionType": ...
        @staticmethod
...
class ReservoirCouplingExporter(java.io.Serializable):
    ...
    def clear(self) -> None: ...
    def exportProductionForecastCsv(
        self,
    ...
    def generateVfpInj(
        ...
        int: int,
    ) -> "ReservoirCouplingExporter.VfpTable": ...
    def generateVfpProd(
        self,
        string: typing.Union[java.lang.String, str],
        systemInterface: jneqsim.thermo.system.SystemInterface,
    ...
    def setFormat(
        self, exportFormat: "ReservoirCouplingExporter.ExportFormat"
    ) -> None: ...
    ...
    class ExportFormat(java.lang.Enum["ReservoirCouplingExporter.ExportFormat"]):
        ...
        E300_COMPOSITIONAL: typing.ClassVar[
            "ReservoirCouplingExporter.ExportFormat"
        ] = ...
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ReservoirCouplingExporter.ExportFormat"]
        ): ...
...
class TransientWellModel(java.io.Serializable):
    ...
    def setBoundaryType(
        self, boundaryType: "TransientWellModel.BoundaryType"
    ) -> "TransientWellModel": ...
    def setDrainageRadius(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> "TransientWellModel": ...
    def setFluidViscosity(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> "TransientWellModel": ...
    def setFormationThickness(
        self, double: float, string: typing.Union[java.lang.String, str]
    ...
    def setTotalCompressibility(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> "TransientWellModel": ...
    def setWellType(
        self, wellType: "TransientWellModel.WellType"
    ) -> "TransientWellModel": ...
    def setWellboreRadius(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> "TransientWellModel": ...
    ...
    class BoundaryType(java.lang.Enum["TransientWellModel.BoundaryType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "TransientWellModel.BoundaryType": ...
        @staticmethod
