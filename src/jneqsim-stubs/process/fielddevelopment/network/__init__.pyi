...
class MultiphaseFlowIntegrator(java.io.Serializable):
    def __init__(self): ...
    def calculateHydraulics(self, streamInterface: jneqsim.process.equipment.stream.StreamInterface, double: float) -> 'MultiphaseFlowIntegrator.PipelineResult': ...
    def calculateHydraulicsCurve(self, systemInterface: jneqsim.thermo.system.SystemInterface, double: float, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> java.util.List['MultiphaseFlowIntegrator.PipelineResult']: ...
    def getHydraulicModel(self) -> 'MultiphaseFlowIntegrator.HydraulicModel': ...
    ...
    def setHydraulicModel(self, hydraulicModel: 'MultiphaseFlowIntegrator.HydraulicModel') -> None: ...
    ...
    def sizePipeline(self, streamInterface: jneqsim.process.equipment.stream.StreamInterface, double: float, double2: float) -> float: ...
    ...
    class HydraulicModel(java.lang.Enum['MultiphaseFlowIntegrator.HydraulicModel']):
        TWO_FLUID: typing.ClassVar['MultiphaseFlowIntegrator.HydraulicModel'] = ...
        BEGGS_BRILL: typing.ClassVar['MultiphaseFlowIntegrator.HydraulicModel'] = ...
        _valueOf_0__T = typing.TypeVar('_valueOf_0__T', bound=java.lang.Enum)  # <T>
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_0__T], string: typing.Union[java.lang.String, str]) -> _valueOf_0__T: ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'MultiphaseFlowIntegrator.HydraulicModel': ...
        @staticmethod
        def values() -> typing.MutableSequence['MultiphaseFlowIntegrator.HydraulicModel']: ...
...
class NetworkSolver(java.io.Serializable):
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def addWell(self, wellSystem: jneqsim.process.equipment.reservoir.WellSystem, double: float) -> 'NetworkSolver': ...
    @typing.overload
    def addWell(self, wellSystem: jneqsim.process.equipment.reservoir.WellSystem, double: float, double2: float) -> 'NetworkSolver': ...
    ...
    def setReferenceFluid(self, systemInterface: jneqsim.thermo.system.SystemInterface) -> 'NetworkSolver': ...
...
class TiebackRouteNetwork(java.io.Serializable):
    @staticmethod
    def builder(string: typing.Union[java.lang.String, str]) -> 'TiebackRouteNetwork.Builder': ...
    ...
    class Builder:
        def addBranch(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'TiebackRouteNetwork.Builder': ...
        def addFlowline(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'TiebackRouteNetwork.Builder': ...
        def addRiser(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'TiebackRouteNetwork.Builder': ...
        def addSegment(self, string: typing.Union[java.lang.String, str], segmentType: 'TiebackRouteNetwork.SegmentType', double: float, double2: float, double3: float, double4: float, double5: float, double6: float, boolean: bool) -> 'TiebackRouteNetwork.Builder': ...
        def addSharedCorridor(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'TiebackRouteNetwork.Builder': ...
        def build(self) -> 'TiebackRouteNetwork': ...
        def hostHub(self, string: typing.Union[java.lang.String, str]) -> 'TiebackRouteNetwork.Builder': ...
    ...
    class SegmentType(java.lang.Enum['TiebackRouteNetwork.SegmentType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'TiebackRouteNetwork.SegmentType': ...
        @staticmethod
