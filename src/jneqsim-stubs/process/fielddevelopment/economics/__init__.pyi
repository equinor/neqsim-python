...
class CashFlowEngine(java.io.Serializable):
    ...
    def getCommodityFeeSchedule(self) -> 'CommodityFeeSchedule': ...
    ...
    def setCommodityFeeSchedule(self, commodityFeeSchedule: 'CommodityFeeSchedule') -> None: ...
    def setFixedOpexPerYear(self, double: float) -> None: ...
    def setFixedOpexStartYear(self, int: int) -> None: ...
    ...
    class AnnualCashFlow(java.io.Serializable):
        def __init__(self, int: int, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float, double9: float, double10: float, double11: float, double12: float, double13: float, double14: float, double15: float): ...
        ...
        def getProcessingFee(self) -> float: ...
...
class CommodityFeeSchedule(java.io.Serializable):
    @staticmethod
    def builder() -> 'CommodityFeeSchedule.Builder': ...
    def calculateAnnualFeeMusd(self, double: float, double2: float, double3: float) -> float: ...
    def getAnnualFixedFeeMusd(self) -> float: ...
    def getGasProcessingFeeUsdPerSm3(self) -> float: ...
    def getNglProcessingFeeUsdPerBbl(self) -> float: ...
    def getOilProcessingFeeUsdPerBbl(self) -> float: ...
    @staticmethod
    def none() -> 'CommodityFeeSchedule': ...
    class Builder:
        def annualFixedFee(self, double: float) -> 'CommodityFeeSchedule.Builder': ...
        def build(self) -> 'CommodityFeeSchedule': ...
        def gasProcessingFee(self, double: float) -> 'CommodityFeeSchedule.Builder': ...
        def nglProcessingFee(self, double: float) -> 'CommodityFeeSchedule.Builder': ...
        def oilProcessingFee(self, double: float) -> 'CommodityFeeSchedule.Builder': ...
...
class ProductionProfileGenerator(java.io.Serializable):
    ...
    @staticmethod
    def capProfileToCumulativeLimit(map: typing.Union[java.util.Map[int, float], typing.Mapping[int, float]], double: float) -> java.util.Map[int, float]: ...
    @staticmethod
    def combineProfiles(*map: typing.Union[java.util.Map[int, float], typing.Mapping[int, float]]) -> java.util.Map[int, float]: ...
    def fitHistoryMatchedDecline(self, map: typing.Union[java.util.Map[int, float], typing.Mapping[int, float]]) -> 'ProductionProfileGenerator.HistoryMatchedDeclineCase': ...
    @typing.overload
    ...
    def generateFromReservoirInput(self, reservoirInput: jneqsim.process.fielddevelopment.concept.ReservoirInput, double: float, boolean: bool, int: int, int2: int) -> java.util.Map[int, float]: ...
    def generateFromSimpleReservoir(self, simpleReservoir: jneqsim.process.equipment.reservoir.SimpleReservoir, boolean: bool, double: float, double2: float, int: int, int2: int) -> java.util.Map[int, float]: ...
    @typing.overload
    ...
    def generateHistoryMatchedProfile(self, historyMatchedDeclineCase: 'ProductionProfileGenerator.HistoryMatchedDeclineCase', int: int, int2: int, double: float) -> java.util.Map[int, float]: ...
    @typing.overload
    ...
    @staticmethod
    def toVfpRateTableCsv(map: typing.Union[java.util.Map[int, float], typing.Mapping[int, float]], string: typing.Union[java.lang.String, str], double: float) -> java.lang.String: ...
    ...
    class HistoryMatchedDeclineCase(java.io.Serializable):
        def __init__(self, int: int, int2: int, double: float, double2: float, double3: float): ...
...
class __module_protocol__(Protocol):
    ...
    CommodityFeeSchedule: typing.Type[CommodityFeeSchedule]
