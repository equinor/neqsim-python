...
class BatchConceptRunner:
    ...
    def addConcepts(
        self,
        list: java.util.List[jneqsim.process.fielddevelopment.concept.FieldConcept],
    ) -> "BatchConceptRunner": ...
    def clear(self) -> "BatchConceptRunner": ...
    def getConceptCount(self) -> int: ...
    def onProgress(
        self,
        progressListener: typing.Union[
            "BatchConceptRunner.ProgressListener", typing.Callable
        ],
    ) -> "BatchConceptRunner": ...
...
class BottleneckAnalyzer(java.io.Serializable):
    ...
    def evaluateDebottleneckOptions(
        self, string: typing.Union[java.lang.String, str], double: float
    ) -> java.util.List["BottleneckAnalyzer.DebottleneckOption"]: ...
    def generateReport(self) -> java.lang.String: ...
    def getActiveBottlenecks(
        self,
    ) -> java.util.List["BottleneckAnalyzer.BottleneckResult"]: ...
    ...
    class ConstraintType(java.lang.Enum["BottleneckAnalyzer.ConstraintType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "BottleneckAnalyzer.ConstraintType": ...
        @staticmethod
    ...
    class EquipmentType(java.lang.Enum["BottleneckAnalyzer.EquipmentType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "BottleneckAnalyzer.EquipmentType": ...
        @staticmethod
...
class ConceptEvaluator:
    ...
    def __init__(
        self,
        flowAssuranceScreener: jneqsim.process.fielddevelopment.screening.FlowAssuranceScreener,
        safetyScreener: jneqsim.process.fielddevelopment.screening.SafetyScreener,
        emissionsTracker: jneqsim.process.fielddevelopment.screening.EmissionsTracker,
        economicsEstimator: jneqsim.process.fielddevelopment.screening.EconomicsEstimator,
    ): ...
    @typing.overload
    def evaluate(
        self, fieldConcept: jneqsim.process.fielddevelopment.concept.FieldConcept
...
class ConceptKPIs(java.io.Serializable):
    ...
    def getSafetyLevel(
        self,
    ) -> jneqsim.process.fielddevelopment.screening.SafetyReport.SafetyLevel: ...
    def getSafetyReport(
        self,
    ) -> jneqsim.process.fielddevelopment.screening.SafetyReport: ...
    ...
    class Builder:
        ...
        def economicsReport(
            self,
            economicsReport: jneqsim.process.fielddevelopment.screening.EconomicsEstimator.EconomicsReport,
        ) -> "ConceptKPIs.Builder": ...
        def emissionsClass(
        ...
        def emissionsReport(
            self,
            emissionsReport: jneqsim.process.fielddevelopment.screening.EmissionsTracker.EmissionsReport,
        ) -> "ConceptKPIs.Builder": ...
        def environmentalScore(self, double: float) -> "ConceptKPIs.Builder": ...
        def estimatedRecovery(self, double: float) -> "ConceptKPIs.Builder": ...
        def evaluationTime(
            self, localDateTime: java.time.LocalDateTime
        ) -> "ConceptKPIs.Builder": ...
        def fieldLife(self, double: float) -> "ConceptKPIs.Builder": ...
        def flowAssuranceOverall(
            self,
            flowAssuranceResult: jneqsim.process.fielddevelopment.screening.FlowAssuranceResult,
        ) -> "ConceptKPIs.Builder": ...
        def flowAssuranceReport(
            self,
            flowAssuranceReport: jneqsim.process.fielddevelopment.screening.FlowAssuranceReport,
        ) -> "ConceptKPIs.Builder": ...
        ...
        def safetyLevel(
            self,
            safetyLevel: jneqsim.process.fielddevelopment.screening.SafetyReport.SafetyLevel,
        ) -> "ConceptKPIs.Builder": ...
        def safetyReport(
            self, safetyReport: jneqsim.process.fielddevelopment.screening.SafetyReport
        ) -> "ConceptKPIs.Builder": ...
...
class DecommissioningEstimator(java.io.Serializable):
    ...
    def getCostBreakdown(
        self,
    ) -> java.util.List["DecommissioningEstimator.CostItem"]: ...
    def getEstimatedDurationMonths(self) -> int: ...
    @typing.overload
    def getPipelineDecomCostMUSD(self) -> float: ...
    @typing.overload
    def getPipelineDecomCostMUSD(
        self, pipelineStrategy: "DecommissioningEstimator.PipelineStrategy"
    ) -> float: ...
    ...
    class FacilityType(java.lang.Enum["DecommissioningEstimator.FacilityType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "DecommissioningEstimator.FacilityType": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["DecommissioningEstimator.FacilityType"]
        ): ...
    ...
    class PipelineStrategy(java.lang.Enum["DecommissioningEstimator.PipelineStrategy"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "DecommissioningEstimator.PipelineStrategy": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["DecommissioningEstimator.PipelineStrategy"]
        ): ...
...
class DevelopmentOptionRanker(java.io.Serializable):
    ...
    def addOption(
        self, string: typing.Union[java.lang.String, str]
    ) -> "DevelopmentOptionRanker.DevelopmentOption": ...
    @typing.overload
    def addOption(
        self, developmentOption: "DevelopmentOptionRanker.DevelopmentOption"
    ) -> None: ...
    def clearOptions(self) -> None: ...
    def getOptions(
        self,
    ) -> java.util.List["DevelopmentOptionRanker.DevelopmentOption"]: ...
    ...
    def rankByCriterion(
        self, criterion: "DevelopmentOptionRanker.Criterion"
    ) -> java.util.List["DevelopmentOptionRanker.DevelopmentOption"]: ...
    def setWeight(
        self, criterion: "DevelopmentOptionRanker.Criterion", double: float
    ) -> None: ...
    ...
    class Criterion(java.lang.Enum["DevelopmentOptionRanker.Criterion"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "DevelopmentOptionRanker.Criterion": ...
        @staticmethod
    ...
    class DevelopmentOption(java.io.Serializable):
        ...
        def getScores(
            self,
        ) -> java.util.Map["DevelopmentOptionRanker.Criterion", float]: ...
    ...
    class RankingResult(java.io.Serializable):
        ...
        def sensitivityAnalysis(
            self, criterion: "DevelopmentOptionRanker.Criterion"
        ) -> java.util.Map[float, java.lang.String]: ...
...
class EnvironmentalReporter(java.io.Serializable):
    ...
    ) -> "EnvironmentalReporter.EnvironmentalReport": ...
    @typing.overload
    def generateReport(
        self,
    ...
    def getTotalPowerConsumption(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> float: ...
    def setOperatingHours(self, double: float) -> "EnvironmentalReporter": ...
    def setPowerSupplyType(
        self, powerSupplyType: "EnvironmentalReporter.PowerSupplyType"
    ...
    class PowerSupplyType(java.lang.Enum["EnvironmentalReporter.PowerSupplyType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "EnvironmentalReporter.PowerSupplyType": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["EnvironmentalReporter.PowerSupplyType"]
        ): ...

class MonteCarloRunner(java.io.Serializable):
    @typing.overload
    def __init__(
        self, cashFlowEngine: jneqsim.process.fielddevelopment.economics.CashFlowEngine
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    def addVariable(
        self,
        string: typing.Union[java.lang.String, str],
        distributionType: "MonteCarloRunner.DistributionType",
        double: float,
        double2: float,
        double3: float,
    ) -> None: ...
    ...
    class DistributionType(java.lang.Enum["MonteCarloRunner.DistributionType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "MonteCarloRunner.DistributionType": ...
        @staticmethod
...
class ProductionAllocator(java.io.Serializable):
    ...
    def addSource(
        ...
        string: typing.Union[java.lang.String, str],
        streamInterface: jneqsim.process.equipment.stream.StreamInterface,
        meteringType: "ProductionAllocator.MeteringType",
    ) -> "ProductionAllocator": ...
...
class ReservesClassification(java.io.Serializable):
    ...
    class ResourceCategory(java.lang.Enum["ReservesClassification.ResourceCategory"]):
        ...
        CONTINGENT_RESOURCES: typing.ClassVar[
            "ReservesClassification.ResourceCategory"
        ] = ...
        PROSPECTIVE_RESOURCES: typing.ClassVar[
            "ReservesClassification.ResourceCategory"
        ] = ...
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ReservesClassification.ResourceCategory"]
        ): ...
    ...
    class Result(java.io.Serializable):
        def __init__(
            self,
            string: typing.Union[java.lang.String, str],
            resourceCategory: "ReservesClassification.ResourceCategory",
            string2: typing.Union[java.lang.String, str],
...
class ScenarioAnalyzer(java.io.Serializable):
    ...
    def addScenario(
        self,
        string: typing.Union[java.lang.String, str],
        scenarioParameters: "ScenarioAnalyzer.ScenarioParameters",
    ) -> "ScenarioAnalyzer": ...
    def clearScenarios(self) -> "ScenarioAnalyzer": ...
    def generateReport(self) -> java.lang.String: ...
    def getResult(
        self, string: typing.Union[java.lang.String, str]
    ) -> "ScenarioAnalyzer.ScenarioResult": ...
    ...
    class ScenarioResult(java.io.Serializable):
        ...
        def setParameters(
            self, scenarioParameters: "ScenarioAnalyzer.ScenarioParameters"
        ) -> None: ...
...
class SeparatorSizingCalculator(java.io.Serializable):
    ...
    def createSeparator(
        ...
        string: typing.Union[java.lang.String, str],
        streamInterface: jneqsim.process.equipment.stream.StreamInterface,
        separatorSizingResult: "SeparatorSizingCalculator.SeparatorSizingResult",
    ) -> jneqsim.process.equipment.separator.Separator: ...
    def gasBubbleRiseInLiquid(
    ...
    def getRecommendedKFactor(
        self, separatorType: "SeparatorSizingCalculator.SeparatorType", boolean: bool
    ) -> float: ...
    def oilDropletSettlingInGas(
        self, double: float, double2: float, double3: float, double4: float
    ) -> float: ...
    ...
    ) -> "SeparatorSizingCalculator.SeparatorSizingResult": ...
    def sizeUsingNeqSimDesign(
        self, separator: jneqsim.process.equipment.separator.Separator
    ) -> "SeparatorSizingCalculator.SeparatorSizingResult": ...
    def soudersbrownGasVelocity(
        self, double: float, double2: float, double3: float
    ) -> float: ...
    def stokesSettlingVelocity(
        self, double: float, double2: float, double3: float, double4: float
    ) -> float: ...
    ...
    class DesignStandard(java.lang.Enum["SeparatorSizingCalculator.DesignStandard"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "SeparatorSizingCalculator.DesignStandard": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["SeparatorSizingCalculator.DesignStandard"]
        ): ...
    ...
    class SeparatorType(java.lang.Enum["SeparatorSizingCalculator.SeparatorType"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str]
        ) -> "SeparatorSizingCalculator.SeparatorType": ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["SeparatorSizingCalculator.SeparatorType"]
        ): ...
