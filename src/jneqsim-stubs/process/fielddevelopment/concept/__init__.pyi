...
class DevelopmentCaseTemplate(java.io.Serializable):
    @typing.overload
    ...
    def getAssumptionsSummary(self) -> java.lang.String: ...
    def getCapexBreakdownMusd(self) -> java.util.Map[java.lang.String, float]: ...
    def getCaseName(self) -> java.lang.String: ...
    def getCaseType(self) -> java.lang.String: ...
    def getConcept(self) -> 'FieldConcept': ...
    def getDevelopmentDurationMonths(self) -> int: ...
    ...
    def getFirstProductionYear(self) -> int: ...
    def getLifecycleEmissionsProfile(self) -> jneqsim.process.fielddevelopment.screening.LifecycleEmissionsProfile: ...
    def getName(self) -> java.lang.String: ...
    def getPowerMw(self) -> float: ...
    def getProductionProfile(self) -> java.util.Map[int, float]: ...
...
class DevelopmentCaseUncertainty(java.io.Serializable):
    @staticmethod
    def builder() -> 'DevelopmentCaseUncertainty.Builder': ...
    @staticmethod
    def empty() -> 'DevelopmentCaseUncertainty': ...
    def getCapex(self) -> 'UncertaintyRange': ...
    def getPrice(self) -> 'UncertaintyRange': ...
    def getProductionFactor(self) -> 'UncertaintyRange': ...
    def getResource(self) -> 'UncertaintyRange': ...
    def getScheduleMonths(self) -> 'UncertaintyRange': ...
    def getSummary(self) -> java.lang.String: ...
    class Builder:
        def __init__(self): ...
...
class FieldConcept(java.io.Serializable):
    @staticmethod
    def builder(string: typing.Union[java.lang.String, str]) -> 'FieldConcept.Builder': ...
    ...
    @typing.overload
    @staticmethod
    def gasTieback(string: typing.Union[java.lang.String, str], double: float, int: int, double2: float) -> 'FieldConcept': ...
    ...
    @typing.overload
    @staticmethod
    def oilDevelopment(string: typing.Union[java.lang.String, str]) -> 'FieldConcept': ...
    @typing.overload
    @staticmethod
    def oilDevelopment(string: typing.Union[java.lang.String, str], int: int, double: float, double2: float) -> 'FieldConcept': ...
    def toString(self) -> java.lang.String: ...
    class Builder:
        def build(self) -> 'FieldConcept': ...
        def description(self, string: typing.Union[java.lang.String, str]) -> 'FieldConcept.Builder': ...
        def id(self, string: typing.Union[java.lang.String, str]) -> 'FieldConcept.Builder': ...
        def infrastructure(self, infrastructureInput: 'InfrastructureInput') -> 'FieldConcept.Builder': ...
        def reservoir(self, reservoirInput: 'ReservoirInput') -> 'FieldConcept.Builder': ...
        def wells(self, wellsInput: 'WellsInput') -> 'FieldConcept.Builder': ...

class GreenfieldConceptFactory:
    @staticmethod
    def fixedPlatform(string: typing.Union[java.lang.String, str]) -> DevelopmentCaseTemplate: ...
    @staticmethod
    def onshoreTerminal(string: typing.Union[java.lang.String, str]) -> DevelopmentCaseTemplate: ...
    @staticmethod
    def phasedBrownfieldExpansion(string: typing.Union[java.lang.String, str]) -> DevelopmentCaseTemplate: ...
    @staticmethod
    def standaloneFpso(string: typing.Union[java.lang.String, str]) -> DevelopmentCaseTemplate: ...
    @staticmethod
    def subseaTieback(string: typing.Union[java.lang.String, str]) -> DevelopmentCaseTemplate: ...
    @staticmethod
    def subseaToShore(string: typing.Union[java.lang.String, str]) -> DevelopmentCaseTemplate: ...
...
class InfrastructureInput(java.io.Serializable):
    ...
    def toString(self) -> java.lang.String: ...
    class Builder:
        def ambientTemperatures(self, double: float, double2: float) -> 'InfrastructureInput.Builder': ...
        def build(self) -> 'InfrastructureInput': ...
        def electricHeating(self, boolean: bool) -> 'InfrastructureInput.Builder': ...
        def exportPipeline(self, double: float, double2: float) -> 'InfrastructureInput.Builder': ...
        def exportPressure(self, double: float) -> 'InfrastructureInput.Builder': ...
        def exportType(self, exportType: 'InfrastructureInput.ExportType') -> 'InfrastructureInput.Builder': ...
        def hostCapacityAvailable(self, double: float) -> 'InfrastructureInput.Builder': ...
        def insulatedFlowline(self, boolean: bool) -> 'InfrastructureInput.Builder': ...
        def powerSupply(self, powerSupply: 'InfrastructureInput.PowerSupply') -> 'InfrastructureInput.Builder': ...
        def processingLocation(self, processingLocation: 'InfrastructureInput.ProcessingLocation') -> 'InfrastructureInput.Builder': ...
    ...
    class ExportType(java.lang.Enum['InfrastructureInput.ExportType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'InfrastructureInput.ExportType': ...
        @staticmethod
    ...
    class PowerSupply(java.lang.Enum['InfrastructureInput.PowerSupply']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'InfrastructureInput.PowerSupply': ...
        @staticmethod
    ...
    class ProcessingLocation(java.lang.Enum['InfrastructureInput.ProcessingLocation']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'InfrastructureInput.ProcessingLocation': ...
        @staticmethod
        def values() -> typing.MutableSequence['InfrastructureInput.ProcessingLocation']: ...
...
class ReservoirInput(java.io.Serializable):
    ...
    def getRecoverableResourceEstimate(self) -> float: ...
    def getRecoverableResourceP10(self) -> float: ...
    def getRecoverableResourceP50(self) -> float: ...
    def getRecoverableResourceP90(self) -> float: ...
    def getRecoveryFactor(self) -> float: ...
    def getReservoirPressure(self) -> float: ...
    def getReservoirTemperature(self) -> float: ...
    def getResourceEstimate(self) -> float: ...
    def getResourceP10(self) -> float: ...
    def getResourceP50(self) -> float: ...
    def getResourceP90(self) -> float: ...
    def getResourceUnit(self) -> java.lang.String: ...
    ...
    def hasResourceUncertainty(self) -> bool: ...
    ...
    def toString(self) -> java.lang.String: ...
    class Builder:
        def addComponent(self, string: typing.Union[java.lang.String, str], double: float) -> 'ReservoirInput.Builder': ...
        ...
        def fluidType(self, fluidType: 'ReservoirInput.FluidType') -> 'ReservoirInput.Builder': ...
        def gasGravity(self, double: float) -> 'ReservoirInput.Builder': ...
        @typing.overload
        def gor(self, double: float) -> 'ReservoirInput.Builder': ...
        @typing.overload
        def gor(self, double: float, string: typing.Union[java.lang.String, str]) -> 'ReservoirInput.Builder': ...
        def h2sPercent(self, double: float) -> 'ReservoirInput.Builder': ...
        def n2Percent(self, double: float) -> 'ReservoirInput.Builder': ...
        def recoveryFactor(self, double: float) -> 'ReservoirInput.Builder': ...
        ...
        def resourceEstimate(self, double: float, string: typing.Union[java.lang.String, str]) -> 'ReservoirInput.Builder': ...
        @typing.overload
        def resourceUncertainty(self, double: float, double2: float, double3: float) -> 'ReservoirInput.Builder': ...
        @typing.overload
        def resourceUncertainty(self, double: float, double2: float, double3: float, string: typing.Union[java.lang.String, str]) -> 'ReservoirInput.Builder': ...
    ...
    class FluidType(java.lang.Enum['ReservoirInput.FluidType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ReservoirInput.FluidType': ...
        @staticmethod
        def values() -> typing.MutableSequence['ReservoirInput.FluidType']: ...

class UncertaintyRange(java.io.Serializable):
    ...
    @staticmethod
    def deterministic(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float) -> 'UncertaintyRange': ...
    def getName(self) -> java.lang.String: ...
...
class WellsInput(java.io.Serializable):
    ...
    class Builder:
        ...
        def completionType(self, completionType: 'WellsInput.CompletionType') -> 'WellsInput.Builder': ...
        def gasLift(self, double: float, string: typing.Union[java.lang.String, str]) -> 'WellsInput.Builder': ...
        def injectorCount(self, int: int) -> 'WellsInput.Builder': ...
        def producerCount(self, int: int) -> 'WellsInput.Builder': ...
        def producerType(self, wellType: 'WellsInput.WellType') -> 'WellsInput.Builder': ...
        def productivityIndex(self, double: float) -> 'WellsInput.Builder': ...
        def ratePerWell(self, double: float, string: typing.Union[java.lang.String, str]) -> 'WellsInput.Builder': ...
        ...
        def waterInjection(self, double: float, string: typing.Union[java.lang.String, str]) -> 'WellsInput.Builder': ...
    class CompletionType(java.lang.Enum['WellsInput.CompletionType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'WellsInput.CompletionType': ...
        @staticmethod
    ...
    class WellType(java.lang.Enum['WellsInput.WellType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'WellsInput.WellType': ...
        @staticmethod
...
class __module_protocol__(Protocol):
    ...
    DevelopmentCaseTemplate: typing.Type[DevelopmentCaseTemplate]
    DevelopmentCaseUncertainty: typing.Type[DevelopmentCaseUncertainty]
    FieldConcept: typing.Type[FieldConcept]
    GreenfieldConceptFactory: typing.Type[GreenfieldConceptFactory]
    InfrastructureInput: typing.Type[InfrastructureInput]
    ReservoirInput: typing.Type[ReservoirInput]
    UncertaintyRange: typing.Type[UncertaintyRange]
