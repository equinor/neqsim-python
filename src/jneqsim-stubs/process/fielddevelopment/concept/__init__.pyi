...
class DevelopmentCaseTemplate(java.io.Serializable):
    ...
    def __init__(
        ...
        cashFlowResult: jneqsim.process.fielddevelopment.economics.CashFlowEngine.CashFlowResult,
        string3: typing.Union[java.lang.String, str],
        developmentCaseUncertainty: "DevelopmentCaseUncertainty",
        lifecycleEmissionsProfile: jneqsim.process.fielddevelopment.screening.LifecycleEmissionsProfile,
    ): ...
    ...
    def getFacilityConfig(
        self,
    ) -> jneqsim.process.fielddevelopment.facility.FacilityConfig: ...
    def getFirstProductionYear(self) -> int: ...
    def getLifecycleEmissionsProfile(
        self,
    ) -> jneqsim.process.fielddevelopment.screening.LifecycleEmissionsProfile: ...
...
class DevelopmentCaseUncertainty(java.io.Serializable):
    ...
    class Builder:
        ...
        ) -> "DevelopmentCaseUncertainty.Builder": ...
        def price(
            self, uncertaintyRange: "UncertaintyRange"
        ) -> "DevelopmentCaseUncertainty.Builder": ...
        def productionFactor(
            self, uncertaintyRange: "UncertaintyRange"
        ) -> "DevelopmentCaseUncertainty.Builder": ...
        def resource(
            self, uncertaintyRange: "UncertaintyRange"
