...
class BatchParameterEstimator(java.io.Serializable):
    ...
    @typing.overload
    def addDataPoint(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> 'BatchParameterEstimator': ...
    @typing.overload
    def addDataPoint(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], map2: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> 'BatchParameterEstimator': ...
    def addMeasuredVariable(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float) -> 'BatchParameterEstimator': ...
    def addTunableParameter(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'BatchParameterEstimator': ...
    ...
    class DataPoint(java.io.Serializable):
        def __init__(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], map2: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]): ...
...
class CalibrationQuality(java.io.Serializable):
    def __init__(self, instant: typing.Union[java.time.Instant, datetime.datetime], double: float, double2: float, double3: float, double4: float, int: int, double5: float): ...
...
class CalibrationResult(java.io.Serializable):
    ...
    @staticmethod
    def success(map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], double: float, int: int, int2: int) -> 'CalibrationResult': ...
    def toString(self) -> java.lang.String: ...

class EnKFParameterEstimator(java.io.Serializable):
    def __init__(self, processSystem: jneqsim.process.processmodel.ProcessSystem): ...
    def addMeasuredVariable(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float) -> 'EnKFParameterEstimator': ...
    @typing.overload
    def addTunableParameter(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'EnKFParameterEstimator': ...
    @typing.overload
    def addTunableParameter(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float) -> 'EnKFParameterEstimator': ...
    def getEstimates(self) -> typing.MutableSequence[float]: ...
    ...
    def toCalibrationResult(self) -> CalibrationResult: ...
    def update(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> 'EnKFParameterEstimator.EnKFResult': ...
    class EnKFResult(java.io.Serializable):
        def __init__(self, int: int, doubleArray: typing.Union[typing.List[float], jpype.JArray], doubleArray2: typing.Union[typing.List[float], jpype.JArray], doubleArray3: typing.Union[typing.List[float], jpype.JArray], doubleArray4: typing.Union[typing.List[float], jpype.JArray], boolean: bool): ...
        def getConfidenceIntervalLower(self) -> typing.MutableSequence[float]: ...
        def getConfidenceIntervalUpper(self) -> typing.MutableSequence[float]: ...
        def getEstimates(self) -> typing.MutableSequence[float]: ...
        ...
        def toCalibrationResult(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> CalibrationResult: ...
...
class EstimationTestHarness(java.io.Serializable):
    def __init__(self, processSystem: jneqsim.process.processmodel.ProcessSystem): ...
    def addMeasurement(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float) -> 'EstimationTestHarness': ...
    @typing.overload
    def addParameter(self, string: typing.Union[java.lang.String, str], double: float) -> 'EstimationTestHarness': ...
    @typing.overload
    def addParameter(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'EstimationTestHarness': ...
    def generateMeasurement(self, double: float) -> java.util.Map[java.lang.String, float]: ...
    @typing.overload
    def runConvergenceTest(self, enKFParameterEstimator: EnKFParameterEstimator, int: int) -> 'EstimationTestHarness.TestReport': ...
    @typing.overload
    def runConvergenceTest(self, enKFParameterEstimator: EnKFParameterEstimator, int: int, double: float, consumer: typing.Union[java.util.function.Consumer[int], typing.Callable[[int], None]]) -> 'EstimationTestHarness.TestReport': ...
    def runDriftTrackingTest(self, enKFParameterEstimator: EnKFParameterEstimator, int: int, int2: int, double: float) -> 'EstimationTestHarness.TestReport': ...
    def runMonteCarloValidation(self, supplier: typing.Union[java.util.function.Supplier[EnKFParameterEstimator], typing.Callable[[], EnKFParameterEstimator]], int: int, int2: int) -> 'EstimationTestHarness.MonteCarloReport': ...
    def runNoiseRobustnessTest(self, enKFParameterEstimator: EnKFParameterEstimator, int: int, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> java.util.Map[float, 'EstimationTestHarness.TestReport']: ...
    ...
    class MonteCarloReport(java.io.Serializable):
        def __init__(self, int: int, int2: int, list: java.util.List[float], list2: java.util.List[float], int3: int): ...
...
class OnlineCalibrator(java.io.Serializable):
    ...
    def incrementalUpdate(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], map2: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> CalibrationResult: ...
    @typing.overload
    def recordDataPoint(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], map2: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> bool: ...
    @typing.overload
    def recordDataPoint(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], map2: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], map3: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> bool: ...
    def setDeviationThreshold(self, double: float) -> None: ...
    def setMaxHistorySize(self, int: int) -> None: ...
    def setTunableParameters(self, list: java.util.List[typing.Union[java.lang.String, str]]) -> None: ...
    class DataPoint(java.io.Serializable):
        ...
        def getRelativeError(self, string: typing.Union[java.lang.String, str]) -> float: ...
        def getTimestamp(self) -> java.time.Instant: ...

class ProcessSimulationFunction(jneqsim.statistics.parameterfitting.nonlinearparameterfitting.LevenbergMarquardtFunction):
    def __init__(self, processSystem: jneqsim.process.processmodel.ProcessSystem): ...
    def addDataPointConditions(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> None: ...
    def addMeasurement(self, string: typing.Union[java.lang.String, str]) -> 'ProcessSimulationFunction': ...
    def addParameter(self, string: typing.Union[java.lang.String, str], double: float, double2: float) -> 'ProcessSimulationFunction': ...
    def calcValue(self, doubleArray: typing.Union[typing.List[float], jpype.JArray]) -> float: ...
    def computeAnalyticalJacobian(self) -> jneqsim.process.util.uncertainty.SensitivityMatrix: ...
...
class WellRoutingEstimationExample:
    ...
    def getRoutingSchedule(self) -> typing.MutableSequence[typing.MutableSequence[int]]: ...
    @staticmethod
    def main(stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def runLiveEstimation(self, enKFParameterEstimator: EnKFParameterEstimator) -> None: ...
    def runValidation(self, enKFParameterEstimator: EnKFParameterEstimator, estimationTestHarness: EstimationTestHarness) -> bool: ...
    def setRouting(self, intArray: typing.Union[typing.List[int], jpype.JArray]) -> None: ...
