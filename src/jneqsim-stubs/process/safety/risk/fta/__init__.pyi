...
class FaultTreeAnalyzer(java.io.Serializable):
    def __init__(self): ...
    def minimalCutSets(self, faultTreeNode: 'FaultTreeNode', int: int) -> java.util.Set[java.util.List[java.lang.String]]: ...
    ...
    class GateType(java.lang.Enum['FaultTreeAnalyzer.GateType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'FaultTreeAnalyzer.GateType': ...
        @staticmethod
...
class FaultTreeNode(java.io.Serializable):
    ...
    betaCCF: float = ...
    @staticmethod
    def and_(string: typing.Union[java.lang.String, str], *faultTreeNode: 'FaultTreeNode') -> 'FaultTreeNode': ...
    @staticmethod
    def basic(string: typing.Union[java.lang.String, str], double: float) -> 'FaultTreeNode': ...
    def isBasic(self) -> bool: ...
    @staticmethod
    def or_(string: typing.Union[java.lang.String, str], *faultTreeNode: 'FaultTreeNode') -> 'FaultTreeNode': ...
    @staticmethod
    def voting(string: typing.Union[java.lang.String, str], int: int, *faultTreeNode: 'FaultTreeNode') -> 'FaultTreeNode': ...
