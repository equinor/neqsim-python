...
class InherentSafetyEvaluator(java.io.Serializable):
    ...
    def score(self, pillar: 'InherentSafetyEvaluator.Pillar', double: float, string: typing.Union[java.lang.String, str]) -> 'InherentSafetyEvaluator': ...
    class Pillar(java.lang.Enum['InherentSafetyEvaluator.Pillar']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'InherentSafetyEvaluator.Pillar': ...
        @staticmethod
