...
class ProcessSafetyScenario(java.io.Serializable):
    ...
    @staticmethod
    def generateFromTopology(processSystem: jneqsim.process.processmodel.ProcessSystem) -> java.util.List['ProcessSafetyScenario']: ...
...
class SafetyAnalysisFunctionEvaluation(java.io.Serializable):
    ...
    class Result(java.io.Serializable):
        def __init__(self, string: typing.Union[java.lang.String, str], list: java.util.List[typing.Union[java.lang.String, str]], list2: java.util.List[typing.Union[java.lang.String, str]], list3: java.util.List[typing.Union[java.lang.String, str]], double: float, string2: typing.Union[java.lang.String, str]): ...
