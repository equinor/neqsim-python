...
import jneqsim.process.safety.alarp
import jneqsim.process.safety.api14c
import jneqsim.process.safety.barrier
import jneqsim.process.safety.blowby
import jneqsim.process.safety.cfd
import jneqsim.process.safety.compliance
...
import jneqsim.process.safety.leakdetection
import jneqsim.process.safety.mdmt
import jneqsim.process.safety.opendrain
import jneqsim.process.safety.overpressure
import jneqsim.process.safety.processsafetysystem
import jneqsim.process.safety.pump
import jneqsim.process.safety.qra
import jneqsim.process.safety.reaction
...
class ProcessSafetyScenario(java.io.Serializable):
    ...
    def generateFromTopology(
        processSystem: jneqsim.process.processmodel.ProcessSystem,
    ) -> java.util.List["ProcessSafetyScenario"]: ...
...
class SafetyAnalysisFunctionEvaluation(java.io.Serializable):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    ...
    def evaluate(
        ...
        iterable: typing.Union[
            java.lang.Iterable[typing.Union[java.lang.String, str]],
            typing.Sequence[typing.Union[java.lang.String, str]],
            typing.Set[typing.Union[java.lang.String, str]],
            typing.Callable[[], java.util.Iterator[typing.Any]],
        ],
    ) -> "SafetyAnalysisFunctionEvaluation.Result": ...
    @staticmethod
    def getSupportedComponentTypes() -> java.util.Set[java.lang.String]: ...
    ...
    class Result(java.io.Serializable):
        ...
        def getCoverageWarning(self) -> java.lang.String: ...
        def getMissingFunctions(self) -> java.util.List[java.lang.String]: ...
        def getProvidedFunctions(self) -> java.util.List[java.lang.String]: ...
        def getRequiredFunctions(self) -> java.util.List[java.lang.String]: ...
...
class __module_protocol__(Protocol):
    ...
    SafetyAnalysisFunctionEvaluation: typing.Type[SafetyAnalysisFunctionEvaluation]
    alarp: jneqsim.process.safety.alarp.__module_protocol__
    api14c: jneqsim.process.safety.api14c.__module_protocol__
    barrier: jneqsim.process.safety.barrier.__module_protocol__
    blowby: jneqsim.process.safety.blowby.__module_protocol__
    cfd: jneqsim.process.safety.cfd.__module_protocol__
    compliance: jneqsim.process.safety.compliance.__module_protocol__
    depressurization: jneqsim.process.safety.depressurization.__module_protocol__
    dispersion: jneqsim.process.safety.dispersion.__module_protocol__
    ...
    mdmt: jneqsim.process.safety.mdmt.__module_protocol__
    opendrain: jneqsim.process.safety.opendrain.__module_protocol__
    overpressure: jneqsim.process.safety.overpressure.__module_protocol__
    processsafetysystem: jneqsim.process.safety.processsafetysystem.__module_protocol__
    pump: jneqsim.process.safety.pump.__module_protocol__
    qra: jneqsim.process.safety.qra.__module_protocol__
    reaction: jneqsim.process.safety.reaction.__module_protocol__
