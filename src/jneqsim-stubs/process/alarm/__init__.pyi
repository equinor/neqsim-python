...
class AlarmActionHandler(java.io.Serializable):
    @staticmethod
    def activateLogic(string: typing.Union[java.lang.String, str], alarmLevel: 'AlarmLevel', alarmEventType: 'AlarmEventType', processLogic: jneqsim.process.logic.ProcessLogic) -> 'AlarmActionHandler': ...
    @staticmethod
    def activateLogicOnHIHI(string: typing.Union[java.lang.String, str], processLogic: jneqsim.process.logic.ProcessLogic) -> 'AlarmActionHandler': ...
    @staticmethod
    def activateLogicOnLOLO(string: typing.Union[java.lang.String, str], processLogic: jneqsim.process.logic.ProcessLogic) -> 'AlarmActionHandler': ...
    @staticmethod
    def composite(list: java.util.List[typing.Union['AlarmActionHandler', typing.Callable]]) -> 'AlarmActionHandler': ...
...
class AlarmConfig(java.io.Serializable):
    ...
    class Builder:
        ...
        def unit(self, string: typing.Union[java.lang.String, str]) -> 'AlarmConfig.Builder': ...

class AlarmEvaluator:
    @staticmethod
    def evaluateAll(processAlarmManager: 'ProcessAlarmManager', processSystem: jneqsim.process.processmodel.ProcessSystem, double: float, double2: float) -> java.util.List['AlarmEvent']: ...
    @staticmethod
    def evaluateAndDisplay(processAlarmManager: 'ProcessAlarmManager', list: java.util.List[jneqsim.process.measurementdevice.MeasurementDeviceInterface], double: float, double2: float) -> java.util.List['AlarmEvent']: ...
    @staticmethod
    def evaluateDevices(processAlarmManager: 'ProcessAlarmManager', list: java.util.List[jneqsim.process.measurementdevice.MeasurementDeviceInterface], double: float, double2: float) -> java.util.List['AlarmEvent']: ...

class AlarmEvent(java.io.Serializable):
    @staticmethod
    def acknowledged(string: typing.Union[java.lang.String, str], alarmLevel: 'AlarmLevel', double: float, double2: float) -> 'AlarmEvent': ...
    @staticmethod
    def activated(string: typing.Union[java.lang.String, str], alarmLevel: 'AlarmLevel', double: float, double2: float) -> 'AlarmEvent': ...
    @staticmethod
    def cleared(string: typing.Union[java.lang.String, str], alarmLevel: 'AlarmLevel', double: float, double2: float) -> 'AlarmEvent': ...
...
class AlarmLevel(java.lang.Enum['AlarmLevel']):
    ...
    class Direction(java.lang.Enum['AlarmLevel.Direction']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'AlarmLevel.Direction': ...
        @staticmethod
...
class AlarmReporter:
    ...
    @typing.overload
    @staticmethod
    def displayAlarmHistory(processAlarmManager: 'ProcessAlarmManager', int: int) -> None: ...
    @staticmethod
    def displayAlarmStatistics(processAlarmManager: 'ProcessAlarmManager') -> None: ...
    @staticmethod
    def displayAlarmStatus(processAlarmManager: 'ProcessAlarmManager', string: typing.Union[java.lang.String, str]) -> None: ...
    @staticmethod
...
class AlarmState(java.io.Serializable):
    def __init__(self): ...
    def acknowledge(self, string: typing.Union[java.lang.String, str], double: float) -> AlarmEvent: ...
    def evaluate(self, alarmConfig: AlarmConfig, double: float, double2: float, double3: float, string: typing.Union[java.lang.String, str]) -> java.util.List[AlarmEvent]: ...
    def getActiveLevel(self) -> AlarmLevel: ...
    def getLastUpdateTime(self) -> float: ...
    def getLastValue(self) -> float: ...
    def getShelveExpiry(self) -> float: ...
    def getShelveReason(self) -> java.lang.String: ...
    def isAcknowledged(self) -> bool: ...
    def isActive(self) -> bool: ...
    def isShelved(self) -> bool: ...
    def reset(self) -> None: ...
    @typing.overload
    def shelve(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def shelve(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    def snapshot(self, string: typing.Union[java.lang.String, str]) -> 'AlarmStatusSnapshot': ...
    def unshelve(self) -> None: ...

class AlarmStatusSnapshot(java.io.Serializable):
    def __init__(self, string: typing.Union[java.lang.String, str], alarmLevel: AlarmLevel, boolean: bool, double: float, double2: float): ...
    def getLevel(self) -> AlarmLevel: ...
    def getSource(self) -> java.lang.String: ...
    def getTimestamp(self) -> float: ...
    def getValue(self) -> float: ...
...
class ProcessAlarmManager(java.io.Serializable):
    ...
    def applyFrom(self, processAlarmManager: 'ProcessAlarmManager', list: java.util.List[jneqsim.process.measurementdevice.MeasurementDeviceInterface]) -> None: ...
    def clearHistory(self) -> None: ...
    def equals(self, object: typing.Any) -> bool: ...
    def evaluateMeasurement(self, measurementDeviceInterface: jneqsim.process.measurementdevice.MeasurementDeviceInterface, double: float, double2: float, double3: float) -> java.util.List[AlarmEvent]: ...
    ...
    def register(self, measurementDeviceInterface: jneqsim.process.measurementdevice.MeasurementDeviceInterface) -> None: ...
    def registerActionHandler(self, alarmActionHandler: typing.Union[AlarmActionHandler, typing.Callable]) -> None: ...
    def registerAll(self, list: java.util.List[jneqsim.process.measurementdevice.MeasurementDeviceInterface]) -> None: ...
    def removeActionHandler(self, alarmActionHandler: typing.Union[AlarmActionHandler, typing.Callable]) -> None: ...
