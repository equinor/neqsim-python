...
class CompressorOptimizationHelper:
    def __init__(self): ...
    @staticmethod
    def createEfficiencyObjective(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
        double: float,
    ) -> "ProductionOptimizer.OptimizationObjective": ...
    @staticmethod
    def createOutletPressureVariable(
        compressor: jneqsim.process.equipment.compressor.Compressor,
        double: float,
        double2: float,
    ) -> "ProductionOptimizer.ManipulatedVariable": ...
    @staticmethod
    def createPowerObjective(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
        double: float,
    ) -> "ProductionOptimizer.OptimizationObjective": ...
    @staticmethod
    def createSpeedVariable(
        compressor: jneqsim.process.equipment.compressor.Compressor,
        double: float,
        double2: float,
    ) -> "ProductionOptimizer.ManipulatedVariable": ...
    @staticmethod
    def createSpeedVariables(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
    ) -> java.util.List["ProductionOptimizer.ManipulatedVariable"]: ...
    @staticmethod
    def createStandardConstraints(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
    ) -> java.util.List["ProductionOptimizer.OptimizationConstraint"]: ...
    @staticmethod
    def createStandardObjectives(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
    ) -> java.util.List["ProductionOptimizer.OptimizationObjective"]: ...
    @staticmethod
    def createSurgeMarginConstraint(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
        double: float,
        constraintSeverity: "ProductionOptimizer.ConstraintSeverity",
    ) -> "ProductionOptimizer.OptimizationConstraint": ...
    @staticmethod
    def createSurgeMarginObjective(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
        double: float,
    ) -> "ProductionOptimizer.OptimizationObjective": ...
    @staticmethod
    def createValidityConstraint(
        list: java.util.List[jneqsim.process.equipment.compressor.Compressor],
    ) -> "ProductionOptimizer.OptimizationConstraint": ...
    @staticmethod
    def extractBounds(
        compressor: jneqsim.process.equipment.compressor.Compressor,
    ) -> "CompressorOptimizationHelper.CompressorBounds": ...
    @staticmethod
    def optimizeTwoStage(
        processSystem: jneqsim.process.processmodel.ProcessSystem,
    ...
    class TwoStageResult:
        def __init__(
            ...
            optimizationResult2: "ProductionOptimizer.OptimizationResult",
        ): ...
        def getFlowUnit(self) -> java.lang.String: ...
...
class ConstraintPenaltyCalculator(java.io.Serializable):
    def __init__(self): ...
    def addConstraint(
        self, processConstraint: "ProcessConstraint"
    ) -> "ConstraintPenaltyCalculator": ...
    def addConstraints(
        self, list: java.util.List["ProcessConstraint"]
    ) -> "ConstraintPenaltyCalculator": ...
    def addEquipmentCapacityConstraints(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> "ConstraintPenaltyCalculator": ...
    @staticmethod
    def applyPenaltyFormula(
        double: float,
    ...
    def evaluate(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> java.util.List["ConstraintPenaltyCalculator.ConstraintEvaluation"]: ...
    def evaluateMargins(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> typing.MutableSequence[float]: ...
    ...
    def penalize(
        self, double: float, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> float: ...
    def totalPenalty(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> float: ...
    ...
    class ConstraintEvaluation(java.io.Serializable):
        def __init__(
            self,
            string: typing.Union[java.lang.String, str],
            constraintSeverityLevel: "ConstraintSeverityLevel",
            double: float,
            boolean: bool,
            double2: float,
            string2: typing.Union[java.lang.String, str],
...
class ConstraintSeverityLevel(java.lang.Enum["ConstraintSeverityLevel"]):
    ...
    @staticmethod
    def fromOptimizerSeverity(
        constraintSeverity: "ProductionOptimizer.ConstraintSeverity",
    ) -> "ConstraintSeverityLevel": ...
    def toCapacitySeverity(
        self,
...
class DegradedOperationOptimizer(java.io.Serializable):
    ...
    def createRecoveryPlan(
        self, string: typing.Union[java.lang.String, str]
    ) -> "DegradedOperationOptimizer.RecoveryPlan": ...
    def evaluateOperatingModes(
        self, string: typing.Union[java.lang.String, str]
    ) -> java.util.Map["DegradedOperationOptimizer.OperatingMode", float]: ...
    @typing.overload
    def optimizeWithEquipmentDown(
        self, string: typing.Union[java.lang.String, str]
    ...
    class OperatingMode(java.lang.Enum["DegradedOperationOptimizer.OperatingMode"]):
        ...
        REDUCED_CAPACITY: typing.ClassVar[
            "DegradedOperationOptimizer.OperatingMode"
        ] = ...
        PARTIAL_SHUTDOWN: typing.ClassVar[
            "DegradedOperationOptimizer.OperatingMode"
        ] = ...
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["DegradedOperationOptimizer.OperatingMode"]
        ): ...

    class RecoveryAction(java.io.Serializable):
        def __init__(
            self,
            phase: "DegradedOperationOptimizer.RecoveryAction.Phase",
            string: typing.Union[java.lang.String, str],
            double: float,
        ): ...
        def getDescription(self) -> java.lang.String: ...
        ...
        class Phase(java.lang.Enum["DegradedOperationOptimizer.RecoveryAction.Phase"]):
            IMMEDIATE: typing.ClassVar[
                "DegradedOperationOptimizer.RecoveryAction.Phase"
            ] = ...
            STABILIZATION: typing.ClassVar[
                "DegradedOperationOptimizer.RecoveryAction.Phase"
            ] = ...
            REPAIR: typing.ClassVar[
                "DegradedOperationOptimizer.RecoveryAction.Phase"
            ] = ...
            RESTORATION: typing.ClassVar[
                "DegradedOperationOptimizer.RecoveryAction.Phase"
            ] = ...
            _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
            @typing.overload
    ...
    class RecoveryPlan(java.io.Serializable):
        ...
        def addAction(
            self, recoveryAction: "DegradedOperationOptimizer.RecoveryAction"
        ) -> None: ...
        def getActions(
            self,
        ) -> java.util.List["DegradedOperationOptimizer.RecoveryAction"]: ...
...
class DegradedOperationResult(java.io.Serializable):
    ...
    def getFailureMode(
        self,
    ) -> jneqsim.process.equipment.failure.EquipmentFailureMode: ...
    ...
    def setOperatingMode(
        self, operatingMode: DegradedOperationOptimizer.OperatingMode
    ) -> None: ...
...
class EclipseVFPExporter(java.io.Serializable):
    ...
    def exportMultipleScenarios(
        self,
        list: java.util.List["EclipseVFPExporter.VFPScenario"],
        string: typing.Union[java.lang.String, str],
    ) -> None: ...
    ...
    def setLiftCurveData(
        self, liftCurveData: "ProcessOptimizationEngine.LiftCurveData"
    ) -> None: ...
    def setTHPs(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> None: ...
...
class FlowRateOptimizationResult(java.io.Serializable):
    def __init__(self): ...
    def addConstraintViolation(
        self, constraintViolation: "FlowRateOptimizationResult.ConstraintViolation"
    ) -> None: ...
    @staticmethod
    def error(
        string: typing.Union[java.lang.String, str],
    ...
    def getConstraintViolations(
        self,
    ) -> java.util.List["FlowRateOptimizationResult.ConstraintViolation"]: ...
    ...
    @staticmethod
    def infeasibleConstraint(
        string: typing.Union[java.lang.String, str],
        list: java.util.List["FlowRateOptimizationResult.ConstraintViolation"],
    ) -> "FlowRateOptimizationResult": ...
    @staticmethod
    def infeasiblePressure(
        string: typing.Union[java.lang.String, str],
    ) -> "FlowRateOptimizationResult": ...
    ...
    class Status(java.lang.Enum["FlowRateOptimizationResult.Status"]):
        ...
        def valueOf(
            string: typing.Union[java.lang.String, str],
        ) -> "FlowRateOptimizationResult.Status": ...
        @staticmethod
...
class FlowRateOptimizer(java.io.Serializable):
    ...
    def calculateTotalCompressorPower(
        self, string: typing.Union[java.lang.String, str]
    ) -> float: ...
    ...
    def findMaxFlowRateAtPressureBoundaries(
        self,
        double: float,
        double2: float,
        string: typing.Union[java.lang.String, str],
        double3: float,
    ) -> "FlowRateOptimizer.ProcessOperatingPoint": ...
    def findMaximumFeasibleFlowRate(
        self, double: float, string: typing.Union[java.lang.String, str], double2: float
    ) -> "FlowRateOptimizer.ProcessOperatingPoint": ...
    def findMinimumTotalPowerOperatingPoint(
        self,
        double: float,
        double2: float,
        string: typing.Union[java.lang.String, str],
    ...
    def generateCapacityCurve(
        ...
        double3: float,
        string2: typing.Union[java.lang.String, str],
    ) -> typing.MutableSequence["FlowRateOptimizer.ProcessOperatingPoint"]: ...
    def generateProcessCapacityTable(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        doubleArray2: typing.Union[typing.List[float], jpype.JArray],
        string: typing.Union[java.lang.String, str],
        double3: float,
    ) -> "FlowRateOptimizer.ProcessCapacityTable": ...
    def generateProcessLiftCurve(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        string: typing.Union[java.lang.String, str],
        doubleArray2: typing.Union[typing.List[float], jpype.JArray],
        string2: typing.Union[java.lang.String, str],
    ) -> "FlowRateOptimizer.ProcessLiftCurveTable": ...
    def generateProcessPerformanceTable(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        string: typing.Union[java.lang.String, str],
        double2: float,
        string2: typing.Union[java.lang.String, str],
    ) -> "FlowRateOptimizer.ProcessPerformanceTable": ...
    @typing.overload
    def generateProfessionalLiftCurves(
        self,
        double: float,
        double2: float,
        double3: float,
        double4: float,
        string: typing.Union[java.lang.String, str],
    ) -> "FlowRateOptimizer.LiftCurveResult": ...
    @typing.overload
    def generateProfessionalLiftCurves(
        self, liftCurveConfiguration: "FlowRateOptimizer.LiftCurveConfiguration"
    ) -> "FlowRateOptimizer.LiftCurveResult": ...
    def getEquipmentUtilizationReport(
        self,
    ) -> java.util.Map[
        java.lang.String, "FlowRateOptimizer.EquipmentUtilizationData"
    ]: ...
    ...
    def getProcessCompressors(
        self,
    ) -> java.util.List[jneqsim.process.equipment.compressor.Compressor]: ...
    def getProcessSeparators(
        self,
    ) -> java.util.List[jneqsim.process.equipment.separator.Separator]: ...
    ...
    def setProgressCallback(
        self,
        progressCallback: typing.Union[
            "FlowRateOptimizer.ProgressCallback", typing.Callable
        ],
    ) -> None: ...
    ...
    class LiftCurveConfiguration(java.io.Serializable):
        ...
        def withFlowRateRange(
            self, double: float, double2: float, int: int
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withFlowRateUnit(
            self, string: typing.Union[java.lang.String, str]
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withInletPressureRange(
            self, double: float, double2: float, int: int
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withMaxPowerLimit(
            self, double: float
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withMaxTotalPowerLimit(
            self, double: float
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withMaxUtilization(
            self, double: float
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withOutletPressureRange(
            self, double: float, double2: float, int: int
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
        def withPressureUnit(
            self, string: typing.Union[java.lang.String, str]
        ) -> "FlowRateOptimizer.LiftCurveConfiguration": ...
    ...
    class LiftCurveResult(java.io.Serializable):
        ...
        def getPerformanceTable(
            self,
        ) -> "FlowRateOptimizer.ProcessPerformanceTable": ...
        def getSummary(self) -> java.lang.String: ...
        def getTotalEvaluations(self) -> int: ...
        def getWarnings(self) -> java.util.List[java.lang.String]: ...
        def setCapacityTable(
            self, processCapacityTable: "FlowRateOptimizer.ProcessCapacityTable"
        ) -> None: ...
        def setFeasiblePoints(self, int: int) -> None: ...
        def setGenerationTimeMs(self, long: int) -> None: ...
        def setLiftCurveTable(
            self, processLiftCurveTable: "FlowRateOptimizer.ProcessLiftCurveTable"
        ) -> None: ...
        def setPerformanceTable(
            self, processPerformanceTable: "FlowRateOptimizer.ProcessPerformanceTable"
        ) -> None: ...
    ...
    class ProcessCapacityTable(java.io.Serializable):
        ...
        def setOperatingPoint(
            self,
            int: int,
            int2: int,
            processOperatingPoint: "FlowRateOptimizer.ProcessOperatingPoint",
        ) -> None: ...
        def setPressureUnit(
            self, string: typing.Union[java.lang.String, str]
        ) -> None: ...
    ...
    class ProcessOperatingPoint(java.io.Serializable):
        def __init__(self): ...
        def addCompressorOperatingPoint(
            self,
            string: typing.Union[java.lang.String, str],
            compressorOperatingPoint: "FlowRateOptimizer.CompressorOperatingPoint",
        ) -> None: ...
        def getCompressorNames(self) -> java.util.List[java.lang.String]: ...
        def getCompressorOperatingPoint(
            self, string: typing.Union[java.lang.String, str]
        ) -> "FlowRateOptimizer.CompressorOperatingPoint": ...
        def getCompressorOperatingPoints(
            self,
        ) -> java.util.Map[
            java.lang.String, "FlowRateOptimizer.CompressorOperatingPoint"
        ]: ...
        def getCompressorPower(
            self, string: typing.Union[java.lang.String, str]
        ) -> float: ...
        def getConstraintViolations(
            self,
        ...
        def getTotalPower(self) -> float: ...
        def isFeasible(self) -> bool: ...
        def setConstraintViolations(
            self, list: java.util.List[FlowRateOptimizationResult.ConstraintViolation]
        ) -> None: ...
        def setEquipmentData(
            self,
            map: typing.Union[
                java.util.Map[
                    typing.Union[java.lang.String, str],
                    "FlowRateOptimizer.EquipmentUtilizationData",
                ],
                typing.Mapping[
                    typing.Union[java.lang.String, str],
                    "FlowRateOptimizer.EquipmentUtilizationData",
...
class FluidMagicInput(java.io.Serializable):
    ...
    class Builder:
        ...
        def gorRange(
            self, double: float, double2: float
        ) -> "FluidMagicInput.Builder": ...
        def gorSpacing(
            self, gORSpacing: "FluidMagicInput.GORSpacing"
        ) -> "FluidMagicInput.Builder": ...
...
class InstalledCapacityTableLoader:
    ...
    def load(
        processModel: jneqsim.process.processmodel.ProcessModel,
        string: typing.Union[java.lang.String, str],
    ) -> java.util.List["InstalledCapacityTableLoader.InstalledCapacityRecord"]: ...
    @typing.overload
    @staticmethod
    def load(
        processModel: jneqsim.process.processmodel.ProcessModel,
...
class MonteCarloSimulator(java.io.Serializable):
    def __init__(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem, int: int
    ): ...
    def addTriangularParameter(
        self,
        string: typing.Union[java.lang.String, str],
        double: float,
        double2: float,
        double3: float,
        parameterApplier: typing.Union[
            "MonteCarloSimulator.ParameterApplier", typing.Callable
        ],
    ) -> "MonteCarloSimulator": ...
    def addUniformParameter(
        self,
        string: typing.Union[java.lang.String, str],
        double: float,
        double2: float,
...
class MultiObjectiveOptimizer(java.io.Serializable):
    ...
    def onProgress(
        self,
        progressCallback: typing.Union[
            "MultiObjectiveOptimizer.ProgressCallback", typing.Callable
        ],
    ) -> "MultiObjectiveOptimizer": ...
    @typing.overload
    def optimizeEpsilonConstraint(
        self,
        processSystem: jneqsim.process.processmodel.ProcessSystem,
        streamInterface: jneqsim.process.equipment.stream.StreamInterface,
        objectiveFunction: "ObjectiveFunction",
        list: java.util.List["ObjectiveFunction"],
        optimizationConfig: "ProductionOptimizer.OptimizationConfig",
        int: int,
    ) -> "ParetoFront": ...
    @typing.overload
    ...
    class ProgressCallback:
        def onProgress(
            self, int: int, int2: int, paretoSolution: "ParetoSolution"
        ) -> None: ...
...
class MultiScenarioVFPGenerator(java.io.Serializable):
    ...
    def __init__(
        ...
        supplier: typing.Union[
            java.util.function.Supplier[jneqsim.process.processmodel.ProcessSystem],
            typing.Callable[[], jneqsim.process.processmodel.ProcessSystem],
        ],
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ): ...
    ...
    def setFlashGenerator(
        self, recombinationFlashGenerator: "RecombinationFlashGenerator"
    ) -> None: ...
    def setFlowRateUnit(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setFlowRates(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
...
class OptimizationResultBase(java.io.Serializable):
    ...
    @typing.overload
    def addConstraintViolation(
        self, constraintViolation: "OptimizationResultBase.ConstraintViolation"
    ) -> None: ...
    def addInitialValue(
        self, string: typing.Union[java.lang.String, str], double: float
    ) -> None: ...
    ...
    def getConstraintViolations(
        self,
    ) -> java.util.List["OptimizationResultBase.ConstraintViolation"]: ...
    ...
    def setBottleneckConstraint(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def setBottleneckEquipment(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def setConstraintEvaluations(self, int: int) -> None: ...
    def setConstraintMargins(
        self,
        map: typing.Union[
            java.util.Map[typing.Union[java.lang.String, str], float],
            typing.Mapping[typing.Union[java.lang.String, str], float],
    ...
    def setConstraintViolations(
        self, list: java.util.List["OptimizationResultBase.ConstraintViolation"]
    ) -> None: ...
    def setConverged(self, boolean: bool) -> None: ...
...
class ParetoFront(java.io.Serializable, java.lang.Iterable["ParetoSolution"]):
    ...
    def getSolutionsSortedBy(
        self, int: int, boolean: bool
    ) -> java.util.List["ParetoSolution"]: ...
...
class ParetoSolution(java.io.Serializable, java.lang.Comparable["ParetoSolution"]):
    ...
    def crowdingDistance(
        self,
        paretoSolution: "ParetoSolution",
        paretoSolution2: "ParetoSolution",
        int: int,
        double: float,
    ) -> float: ...
    ...
    class Builder:
        ...
        def decisionVariable(
            self, string: typing.Union[java.lang.String, str], double: float
        ) -> "ParetoSolution.Builder": ...
        def decisionVariables(
            self,
            map: typing.Union[
                java.util.Map[typing.Union[java.lang.String, str], float],
                typing.Mapping[typing.Union[java.lang.String, str], float],
...
class PressureBoundaryOptimizer(java.io.Serializable):
    ...
    def findMinimumPowerOperatingPoint(
        self,
        double: float,
        double2: float,
        string: typing.Union[java.lang.String, str],
    ...
    def generateLiftCurveTable(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        doubleArray2: typing.Union[typing.List[float], jpype.JArray],
        string: typing.Union[java.lang.String, str],
    ) -> "PressureBoundaryOptimizer.LiftCurveTable": ...
    def getCompressors(
        self,
    ) -> java.util.List[jneqsim.process.equipment.compressor.Compressor]: ...
...
class ProcessConstraintEvaluator(java.io.Serializable):
    ...
    def __init__(self, processSystem: jneqsim.process.processmodel.ProcessSystem): ...
    @typing.overload
    def calculateFlowSensitivities(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> java.util.Map[java.lang.String, float]: ...
    @typing.overload
    def calculateFlowSensitivities(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem, double: float
    ) -> java.util.Map[java.lang.String, float]: ...
    def clearCache(self) -> None: ...
    @typing.overload
    def estimateMaxFlow(
    ...
    def evaluate(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
    ) -> "ProcessConstraintEvaluator.ConstraintEvaluationResult": ...
    ...
    class ConstraintEvaluationResult(java.io.Serializable):
        def __init__(self): ...
        def addEquipmentSummary(
            self,
            equipmentConstraintSummary: "ProcessConstraintEvaluator.EquipmentConstraintSummary",
        ) -> None: ...
        def addNormalizedUtilization(
            self, string: typing.Union[java.lang.String, str], double: float
        ) -> None: ...
        def getBottleneckConstraint(self) -> java.lang.String: ...
        def getBottleneckEquipment(self) -> java.lang.String: ...
        ...
        def getEquipmentSummaries(
            self,
        ) -> java.util.Map[
            java.lang.String, "ProcessConstraintEvaluator.EquipmentConstraintSummary"
        ]: ...
        def getNormalizedUtilizations(
            self,
        ) -> java.util.Map[java.lang.String, float]: ...
        def getOverallUtilization(self) -> float: ...
...
class ProcessModelSimulationEvaluator(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, processModel: jneqsim.process.processmodel.ProcessModel): ...
    def addConstraintEquality(
        self,
        string: typing.Union[java.lang.String, str],
        toDoubleFunction: typing.Union[
            java.util.function.ToDoubleFunction[
                jneqsim.process.processmodel.ProcessModel
            ],
            typing.Callable[[jneqsim.process.processmodel.ProcessModel], float],
        ],
        double: float,
        double2: float,
    ) -> "ProcessModelSimulationEvaluator": ...
    def addConstraintLowerBound(
        self,
        string: typing.Union[java.lang.String, str],
        toDoubleFunction: typing.Union[
            java.util.function.ToDoubleFunction[
    ...
    def addObjective(
        ...
        direction: "ProcessModelSimulationEvaluator.ObjectiveDefinition.Direction",
    ) -> "ProcessModelSimulationEvaluator": ...
    @typing.overload
    def addParameter(
        self,
    ...
    def addParameterWithSetter(
        self,
        string: typing.Union[java.lang.String, str],
        biConsumer: typing.Union[
            java.util.function.BiConsumer[
                jneqsim.process.processmodel.ProcessModel, float
            ],
            typing.Callable[[jneqsim.process.processmodel.ProcessModel, float], None],
        ],
        double: float,
        double2: float,
        string2: typing.Union[java.lang.String, str],
    ) -> "ProcessModelSimulationEvaluator": ...
    def estimateConstraintJacobian(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> typing.MutableSequence[typing.MutableSequence[float]]: ...
    @typing.overload
    ...
    @typing.overload
    def estimateGradient(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray], int: int
    ) -> typing.MutableSequence[float]: ...
    def evaluate(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> "ProcessModelSimulationEvaluator.EvaluationResult": ...
    def evaluateObjective(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> float: ...
    def evaluatePenalizedObjective(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> float: ...
    def findActiveBottleneck(
        self, processModel: jneqsim.process.processmodel.ProcessModel
    ) -> "ProcessModelSimulationEvaluator.BottleneckStatus": ...
    ...
    def getConstraintCount(self) -> int: ...
    def getConstraintMarginVector(
        self, processModel: jneqsim.process.processmodel.ProcessModel
    ) -> typing.MutableSequence[float]: ...
    def getConstraints(
        self,
    ) -> java.util.List["ProcessModelSimulationEvaluator.ConstraintDefinition"]: ...
    ...
    def getObjectives(
        self,
    ) -> java.util.List["ProcessModelSimulationEvaluator.ObjectiveDefinition"]: ...
    def getParameterCount(self) -> int: ...
    def getParameters(
        self,
    ) -> java.util.List["ProcessModelSimulationEvaluator.ParameterDefinition"]: ...
    ...
    class ConstraintDefinition(java.io.Serializable):
        ...
        def getAreaName(self) -> java.lang.String: ...
        def getCapturedCapacityConstraint(
            self,
        ...
        def getType(
            self,
        ) -> "ProcessModelSimulationEvaluator.ConstraintDefinition.Type": ...
        def getUnit(self) -> java.lang.String: ...
        ...
        def setType(
            self, type: "ProcessModelSimulationEvaluator.ConstraintDefinition.Type"
        ) -> None: ...
        def setUnit(self, string: typing.Union[java.lang.String, str]) -> None: ...
        def setUpperBound(self, double: float) -> None: ...

        class Type(
            java.lang.Enum["ProcessModelSimulationEvaluator.ConstraintDefinition.Type"]
        ):
            LOWER_BOUND: typing.ClassVar[
                "ProcessModelSimulationEvaluator.ConstraintDefinition.Type"
            ] = ...
            UPPER_BOUND: typing.ClassVar[
                "ProcessModelSimulationEvaluator.ConstraintDefinition.Type"
            ] = ...
            RANGE: typing.ClassVar[
                "ProcessModelSimulationEvaluator.ConstraintDefinition.Type"
            ] = ...
            EQUALITY: typing.ClassVar[
                "ProcessModelSimulationEvaluator.ConstraintDefinition.Type"
            ] = ...
            _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
            @typing.overload
    ...
    class EvaluationResult(java.io.Serializable):
        ...
        def setActiveBottleneck(
            self, bottleneckStatus: "ProcessModelSimulationEvaluator.BottleneckStatus"
        ) -> None: ...
        def setAdditionalOutputs(
            self,
            map: typing.Union[
                java.util.Map[typing.Union[java.lang.String, str], float],
                typing.Mapping[typing.Union[java.lang.String, str], float],
    ...
    class ObjectiveDefinition(java.io.Serializable):
        ...
        def getDirection(
            self,
        ) -> "ProcessModelSimulationEvaluator.ObjectiveDefinition.Direction": ...
        def getEvaluator(
            self,
        ) -> java.util.function.ToDoubleFunction[
            jneqsim.process.processmodel.ProcessModel
        ...
        class Direction(
            ...
            MINIMIZE: typing.ClassVar[
                "ProcessModelSimulationEvaluator.ObjectiveDefinition.Direction"
            ] = ...
            MAXIMIZE: typing.ClassVar[
                "ProcessModelSimulationEvaluator.ObjectiveDefinition.Direction"
            ] = ...
            _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
            @typing.overload
    ...
    class ParameterDefinition(java.io.Serializable):
        ...
        def setSetter(
            ...
            biConsumer: typing.Union[
                ...
                typing.Callable[
                    [jneqsim.process.processmodel.ProcessModel, float], None
                ],
            ],
        ) -> None: ...
        def setUnit(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class ProcessModelThroughputOptimizer(java.io.Serializable):
    ...
    def findMaximumThroughput(
        self, double: float, double2: float, double3: float
    ) -> "ProcessModelThroughputResult": ...
    def getMaxIterations(self) -> int: ...
    def getProducerControls(
        self,
    ) -> java.util.List["ProcessModelThroughputOptimizer.ProducerControl"]: ...
    ...
    def setIncludeEquipmentCapacityConstraints(
        self, boolean: bool
    ) -> "ProcessModelThroughputOptimizer": ...
    def setIncludeStrategyCapacityConstraints(
        self, boolean: bool
    ) -> "ProcessModelThroughputOptimizer": ...
...
class ProcessOptimizationEngine(java.io.Serializable):
    ...
    def analyzeSensitivity(
        self, double: float, double2: float, double3: float
    ) -> "ProcessOptimizationEngine.SensitivityResult": ...
    def bfgsSearch(
        self,
        double: float,
        double2: float,
    ...
    def calculateShadowPrices(
        self, double: float, double2: float, double3: float
    ) -> java.util.Map[java.lang.String, float]: ...
    def clearCache(self) -> None: ...
    def createFlowAdjuster(
        self,
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
        string3: typing.Union[java.lang.String, str],
    ...
    def disableAdjusters(
        self,
    ) -> java.util.List[jneqsim.process.equipment.util.Adjuster]: ...
    def enableAdjusters(
        self, list: java.util.List[jneqsim.process.equipment.util.Adjuster]
    ) -> None: ...
    def estimateMaximumFlow(
        self, double: float, string: typing.Union[java.lang.String, str]
    ) -> float: ...
    def evaluateAllConstraints(
        self,
    ) -> "ProcessOptimizationEngine.ConstraintReport": ...
    def evaluateConstraintsWithCache(
        self,
    ) -> ProcessConstraintEvaluator.ConstraintEvaluationResult: ...
    def findBottleneckEquipment(self) -> java.lang.String: ...
    def findMaximumThroughput(
        self, double: float, double2: float, double3: float, double4: float
    ) -> "ProcessOptimizationEngine.OptimizationResult": ...
    def findRequiredInletPressure(
        self, double: float, double2: float, double3: float, double4: float
    ) -> "ProcessOptimizationEngine.OptimizationResult": ...
    def generateComprehensiveLiftCurve(
        self,
        string: typing.Union[java.lang.String, str],
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        double2: float,
    ) -> FlowRateOptimizer: ...
    def generateLiftCurve(
        self,
        doubleArray: typing.Union[typing.List[float], jpype.JArray],
        doubleArray2: typing.Union[typing.List[float], jpype.JArray],
        doubleArray3: typing.Union[typing.List[float], jpype.JArray],
        doubleArray4: typing.Union[typing.List[float], jpype.JArray],
    ) -> "ProcessOptimizationEngine.LiftCurveData": ...
    def getAdjusters(
        self,
    ) -> java.util.List[jneqsim.process.equipment.util.Adjuster]: ...
    ...
    def getTolerance(self) -> float: ...
    def gradientDescentArmijoWolfeSearch(
        self, double: float, double2: float, double3: float
    ) -> float: ...
    def gradientDescentSearch(
        self, double: float, double2: float, double3: float
    ) -> float: ...
    def isEnforceConstraints(self) -> bool: ...
    def optimizeWithAdjusterTargets(
        self, double: float, double2: float, double3: float, double4: float
    ) -> "ProcessOptimizationEngine.OptimizationResult": ...
    def optimizeWithAdjustersDisabled(
        self, double: float, double2: float, double3: float, double4: float
    ) -> "ProcessOptimizationEngine.OptimizationResult": ...
    ...
    def setSearchAlgorithm(
        self, searchAlgorithm: "ProcessOptimizationEngine.SearchAlgorithm"
    ) -> None: ...
    def setTolerance(self, double: float) -> None: ...
    ...
    class ConstraintReport(java.io.Serializable):
        ...
        def addEquipmentStatus(
            self,
            equipmentConstraintStatus: "ProcessOptimizationEngine.EquipmentConstraintStatus",
        ) -> None: ...
        def getBottleneck(
            self,
        ) -> "ProcessOptimizationEngine.EquipmentConstraintStatus": ...
        def getEquipmentStatuses(
            self,
        ) -> java.util.List["ProcessOptimizationEngine.EquipmentConstraintStatus"]: ...
    ...
    class EquipmentConstraintStatus(java.io.Serializable):
        ...
        def setConstraints(
            self,
            list: java.util.List[jneqsim.process.equipment.capacity.CapacityConstraint],
        ) -> None: ...
        def setEquipmentName(
            self, string: typing.Union[java.lang.String, str]
        ) -> None: ...
    ...
    class LiftCurveData(java.io.Serializable):
        def __init__(self): ...
        def addPoint(
            self, liftCurvePoint: "ProcessOptimizationEngine.LiftCurvePoint"
        ) -> None: ...
        def getPoints(
            self,
        ) -> java.util.List["ProcessOptimizationEngine.LiftCurvePoint"]: ...
        def size(self) -> int: ...
    ...
    class OptimizationResult(java.io.Serializable):
        ...
        def setOutletPressure(self, double: float) -> None: ...
        def setSensitivity(
            self, sensitivityResult: "ProcessOptimizationEngine.SensitivityResult"
        ) -> None: ...
    ...
    class SearchAlgorithm(java.lang.Enum["ProcessOptimizationEngine.SearchAlgorithm"]):
        ...
        GRADIENT_DESCENT: typing.ClassVar[
            "ProcessOptimizationEngine.SearchAlgorithm"
        ] = ...
        GRADIENT_DESCENT_ARMIJO_WOLFE: typing.ClassVar[
            "ProcessOptimizationEngine.SearchAlgorithm"
        ] = ...
        BFGS: typing.ClassVar["ProcessOptimizationEngine.SearchAlgorithm"] = ...
        SEQUENTIAL_QUADRATIC_PROGRAMMING: typing.ClassVar[
            "ProcessOptimizationEngine.SearchAlgorithm"
        ] = ...
        _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
        @typing.overload
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ProcessOptimizationEngine.SearchAlgorithm"]
        ): ...
...
class ProductionImpactAnalyzer(java.io.Serializable):
    ...
    def clearCache(self) -> None: ...
    def compareFailureScenarios(
        self, list: java.util.List[typing.Union[java.lang.String, str]]
    ) -> java.util.List["ProductionImpactResult"]: ...
    def compareToPlantStop(
        self, string: typing.Union[java.lang.String, str]
    ) -> "ProductionImpactResult": ...
    def getProcessSystem(self) -> jneqsim.process.processmodel.ProcessSystem: ...
    def rankEquipmentByCriticality(
        self,
    ) -> java.util.List["ProductionImpactResult"]: ...
    def setFeedStreamName(
        self, string: typing.Union[java.lang.String, str]
    ) -> "ProductionImpactAnalyzer": ...
    def setOptimizeDegradedOperation(
        self, boolean: bool
    ) -> "ProductionImpactAnalyzer": ...
    def setProcessSystem(
        self, processSystem: jneqsim.process.processmodel.ProcessSystem
...
class ProductionImpactResult(java.io.Serializable):
    ...
    def addAffectedEquipment(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def addOptimizedSetpoint(
        self, string: typing.Union[java.lang.String, str], double: float
    ) -> None: ...
    ...
    def setRecommendationReason(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def setRecommendedAction(
        self, recommendedAction: "ProductionImpactResult.RecommendedAction"
    ) -> None: ...
    ...
    class RecommendedAction(java.lang.Enum["ProductionImpactResult.RecommendedAction"]):
        ...
        REDUCE_THROUGHPUT: typing.ClassVar[
            "ProductionImpactResult.RecommendedAction"
        ] = ...
        PARTIAL_SHUTDOWN: typing.ClassVar[
            "ProductionImpactResult.RecommendedAction"
        ] = ...
        FULL_SHUTDOWN: typing.ClassVar["ProductionImpactResult.RecommendedAction"] = ...
        BYPASS_EQUIPMENT: typing.ClassVar[
            "ProductionImpactResult.RecommendedAction"
        ] = ...
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["ProductionImpactResult.RecommendedAction"]
        ): ...
...
class SQPoptimizer(java.io.Serializable):
    ...
    def addEqualityConstraint(
        self,
        constraintFunc: typing.Union["SQPoptimizer.ConstraintFunc", typing.Callable],
    ) -> None: ...
    ...
    def setObjectiveFunction(
        self, objectiveFunc: typing.Union["SQPoptimizer.ObjectiveFunc", typing.Callable]
    ) -> None: ...
    def setTolerance(self, double: float) -> None: ...
...
class SensitivityAnalysis(java.io.Serializable):
    ...
    def setParameter(
        ...
        biConsumer: typing.Union[
            ...
            typing.Callable[[jneqsim.process.processmodel.ProcessSystem, float], None],
        ],
    ) -> "SensitivityAnalysis": ...
    @typing.overload
    def setParameter(
        ...
        consumer: typing.Union[
            java.util.function.Consumer[jneqsim.process.processmodel.ProcessSystem],
            typing.Callable[[jneqsim.process.processmodel.ProcessSystem], None],
        ],
    ) -> "SensitivityAnalysis": ...
...
class ThroughputCaseRow(java.io.Serializable):
    ...
    def fromEvaluation(
        ...
        evaluationResult: ProcessModelSimulationEvaluator.EvaluationResult,
    ) -> "ThroughputCaseRow": ...
...
class ProcessSimulationEvaluator(java.io.Serializable):
    ...
    def addObjective(
        ...
        direction: "ProcessSimulationEvaluator.ObjectiveDefinition.Direction",
    ) -> "ProcessSimulationEvaluator": ...
    @typing.overload
    def addObjective(
        self,
    ...
    def evaluate(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> "ProcessSimulationEvaluator.EvaluationResult": ...
    def evaluateObjective(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> float: ...
    def evaluatePenalizedObjective(
    ...
    def getConstraintMargins(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> typing.MutableSequence[float]: ...
    def getConstraints(
        self,
    ) -> java.util.List["ProcessSimulationEvaluator.ConstraintDefinition"]: ...
    def getEvaluationCount(self) -> int: ...
    def getFiniteDifferenceStep(self) -> float: ...
    def getInitialValues(self) -> typing.MutableSequence[float]: ...
    ...
    def getObjectives(
        self,
    ) -> java.util.List["ProcessSimulationEvaluator.ObjectiveDefinition"]: ...
    def getParameterCount(self) -> int: ...
    def getParameters(
        self,
    ) -> java.util.List["ProcessSimulationEvaluator.ParameterDefinition"]: ...
    def getProblemDefinition(self) -> java.util.Map[java.lang.String, typing.Any]: ...
    def getProcessSystem(self) -> jneqsim.process.processmodel.ProcessSystem: ...
    def getUpperBounds(self) -> typing.MutableSequence[float]: ...
    ...
    class ConstraintDefinition(java.io.Serializable, ProcessConstraint):
        ...
        def setPenaltyWeight(self, double: float) -> None: ...
        def setType(
            self, type: "ProcessSimulationEvaluator.ConstraintDefinition.Type"
        ) -> None: ...
        def setUnit(self, string: typing.Union[java.lang.String, str]) -> None: ...
        def setUpperBound(self, double: float) -> None: ...
        def toOptimizationConstraint(
            self,
        ) -> "ProductionOptimizer.OptimizationConstraint": ...

        class Type(
            java.lang.Enum["ProcessSimulationEvaluator.ConstraintDefinition.Type"]
        ):
            LOWER_BOUND: typing.ClassVar[
                "ProcessSimulationEvaluator.ConstraintDefinition.Type"
            ] = ...
            UPPER_BOUND: typing.ClassVar[
                "ProcessSimulationEvaluator.ConstraintDefinition.Type"
            ] = ...
    ...
    class ObjectiveDefinition(java.io.Serializable):
        ...
        def getDirection(
            self,
        ) -> "ProcessSimulationEvaluator.ObjectiveDefinition.Direction": ...
        def getEvaluator(
            self,
        ) -> java.util.function.ToDoubleFunction[
            jneqsim.process.processmodel.ProcessSystem
        ...
        def getWeight(self) -> float: ...
        def setDirection(
            self, direction: "ProcessSimulationEvaluator.ObjectiveDefinition.Direction"
        ) -> None: ...
        def setEvaluator(
            self,
            toDoubleFunction: typing.Union[
        ...
        class Direction(
            java.lang.Enum["ProcessSimulationEvaluator.ObjectiveDefinition.Direction"]
        ):
            MINIMIZE: typing.ClassVar[
                "ProcessSimulationEvaluator.ObjectiveDefinition.Direction"
            ] = ...
...
class ProductionOptimizer:
    ...
    class ParetoPoint:
        ...
        def dominates(
            self,
            paretoPoint: "ProductionOptimizer.ParetoPoint",
            map: typing.Union[
                java.util.Map[
                    typing.Union[java.lang.String, str],
                    "ProductionOptimizer.ObjectiveType",
    ...
    class ParetoResult:
        def __init__(
            self,
            list: java.util.List["ProductionOptimizer.ParetoPoint"],
            list2: java.util.List["ProductionOptimizer.ParetoPoint"],
            list3: java.util.List[typing.Union[java.lang.String, str]],
            map: typing.Union[
                java.util.Map[
                    typing.Union[java.lang.String, str],
                    "ProductionOptimizer.ObjectiveType",
        ...
        def getObjectiveTypes(
            self,
        ) -> java.util.Map[java.lang.String, "ProductionOptimizer.ObjectiveType"]: ...
        def getParetoFront(
            self,
        ) -> java.util.List["ProductionOptimizer.ParetoPoint"]: ...
...
class StandardObjective(java.lang.Enum["StandardObjective"], ObjectiveFunction):
    ...
    @staticmethod
    def maximizeManifoldThroughput(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    ...
    @staticmethod
    def maximizePumpNPSHMargin(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def maximizeStreamFlow(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    ...
    @staticmethod
    def minimizeManifoldBranchLOF(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizeManifoldHeaderFRMS(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizeManifoldHeaderLOF(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizeManifoldImbalance(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizeManifoldPressureDrop(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizeManifoldVelocityRatio(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizePipelineVibration(
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
        string3: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizePumpPower(
        string: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    @staticmethod
    def minimizeStreamFlow(
        string: typing.Union[java.lang.String, str],
        string2: typing.Union[java.lang.String, str],
    ) -> ObjectiveFunction: ...
    _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
