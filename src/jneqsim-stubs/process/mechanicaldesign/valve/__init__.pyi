...
class ControlValveGasSizing_IEC_60534_2_1(java.io.Serializable):
    ...
    def fromValve(self, throttlingValve: jneqsim.process.equipment.valve.ThrottlingValve) -> None: ...
    ...
    def setFlowConditions(self, double: float, double2: float, double3: float, double4: float) -> None: ...
    def setValveCoefficients(self, double: float, double2: float, double3: float) -> None: ...
...
class ControlValveNoise_IEC_60534_8_3(java.io.Serializable):
    ...
    def setAcousticProperties(self, double: float, double2: float, double3: float) -> None: ...
    def setFlowConditions(self, double: float, double2: float, double3: float, double4: float, double5: float) -> None: ...
...
class ValveMechanicalDesign(jneqsim.process.mechanicaldesign.MechanicalDesign):
    ...
    @typing.overload
    def addAvailableTrimOption(self, string: typing.Union[java.lang.String, str], double: float, double2: float) -> None: ...
    @typing.overload
    def addAvailableTrimOption(self, string: typing.Union[java.lang.String, str], double: float, double2: float, string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> None: ...
    def assessTrimOptionsForRequiredCv(self, double: float) -> 'ValveTrimSizingResult': ...
    def calcDesign(self) -> None: ...
    def calcValveSize(self) -> java.util.Map[java.lang.String, typing.Any]: ...
    def clearAvailableTrimOptions(self) -> None: ...
    def displayResults(self) -> None: ...
    def evaluateAvailableTrimOptions(self) -> 'ValveTrimSizingResult': ...
    def getActuatorWeight(self) -> float: ...
    def getAnsiPressureClass(self) -> int: ...
    def getAvailableTrimOptions(self) -> java.util.List['ValveTrimOption']: ...
    ...
    def getMaximumAllowedTrimUtilization(self) -> float: ...
    def getMaximumAvailableTrimCv(self) -> float: ...
    ...
    def getSelectedTrimOption(self) -> 'ValveTrimOption': ...
    def getStemDiameter(self) -> float: ...
    def getTrimCvUtilization(self) -> float: ...
    def getTrimSizingResult(self) -> 'ValveTrimSizingResult': ...
    ...
    def setChokeDiameter(self, double: float, string: typing.Union[java.lang.String, str]) -> None: ...
    def setChokeDischargeCoefficient(self, double: float) -> None: ...
    def setMaximumAllowedTrimUtilization(self, double: float) -> None: ...
...
class ValveMechanicalDesignResponse(jneqsim.process.mechanicaldesign.MechanicalDesignResponse):
    ...
    def getRelativeTrimSizePercent(self) -> float: ...
    def getRequiredActuatorThrust(self) -> float: ...
    def getSelectedTrimIdentifier(self) -> java.lang.String: ...
    def getSelectedTrimMaximumCv(self) -> float: ...
    def getStemDiameter(self) -> float: ...
    def getTrimAssessmentStatus(self) -> java.lang.String: ...
    def getTrimConstruction(self) -> java.lang.String: ...
    def getTrimCvCapacityMargin(self) -> float: ...
    def getTrimCvUtilization(self) -> float: ...
    def getTrimMaterial(self) -> java.lang.String: ...
    def getTrimRecommendation(self) -> java.lang.String: ...
    ...
    def isChoked(self) -> bool: ...
    def isTrimFeasible(self) -> bool: ...
    def populateFromValveDesign(self, valveMechanicalDesign: ValveMechanicalDesign) -> None: ...
    ...
    def setAvailableTrimOptions(self, list: java.util.List['ValveTrimOption']) -> None: ...
    ...
    def setMaximumAllowedTrimUtilization(self, double: float) -> None: ...
    def setMaximumAvailableTrimCv(self, double: float) -> None: ...
    ...
    def setRelativeTrimSizePercent(self, double: float) -> None: ...
    def setRequiredActuatorThrust(self, double: float) -> None: ...
    def setSelectedTrimIdentifier(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setSelectedTrimMaximumCv(self, double: float) -> None: ...
    def setStemDiameter(self, double: float) -> None: ...
    def setTrimAssessmentStatus(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setTrimConstruction(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setTrimCvCapacityMargin(self, double: float) -> None: ...
    def setTrimCvUtilization(self, double: float) -> None: ...
    def setTrimFeasible(self, boolean: bool) -> None: ...
    def setTrimMaterial(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setTrimRecommendation(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setValveCharacteristic(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class ValveTrimOption(java.io.Serializable):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]): ...
    def getConstruction(self) -> java.lang.String: ...
    def getIdentifier(self) -> java.lang.String: ...
    def getMaterial(self) -> java.lang.String: ...
    def getMaximumDesignCv(self) -> float: ...
    def getRelativeTrimSizePercent(self) -> float: ...

class ValveTrimSizingResult(java.io.Serializable):
    @staticmethod
    def feasible(double: float, valveTrimOption: ValveTrimOption, double2: float, double3: float) -> 'ValveTrimSizingResult': ...
    def getCapacityMarginCv(self) -> float: ...
    def getLimitingTrimOption(self) -> ValveTrimOption: ...
    def getMaximumAllowedUtilization(self) -> float: ...
    def getMaximumAvailableCv(self) -> float: ...
    def getRecommendation(self) -> java.lang.String: ...
    def getRequiredCv(self) -> float: ...
    def getSelectedTrimOption(self) -> ValveTrimOption: ...
    def getStatus(self) -> 'ValveTrimSizingResult.Status': ...
    def getUtilization(self) -> float: ...
    @staticmethod
    def infeasible(double: float, valveTrimOption: ValveTrimOption, double2: float) -> 'ValveTrimSizingResult': ...
    def isEvaluated(self) -> bool: ...
    def isFeasible(self) -> bool: ...
    @typing.overload
    @staticmethod
    def notEvaluated(double: float, string: typing.Union[java.lang.String, str]) -> 'ValveTrimSizingResult': ...
    @typing.overload
    @staticmethod
    def notEvaluated(double: float, string: typing.Union[java.lang.String, str], double2: float) -> 'ValveTrimSizingResult': ...
    class Status(java.lang.Enum['ValveTrimSizingResult.Status']):
        NOT_EVALUATED: typing.ClassVar['ValveTrimSizingResult.Status'] = ...
        FEASIBLE: typing.ClassVar['ValveTrimSizingResult.Status'] = ...
        NO_FEASIBLE_TRIM: typing.ClassVar['ValveTrimSizingResult.Status'] = ...
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ValveTrimSizingResult.Status': ...
        @staticmethod
        def values() -> typing.MutableSequence['ValveTrimSizingResult.Status']: ...
...
class ControlValveSizing_MultiphaseChoke(ControlValveSizingInterface, java.io.Serializable):
    @typing.overload
    def __init__(self, valveMechanicalDesign: ValveMechanicalDesign): ...
    @typing.overload
    def __init__(self, valveMechanicalDesign: ValveMechanicalDesign, string: typing.Union[java.lang.String, str]): ...
    def calcValveSize(self, double: float) -> java.util.Map[java.lang.String, typing.Any]: ...
    def calculateFlowRateFromValveOpening(self, double: float, streamInterface: jneqsim.process.equipment.stream.StreamInterface, streamInterface2: jneqsim.process.equipment.stream.StreamInterface) -> float: ...
    def calculateValveOpeningFromFlowRate(self, double: float, double2: float, streamInterface: jneqsim.process.equipment.stream.StreamInterface, streamInterface2: jneqsim.process.equipment.stream.StreamInterface) -> float: ...
    def findOutletPressureForFixedKv(self, double: float, streamInterface: jneqsim.process.equipment.stream.StreamInterface) -> float: ...
    def getChokeDiameter(self) -> float: ...
    def getChokeModel(self) -> jneqsim.process.mechanicaldesign.valve.choke.MultiphaseChokeFlow: ...
    def getChokeReport(self, streamInterface: jneqsim.process.equipment.stream.StreamInterface, double: float) -> java.lang.String: ...
...
class __module_protocol__(Protocol):
    ...
    ControlValveGasSizing_IEC_60534_2_1: typing.Type[ControlValveGasSizing_IEC_60534_2_1]
    ...
    ValveTrimOption: typing.Type[ValveTrimOption]
    ValveTrimSizingResult: typing.Type[ValveTrimSizingResult]
