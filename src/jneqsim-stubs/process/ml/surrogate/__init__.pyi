...
class PhysicsConstraintValidator(java.io.Serializable):
    ...
    ) -> "PhysicsConstraintValidator.ValidationResult": ...
    ...
    class ValidationResult(java.io.Serializable):
        ...
        def getViolations(
            self,
        ) -> java.util.List["PhysicsConstraintValidator.ConstraintViolation"]: ...
...
class SurrogateModelRegistry(java.io.Serializable):
    ...
    ) -> java.util.Optional["SurrogateModelRegistry.SurrogateModel"]: ...
    def getAllModels(
        self,
    ) -> java.util.Map[
        java.lang.String, "SurrogateModelRegistry.SurrogateMetadata"
    ]: ...
    @staticmethod
    def getInstance() -> "SurrogateModelRegistry": ...
    def getMetadata(
        self, string: typing.Union[java.lang.String, str]
    ) -> java.util.Optional["SurrogateModelRegistry.SurrogateMetadata"]: ...
    ...
    def register(
        self,
        string: typing.Union[java.lang.String, str],
        surrogateModel: typing.Union[
            "SurrogateModelRegistry.SurrogateModel", typing.Callable
        ],
    ) -> None: ...
    @typing.overload
    def register(
        ...
        surrogateMetadata: "SurrogateModelRegistry.SurrogateMetadata",
    ) -> None: ...
    def saveModel(
        self,
        string: typing.Union[java.lang.String, str],
