...
class InhibitorInjectionPoint(jneqsim.process.equipment.TwoPortEquipment):
    ...
    def setChemical(self, productionChemical: jneqsim.process.chemistry.ProductionChemical) -> None: ...
    ...
    class DoseMode(java.lang.Enum['InhibitorInjectionPoint.DoseMode']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'InhibitorInjectionPoint.DoseMode': ...
        @staticmethod
