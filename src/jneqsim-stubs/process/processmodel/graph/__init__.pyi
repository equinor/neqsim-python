...
class ProcessGraph(java.io.Serializable):
    ...
    def addSignalEdge(self, processNode: 'ProcessNode', processNode2: 'ProcessNode', string: typing.Union[java.lang.String, str], edgeType: ProcessEdge.EdgeType) -> ProcessEdge: ...
