...
class GasPhysicalPropertyMethod(jneqsim.physicalproperties.methods.PhysicalPropertyMethod):
...
class __module_protocol__(Protocol):
    ...
    conductivity: jneqsim.physicalproperties.methods.gasphysicalproperties.conductivity.__module_protocol__
    density: jneqsim.physicalproperties.methods.gasphysicalproperties.density.__module_protocol__
    diffusivity: jneqsim.physicalproperties.methods.gasphysicalproperties.diffusivity.__module_protocol__
    viscosity: jneqsim.physicalproperties.methods.gasphysicalproperties.viscosity.__module_protocol__
