...
class ComponentInterface(jneqsim.thermo.ThermodynamicConstantsInterface, java.lang.Cloneable):
    ...
    def getCostaldCharacteristicVolume(self) -> float: ...
    ...
    def getEpsikSAFTVRMie(self) -> float: ...
    ...
    def getK(self) -> float: ...
    def getLambdaASAFTVRMie(self) -> float: ...
    def getLambdaRSAFTVRMie(self) -> float: ...
    ...
    def getSigmaSAFTVRMie(self) -> float: ...
    ...
    def setAssociationEnergySAFTVRMie(self, double: float) -> None: ...
    ...
    def setAssociationVolumeSAFTVRMie(self, double: float) -> None: ...
    ...
    def setCostaldCharacteristicVolume(self, double: float) -> None: ...
    ...
    def setDebyeDipoleMoment(self, double: float) -> None: ...
    def setEpsikSAFT(self, double: float) -> None: ...
    def setEpsikSAFTVRMie(self, double: float) -> None: ...
    ...
    def setLambdaASAFTVRMie(self, double: float) -> None: ...
    def setLambdaRSAFTVRMie(self, double: float) -> None: ...
    ...
    def setSigmaSAFTVRMie(self, double: float) -> None: ...
    ...
    def setmSAFTVRMie(self, double: float) -> None: ...
...
class ComponentNameResolver:
    @staticmethod
    def deinvertCasIndexName(string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @staticmethod
    def getCanonicalNames() -> java.util.Map[java.lang.String, java.lang.String]: ...
    @staticmethod
    def getSynonyms() -> java.util.Map[java.lang.String, java.lang.String]: ...
    @staticmethod
    def isKnownName(string: typing.Union[java.lang.String, str]) -> bool: ...
    @staticmethod
    def normalize(string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @staticmethod
    def resolve(string: typing.Union[java.lang.String, str]) -> java.lang.String: ...

class IapwsHenryLaw:
    DATASET_ID: typing.ClassVar[java.lang.String] = ...
    WATER_MOLAR_MASS_KG_PER_MOL: typing.ClassVar[float] = ...
    @staticmethod
    def assess(string: typing.Union[java.lang.String, str], double: float) -> 'IapwsHenryLaw.Assessment': ...
    @staticmethod
    def getHenryCoefficientBar(string: typing.Union[java.lang.String, str], double: float) -> float: ...
    @staticmethod
    def getHenryCoefficientBarAllowExtrapolation(string: typing.Union[java.lang.String, str], double: float) -> float: ...
    @staticmethod
    def getLnHenryCoefficientTemperatureDerivative(string: typing.Union[java.lang.String, str], double: float) -> float: ...
    @staticmethod
    def isEquationDefined(string: typing.Union[java.lang.String, str], double: float) -> bool: ...
    @staticmethod
    def isSupportedSpecies(string: typing.Union[java.lang.String, str]) -> bool: ...
    @staticmethod
    def isUsable(string: typing.Union[java.lang.String, str], double: float) -> bool: ...
    class Assessment:
        def formatDiagnostic(self) -> java.lang.String: ...
        def getCanonicalGasName(self) -> java.lang.String: ...
        def getCoefficientA(self) -> float: ...
        def getCoefficientB(self) -> float: ...
        def getCoefficientC(self) -> float: ...
        def getDatasetId(self) -> java.lang.String: ...
        def getMaximumFittedTemperature(self) -> float: ...
        def getMinimumFittedTemperature(self) -> float: ...
        def getRmsLogHenryResidual(self) -> float: ...
        def getStatus(self) -> 'IapwsHenryLaw.Status': ...
        def getTemperature(self) -> float: ...
        def isSupportedSpecies(self) -> bool: ...
        def isUsable(self) -> bool: ...
    class Status(java.lang.Enum['IapwsHenryLaw.Status']):
        WITHIN_FITTED_RANGE: typing.ClassVar['IapwsHenryLaw.Status'] = ...
        GUIDELINE_EXTRAPOLATION: typing.ClassVar['IapwsHenryLaw.Status'] = ...
        UNSUPPORTED_SPECIES: typing.ClassVar['IapwsHenryLaw.Status'] = ...
        OUTSIDE_CORRELATION_DOMAIN: typing.ClassVar['IapwsHenryLaw.Status'] = ...
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'IapwsHenryLaw.Status': ...
        @staticmethod
        def values() -> typing.MutableSequence['IapwsHenryLaw.Status']: ...
...
class Component(ComponentInterface):
    ...
    def getMatiascopemanParamsUMRCPA(self) -> typing.MutableSequence[float]: ...
...
class ComponentEos(Component, ComponentEosInterface):
    ...
    def getChemicalPotential(self, double: float, double2: float) -> float: ...
    def getDeltaEosParameters(self) -> typing.MutableSequence[float]: ...
    def getOmegaAOverride(self) -> float: ...
    def getSurfaceTenisionInfluenceParameter(self, double: float) -> float: ...
    def geta(self) -> float: ...
    def getaDiffDiffT(self) -> float: ...
    def getaDiffT(self) -> float: ...
    ...
    def hasOmegaAOverride(self) -> bool: ...
    def init(self, double: float, double2: float, double3: float, double4: float, int: int) -> None: ...
    def logfugcoefdN(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> typing.MutableSequence[float]: ...
    def logfugcoefdNi(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int) -> float: ...
    def logfugcoefdP(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    ...
    def setAttractiveTerm(self, int: int) -> None: ...
    def setBder(self, double: float) -> None: ...
    def setOmegaA(self, double: float) -> None: ...
    def seta(self, double: float) -> None: ...
    def setb(self, double: float) -> None: ...
    def setdAdT(self, double: float) -> None: ...
    def setdAdTdT(self, double: float) -> None: ...
...
class ComponentGEVanLaarAcid(ComponentGE):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def fugcoef(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def getGamma(self) -> float: ...
...
class ComponentGePitzer(ComponentGE):
    ...
    def getMolality(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    def isHydrocarbon(self) -> bool: ...
    def setNeutralPitzerInteractionsActive(self, boolean: bool) -> None: ...
...
class ComponentPR(ComponentEos):
    ...
    def getCachadinaInfluenceParameters(self) -> typing.MutableSequence[float]: ...
    def getInfluenceParameterModel(self) -> int: ...
    def getQpure(self, double: float) -> float: ...
    def getSurfaceTenisionInfluenceParameter(self, double: float) -> float: ...
    def getVolumeCorrection(self) -> float: ...
    def getdQpuredT(self, double: float) -> float: ...
    def getdQpuredTdT(self, double: float) -> float: ...
    def setCachadinaInfluenceParameters(self, double: float, double2: float, double3: float) -> None: ...
    def setInfluenceParameterModel(self, int: int) -> None: ...
...
class ComponentSolidHelmholtzEos(ComponentEos):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def Finit(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    def calca(self) -> float: ...
    def calcb(self) -> float: ...
...
class ComponentGEUnifac(ComponentGEUniquac):
    ...
    def initPCUNIFACGroups(self) -> None: ...
...
class ComponentSAFTVRMie(ComponentSrk):
    ...
    def Finit(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    @staticmethod
    def calcEffectiveDiameter(double: float, double2: float, double3: float, double4: float, double5: float) -> float: ...
    def calcF1dispI1dn(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcF1dispSumTermdn(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcF2dispSumTermdn(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcF2dispZHCdn(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    @staticmethod
    def calcMiePrefactor(double: float, double2: float) -> float: ...
    def calcdF1dispVolTermdn(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdahsSAFTdi(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdghsSAFTdi(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdmSAFTdi(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def calcdnSAFTdi(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def clone(self) -> 'ComponentSAFTVRMie': ...
    def dFCPAdN(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dF_DISP_SAFTdN(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dF_HC_SAFTdN(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdN(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdN(self, int: int, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int2: int, double: float, double2: float) -> float: ...
    def dFdNdT(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def dFdNdV(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, double: float, double2: float) -> float: ...
    def getDdSAFTidT(self) -> float: ...
    def getDmSAFTdi(self) -> float: ...
    def getDnSAFTdi(self) -> float: ...
    def getEpsikSAFT(self) -> float: ...
    def getNAssocSites(self) -> int: ...
    def getSigmaSAFTi(self) -> float: ...
    def getXsiteAssoc(self) -> typing.MutableSequence[float]: ...
    def getdSAFTi(self) -> float: ...
    def getmSAFTi(self) -> float: ...
    def init(self, double: float, double2: float, double3: float, double4: float, int: int) -> None: ...
    def initAssociationArrays(self, int: int) -> None: ...
    def recalcSAFTDiameter(self, double: float) -> None: ...
    def setXsiteAssoc(self, int: int, double: float) -> None: ...
...
class ComponentCoutinhoWax(ComponentSolid):
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def calcLambdaIJ(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int, int2: int) -> float: ...
    def calcLnGammaUNIQUAC(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    def calcSublimationEnthalpy(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int) -> float: ...
    @typing.overload
    def fugcoef(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def fugcoef(self, double: float, double2: float) -> float: ...
...
class ComponentUMRCPAvolcor(ComponentUMRCPA):
    Cij: typing.MutableSequence[float] = ...
    Ci: float = ...
    @typing.overload
    def __init__(self, int: int, double: float, double2: float, double3: float, double4: float, double5: float): ...
...
class ComponentElectrolyteCPAAdvanced(ComponentElectrolyteCPAstatoil):
    @typing.overload
    def __init__(self, int: int, double: float, double2: float, double3: float, double4: float, double5: float): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], double: float, double2: float, int: int): ...
    def Finit(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, double: float, double2: float, double3: float, double4: float, int: int, int2: int) -> None: ...
    def clone(self) -> 'ComponentElectrolyteCPAAdvanced': ...
...
class __module_protocol__(Protocol):
    ...
    ComponentCoutinhoWax: typing.Type[ComponentCoutinhoWax]
    ...
    ComponentElectrolyteCPAAdvanced: typing.Type[ComponentElectrolyteCPAAdvanced]
    ...
    ComponentGEVanLaarAcid: typing.Type[ComponentGEVanLaarAcid]
    ...
    ComponentNameResolver: typing.Type[ComponentNameResolver]
    ...
    ComponentSAFTVRMie: typing.Type[ComponentSAFTVRMie]
    ComponentSolid: typing.Type[ComponentSolid]
    ComponentSolidHelmholtzEos: typing.Type[ComponentSolidHelmholtzEos]
    ...
    ComponentUMRCPAvolcor: typing.Type[ComponentUMRCPAvolcor]
    ...
    IapwsHenryLaw: typing.Type[IapwsHenryLaw]
