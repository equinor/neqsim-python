...
class EosGeFlashModel:
    def constrainGammaPhiKValue(self, componentInterface: jneqsim.thermo.component.ComponentInterface, double: float) -> float: ...
    def finishGammaPhiFlash(self, double: float, double2: float) -> bool: ...
    def getGammaPhiFlashDiagnostics(self, double: float, double2: float) -> java.lang.String: ...
    def getGammaPhiVapourFugacityCoefficient(self, componentInterface: jneqsim.thermo.component.ComponentInterface, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    def prepareGammaPhiFlash(self) -> None: ...
    def relaxGammaPhiKValue(self, double: float, double2: float) -> float: ...
    def requiresDirectGammaPhiFlash(self) -> bool: ...

class FluidBuilder(java.io.Serializable):
    @staticmethod
    def acidGas(double: float, double2: float) -> 'SystemInterface': ...
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float) -> 'FluidBuilder': ...
    def addPlusFraction(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'FluidBuilder': ...
    def addTBPFraction(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> 'FluidBuilder': ...
    def build(self) -> 'SystemInterface': ...
    @staticmethod
    def co2Rich(double: float, double2: float) -> 'SystemInterface': ...
    @staticmethod
    def create(double: float, double2: float) -> 'FluidBuilder': ...
    @staticmethod
    def dryExportGas(double: float, double2: float) -> 'SystemInterface': ...
    @staticmethod
    def gasCondensate(double: float, double2: float) -> 'SystemInterface': ...
    @staticmethod
    def leanNaturalGas(double: float, double2: float) -> 'SystemInterface': ...
    @staticmethod
    def richNaturalGas(double: float, double2: float) -> 'SystemInterface': ...
    @staticmethod
    def typicalBlackOil(double: float, double2: float) -> 'SystemInterface': ...
    def withEOS(self, eOSType: 'FluidBuilder.EOSType') -> 'FluidBuilder': ...
    def withLumpedComponents(self, int: int) -> 'FluidBuilder': ...
    @typing.overload
    def withMixingRule(self, int: int) -> 'FluidBuilder': ...
    @typing.overload
    def withMixingRule(self, string: typing.Union[java.lang.String, str]) -> 'FluidBuilder': ...
    def withMultiPhaseCheck(self) -> 'FluidBuilder': ...
    def withSolidPhaseCheck(self) -> 'FluidBuilder': ...
    class EOSType(java.lang.Enum['FluidBuilder.EOSType']):
        SRK: typing.ClassVar['FluidBuilder.EOSType'] = ...
        PR: typing.ClassVar['FluidBuilder.EOSType'] = ...
        SRK_CPA: typing.ClassVar['FluidBuilder.EOSType'] = ...
        PR_CPA: typing.ClassVar['FluidBuilder.EOSType'] = ...
        ELECTROLYTE_CPA: typing.ClassVar['FluidBuilder.EOSType'] = ...
        GERG2008: typing.ClassVar['FluidBuilder.EOSType'] = ...
        SRK_PENELOUX: typing.ClassVar['FluidBuilder.EOSType'] = ...
        PR_1978: typing.ClassVar['FluidBuilder.EOSType'] = ...
        PR_LK: typing.ClassVar['FluidBuilder.EOSType'] = ...
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'FluidBuilder.EOSType': ...
        @staticmethod
        def values() -> typing.MutableSequence['FluidBuilder.EOSType']: ...
...
class SystemInterface(java.lang.Cloneable, java.io.Serializable):
    ...
    @typing.overload
    def addComponent(self, componentInterface: jneqsim.thermo.component.ComponentInterface) -> None: ...
    @typing.overload
    ...
    def addTBPfraction_Mw_Sg(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> None: ...
    def addTBPfraction_Mw_Sg_Crit(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> None: ...
    def addTBPfraction_Mw_Sg_Tb(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float) -> None: ...
    @typing.overload
    def addTBPfraction_Mw_Tb(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> None: ...
    @typing.overload
    def addTBPfraction_Mw_Tb(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, tbpClosure: jneqsim.thermo.characterization.TbpClosure) -> None: ...
    @typing.overload
    def addTBPfraction_Sg_Tb(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> None: ...
    @typing.overload
    def addTBPfraction_Sg_Tb(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, tbpClosure: jneqsim.thermo.characterization.TbpClosure) -> None: ...
    @typing.overload
    def addTBPfraction_Tb_Kw(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> None: ...
    @typing.overload
    def addTBPfraction_Tb_Kw(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, tbpClosure: jneqsim.thermo.characterization.TbpClosure) -> None: ...
    @typing.overload
    def addTBPfraction_Tb_Pna(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float, double5: float) -> None: ...
    @typing.overload
    def addTBPfraction_Tb_Pna(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float, tbpClosure: jneqsim.thermo.characterization.TbpClosure) -> None: ...
    ...
    @typing.overload
    def calcHenrysConstant(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> float: ...
    ...
    def calculateDensityFromBoilingPointAndWatsonK(self, double: float, double2: float) -> float: ...
    def calculateMolarMassFromDensityAndBoilingPoint(self, double: float, double2: float) -> float: ...
    @typing.overload
    def calculateWatsonKFromPna(self, double: float, double2: float, double3: float) -> float: ...
    @typing.overload
    def calculateWatsonKFromPna(self, double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> float: ...
    ...
    def doEnhancedMultiPhaseCheck(self) -> bool: ...
    ...
    def getChemicalReactionConcentrationBasis(self) -> jneqsim.chemicalreactions.chemicalreaction.ChemicalReactionConcentrationBasis: ...
    def getChemicalReactionDataSource(self) -> jneqsim.chemicalreactions.chemicalreaction.ChemicalReactionDataSource: ...
    def getChemicalReactionOperations(self) -> jneqsim.chemicalreactions.ChemicalReactionOperations: ...
    ...
    def getDensityAtReferenceConditions(self, double: float, string: typing.Union[java.lang.String, str], double2: float, string2: typing.Union[java.lang.String, str]) -> float: ...
    ...
    def getHydrateFraction(self) -> float: ...
    def getHydratePhase(self) -> jneqsim.thermo.phase.PhaseInterface: ...
    ...
    def getInterphaseProperties(self) -> jneqsim.physicalproperties.interfaceproperties.InterphasePropertiesInterface: ...
    @typing.overload
    ...
    def getOilAssayCharacterisation(self) -> jneqsim.thermo.characterization.OilAssayCharacterisation: ...
    ...
    @typing.overload
    def getPhase(self, string: typing.Union[java.lang.String, str]) -> jneqsim.thermo.phase.PhaseInterface: ...
    @typing.overload
    def getPhase(self, phaseType: jneqsim.thermo.phase.PhaseType) -> jneqsim.thermo.phase.PhaseInterface: ...
    ...
    @typing.overload
    def getPhaseIndex(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> int: ...
    @typing.overload
    def getPhaseNumberOfPhase(self, phaseType: jneqsim.thermo.phase.PhaseType) -> int: ...
    @typing.overload
    def getPhaseNumberOfPhase(self, string: typing.Union[java.lang.String, str]) -> int: ...
    def getPhaseOfType(self, string: typing.Union[java.lang.String, str]) -> jneqsim.thermo.phase.PhaseInterface: ...
    def getPhases(self) -> typing.MutableSequence[jneqsim.thermo.phase.PhaseInterface]: ...
    @typing.overload
    ...
    @typing.overload
    def getStandard(self, string: typing.Union[java.lang.String, str]) -> jneqsim.standards.StandardInterface: ...
    ...
    def getWaxCharacterisation(self) -> jneqsim.thermo.characterization.WaxCharacterise: ...
    ...
    @typing.overload
    def phaseToSystem(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> 'SystemInterface': ...
    ...
    def replacePhase(self, int: int, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> None: ...
    def reset(self) -> None: ...
    ...
    @typing.overload
    def setBinaryInteractionParameter(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float) -> None: ...
    def setBmixType(self, int: int) -> None: ...
    @typing.overload
    def setComponentCriticalParameters(self, int: int, double: float, double2: float, double3: float) -> None: ...
    @typing.overload
    def setComponentCriticalParameters(self, string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float) -> None: ...
    ...
    @typing.overload
    def setComponentVolumeCorrection(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    def setEmptyFluid(self) -> None: ...
    def setEnhancedMultiPhaseCheck(self, boolean: bool) -> None: ...
    ...
    @typing.overload
    def setForceSinglePhase(self, phaseType: jneqsim.thermo.phase.PhaseType) -> None: ...
    ...
    @typing.overload
    def setLiquidDensityModel(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setLiquidDensityModel(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    ...
    def setPhase(self, phaseInterface: jneqsim.thermo.phase.PhaseInterface, int: int) -> None: ...
    def setPhaseIndex(self, int: int, int2: int) -> None: ...
    @typing.overload
    def setPhaseType(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setPhaseType(self, int: int, phaseType: jneqsim.thermo.phase.PhaseType) -> None: ...
    @typing.overload
    ...
    def setWaxModelType(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class HybridEosGeFlashModel(EosGeFlashModel):
    def enableHybridEosGeFlash(self) -> None: ...
    def finishHybridEosGeFlash(self, double: float) -> bool: ...
    def getHybridEosGeFlashDiagnostics(self, double: float) -> java.lang.String: ...
    def isHybridEosGeAqueousPhase(self, int: int) -> bool: ...
    def isHybridEosGeTopologyConfigured(self) -> bool: ...
    def prepareHybridEosGeFlash(self) -> None: ...
    def requiresHybridEosGeFlash(self) -> bool: ...
    def restoreHybridEosGeActivePhaseTypes(self) -> None: ...
    def restoreHybridEosGePhaseRoles(self) -> None: ...
    def synchronizeHybridEosGeOverallComposition(self, doubleArray: typing.Union[typing.List[float], jpype.JArray], double2: float) -> None: ...
...
class SystemThermo(SystemInterface):
    ...
    def setUseTVasIndependentVariables(self, boolean: bool) -> None: ...
    def setWaxModelType(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def synchronizeSinglePhaseReactionComposition(self, componentInterfaceArray: typing.Union[typing.List[jneqsim.thermo.component.ComponentInterface], jpype.JArray]) -> None: ...
    def toCompJson(self) -> java.lang.String: ...
    def toJson(self) -> java.lang.String: ...
    def tuneModel(self, string: typing.Union[java.lang.String, str], double: float, int: int) -> None: ...
...
class SystemEosGE(SystemEos, HybridEosGeFlashModel):
    def enableHybridEosGeFlash(self) -> None: ...
    def finishHybridEosGeFlash(self, double: float) -> bool: ...
    def getEosGasPhaseSlot(self) -> int: ...
    def getEosOilPhase(self) -> jneqsim.thermo.phase.PhaseInterface: ...
    def getEosOilPhaseSlot(self) -> int: ...
    def getEquationOfStatePhase(self) -> jneqsim.thermo.phase.PhaseInterface: ...
    def getGeLiquidPhase(self) -> jneqsim.thermo.phase.PhaseInterface: ...
    def getGeLiquidPhaseSlot(self) -> int: ...
    def getHybridEosGeFlashDiagnostics(self, double: float) -> java.lang.String: ...
    def isExcessGibbsEnergyPhase(self, int: int) -> bool: ...
    def isHybridEosGeAqueousPhase(self, int: int) -> bool: ...
    def isHybridEosGeTopologyConfigured(self) -> bool: ...
    def prepareGammaPhiFlash(self) -> None: ...
    def prepareHybridEosGeFlash(self) -> None: ...
...
class SystemGERG2008Eos(SystemEos):
    ...
    @typing.overload
    def init(self, int: int, int2: int) -> None: ...
    def isUsingAmmoniaExtendedModel(self) -> bool: ...
    def isUsingHydrogenEnhancedModel(self) -> bool: ...
    def setGergModelType(self, gERG2008Type: jneqsim.thermo.util.gerg.GERG2008Type) -> None: ...
    def useAmmoniaExtendedModel(self) -> None: ...
    def useHydrogenEnhancedModel(self) -> None: ...
...
class SystemSolidHelmholtzEos(SystemEos):
    def __init__(self, double: float, double2: float, string: typing.Union[java.lang.String, str], solidHelmholtzEquation: typing.Union[jneqsim.thermo.util.solid.SolidHelmholtzEquation, typing.Callable]): ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float, string2: typing.Union[java.lang.String, str], int: int) -> None: ...
    def clone(self) -> 'SystemSolidHelmholtzEos': ...
...
class SystemArgonSolidHelmholtzEos(SystemSolidHelmholtzEos):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    def clone(self) -> 'SystemArgonSolidHelmholtzEos': ...
    def getArgonSolidEquation(self) -> jneqsim.thermo.util.solid.ArgonSolidHelmholtzEquation: ...
...
class SystemDesmukhMather(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemGEWilson(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemKentEisenberg(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemPitzer(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def applyCompletePhreeqcPitzerCatalogParameters(self) -> None: ...
    def applyPhreeqcCalciumMagnesiumChlorideSulfateParameters(self) -> None: ...
    def applyPhreeqcCo2SodiumSulfateParameters(self) -> None: ...
    def applyPhreeqcSodiumPotassiumChlorideParameters(self) -> None: ...
    def clone(self) -> 'SystemPitzer': ...
    def getChemicalReactionConcentrationBasis(self) -> jneqsim.chemicalreactions.chemicalreaction.ChemicalReactionConcentrationBasis: ...
    def getChemicalReactionDataSource(self) -> jneqsim.chemicalreactions.chemicalreaction.ChemicalReactionDataSource: ...
    def getPitzerParameterQualification(self) -> jneqsim.thermo.phase.PitzerParameterQualification: ...
    def isUsingPhreeqcPitzerParametersByDefault(self) -> bool: ...
    def refreshDefaultPitzerParameterSelection(self) -> bool: ...
    def requireCompletePitzerDatasetQualification(self) -> jneqsim.thermo.phase.PitzerParameterQualification: ...
    def requirePitzerDatasetValidationFor(self, validationTarget: jneqsim.thermo.phase.PitzerParameterQualification.ValidationTarget) -> jneqsim.thermo.phase.PitzerParameterQualification: ...
    @typing.overload
    def setMixingRule(self, int: int) -> None: ...
    @typing.overload
    def setMixingRule(self, mixingRuleTypeInterface: typing.Union[jneqsim.thermo.mixingrule.MixingRuleTypeInterface, typing.Callable]) -> None: ...
    ...
    @typing.overload
    def setMixingRule(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    def useLegacyPitzerParameters(self) -> None: ...
...
class SystemPrLeeKeslerEos(SystemPrEos):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemSAFTVRMie(SystemSrkEos):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemUNIFAC(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemUNIFACpsrk(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemVanLaarActivitySRK(SystemEosGE):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    ...
    def __init__(self, double: float, double2: float, boolean: bool): ...
    @staticmethod
    def acidSolubilityInCarbonDioxidePpm(string: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float) -> float: ...
    @staticmethod
    def acidWaterMassFraction(phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def addComponent(self, int: int, double: float) -> None: ...
    ...
    @typing.overload
    def addComponent(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    def carbonDioxideCarrierFugacityCoefficient(self, string: typing.Union[java.lang.String, str]) -> float: ...
    @staticmethod
    def carbonDioxideNitricAcidKij(double: float, double2: float) -> float: ...
    @staticmethod
    def carbonDioxideNitricAcidKijFromDensity(double: float) -> float: ...
    @staticmethod
    def carbonDioxideSulfuricAcidKij(double: float) -> float: ...
    def clone(self) -> 'SystemVanLaarActivitySRK': ...
    @staticmethod
    def componentSolubilityInCarbonDioxidePpm(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float) -> float: ...
    def constrainGammaPhiKValue(self, componentInterface: jneqsim.thermo.component.ComponentInterface, double: float) -> float: ...
    def finishGammaPhiFlash(self, double: float, double2: float) -> bool: ...
    def getGammaPhiFlashDiagnostics(self, double: float, double2: float) -> java.lang.String: ...
    def getGammaPhiVapourFugacityCoefficient(self, componentInterface: jneqsim.thermo.component.ComponentInterface, phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> float: ...
    ...
    def init(self, int: int, int2: int) -> None: ...
    @staticmethod
    def isPredominantlyAcidWaterPhase(phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> bool: ...
    @staticmethod
    def isPredominantlyCarbonDioxidePhase(phaseInterface: jneqsim.thermo.phase.PhaseInterface) -> bool: ...
    @staticmethod
    def isVanLaarActivityComponent(string: typing.Union[java.lang.String, str]) -> bool: ...
    @staticmethod
    def pureCarbonDioxideDensityKgM3(double: float, double2: float) -> float: ...
    def relaxGammaPhiKValue(self, double: float, double2: float) -> float: ...
    def requiresDirectGammaPhiFlash(self) -> bool: ...
...
class SystemElectrolyteCPAAdvanced(SystemFurstElectrolyteEos):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    def clone(self) -> 'SystemElectrolyteCPAAdvanced': ...

class SystemElectrolyteCPAMM(SystemSrkCPA):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def clone(self) -> 'SystemElectrolyteCPAMM': ...
    def getDebyeLength(self, int: int) -> float: ...
    def getMixturePermittivity(self, int: int) -> float: ...
    def getSolventPermittivity(self, int: int) -> float: ...
    @typing.overload
    def initHuronVidalIonParameters(self) -> None: ...
    @typing.overload
    def initHuronVidalIonParameters(self, double: float) -> None: ...
    def setBornOn(self, boolean: bool) -> None: ...
    def setDebyeHuckelOn(self, boolean: bool) -> None: ...
    @typing.overload
    def setDielectricMixingRule(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setDielectricMixingRule(self, dielectricMixingRule: jneqsim.thermo.phase.PhaseElectrolyteCPAMM.DielectricMixingRule) -> None: ...
...
class SystemSoreideWhitson(SystemPrEos1978):
    ...
    @typing.overload
    def setAqueousCO2Parameterization(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setSoreideWhitsonParameterization(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
...
class SystemUMRCPAvolcor(SystemUMRCPAEoS):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemSrkCPAstatoilAndersonMixing(SystemSrkCPAstatoil):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
...
class SystemSrkCPAstatoilAndersonReduced(SystemSrkCPAstatoil):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def clone(self) -> 'SystemSrkCPAstatoilAndersonReduced': ...

class SystemSrkCPAstatoilBroydenImplicit(SystemSrkCPAstatoil):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def clone(self) -> 'SystemSrkCPAstatoilBroydenImplicit': ...

class SystemSrkCPAstatoilFullyImplicit(SystemSrkCPAstatoil):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def clone(self) -> 'SystemSrkCPAstatoilFullyImplicit': ...

class SystemSrkCPAstatoilFullyImplicitReduced(SystemSrkCPAstatoil):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def clone(self) -> 'SystemSrkCPAstatoilFullyImplicitReduced': ...

class SystemSrkCPAstatoilReduced(SystemSrkCPAstatoil):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, double: float, double2: float): ...
    @typing.overload
    def __init__(self, double: float, double2: float, boolean: bool): ...
    def clone(self) -> 'SystemSrkCPAstatoilReduced': ...


class __module_protocol__(Protocol):
    # A module protocol which reflects the result of ``jp.JPackage("jneqsim.thermo.system")``.

    EosGeFlashModel: typing.Type[EosGeFlashModel]
    FluidBuilder: typing.Type[FluidBuilder]
    HybridEosGeFlashModel: typing.Type[HybridEosGeFlashModel]
    ...
    SystemPrLeeKeslerEos: typing.Type[SystemPrLeeKeslerEos]
    ...
    SystemSAFTVRMie: typing.Type[SystemSAFTVRMie]
    SystemSolidHelmholtzEos: typing.Type[SystemSolidHelmholtzEos]
    ...
    SystemSrkCPAstatoilAndersonMixing: typing.Type[SystemSrkCPAstatoilAndersonMixing]
    SystemSrkCPAstatoilAndersonReduced: typing.Type[SystemSrkCPAstatoilAndersonReduced]
    SystemSrkCPAstatoilBroydenImplicit: typing.Type[SystemSrkCPAstatoilBroydenImplicit]
    SystemSrkCPAstatoilFullyImplicit: typing.Type[SystemSrkCPAstatoilFullyImplicit]
    SystemSrkCPAstatoilFullyImplicitReduced: typing.Type[SystemSrkCPAstatoilFullyImplicitReduced]
    SystemSrkCPAstatoilReduced: typing.Type[SystemSrkCPAstatoilReduced]
    ...
    SystemUMRCPAvolcor: typing.Type[SystemUMRCPAvolcor]
    ...
    SystemVanLaarActivitySRK: typing.Type[SystemVanLaarActivitySRK]
