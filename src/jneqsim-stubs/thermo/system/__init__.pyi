...
class SystemInterface(java.lang.Cloneable, java.io.Serializable):
    ...
    def getDensityAtReferenceConditions(
        self,
        double: float,
        string: typing.Union[java.lang.String, str],
        double2: float,
...
class SystemElectrolyteCPAMM(SystemSrkCPA):
    ...
    def setDielectricMixingRule(
        self,
        dielectricMixingRule: jneqsim.thermo.phase.PhaseElectrolyteCPAMM.DielectricMixingRule,
    ) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    SystemSrkCPAstatoilFullyImplicitReduced: typing.Type[
