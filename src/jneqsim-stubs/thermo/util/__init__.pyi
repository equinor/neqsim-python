...
import jneqsim.thermo.util.amines
...
import jneqsim.thermo.util.hydrogen
...
class ProducedWaterFluidBuilder:
    @staticmethod
    def addGasToWater(systemInterface: jneqsim.thermo.system.SystemInterface, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]], double: float) -> jneqsim.thermo.system.SystemInterface: ...
    @staticmethod
    def createFromIons(double: float, double2: float, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> jneqsim.thermo.system.SystemInterface: ...
    @staticmethod
    def createFromTDS(double: float, double2: float, double3: float, double4: float) -> jneqsim.thermo.system.SystemInterface: ...
    @staticmethod
    def createFromType(double: float, double2: float, string: typing.Union[java.lang.String, str]) -> jneqsim.thermo.system.SystemInterface: ...
...
class __module_protocol__(Protocol):
    ...
    ProducedWaterFluidBuilder: typing.Type[ProducedWaterFluidBuilder]
    ReservoirFluidType: typing.Type[ReservoirFluidType]
    Vega: jneqsim.thermo.util.Vega.__module_protocol__
    amines: jneqsim.thermo.util.amines.__module_protocol__
    ...
    hydrogen: jneqsim.thermo.util.hydrogen.__module_protocol__
