...
class ParaOrthoH2Correction(java.io.Serializable):
    ...
    @staticmethod
    def getConversionHeatJPerKg(double: float, double2: float, double3: float) -> float: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def getThermalConductivityCorrectionFactor(double: float, double2: float) -> float: ...
    class ConversionCatalyst(java.lang.Enum['ParaOrthoH2Correction.ConversionCatalyst']):
        NONE: typing.ClassVar['ParaOrthoH2Correction.ConversionCatalyst'] = ...
        ACTIVATED_CHARCOAL: typing.ClassVar['ParaOrthoH2Correction.ConversionCatalyst'] = ...
        HYDROUS_FERRIC_OXIDE: typing.ClassVar['ParaOrthoH2Correction.ConversionCatalyst'] = ...
        PARAMAGNETIC_OXIDE: typing.ClassVar['ParaOrthoH2Correction.ConversionCatalyst'] = ...
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ParaOrthoH2Correction.ConversionCatalyst': ...
        @staticmethod
        def values() -> typing.MutableSequence['ParaOrthoH2Correction.ConversionCatalyst']: ...
