...
class NeqSimSpanWagner:
    @staticmethod
    def getProperties(double: float, double2: float, phaseType: jneqsim.thermo.phase.PhaseType) -> typing.MutableSequence[float]: ...
    @staticmethod
    def getSaturationPressure(double: float) -> float: ...
