...
class PhaseInterface(
    ...
    def calcA(
        self, phaseInterface: "PhaseInterface", double: float, double2: float, int: int
    ) -> float: ...
    def calcAT(
        self,
        int: int,
    ...
    @typing.overload
    def getAlpha0_Leachman(
        self, string: typing.Union[java.lang.String, str]
    ) -> typing.MutableSequence[org.netlib.util.doubleW]: ...
    ...
    def getComponentWithIndex(
        self, int: int
    ) -> jneqsim.thermo.component.ComponentInterface: ...
    def getComponents(
        self,
    ) -> typing.MutableSequence[jneqsim.thermo.component.ComponentInterface]: ...
    def getComposition(
        self, string: typing.Union[java.lang.String, str]
    ...
    def getMixingRuleType(
        self,
    ) -> jneqsim.thermo.mixingrule.MixingRuleTypeInterface: ...
    ...
    def getPhysicalPropertyModel(
        self,
    ) -> jneqsim.physicalproperties.system.PhysicalPropertyModel: ...
    @typing.overload
    ...
    @typing.overload
    def init(
        self, double: float, int: int, int2: int, phaseType: "PhaseType", double2: float
    ) -> None: ...
    @typing.overload
    def init(self) -> None: ...
    @typing.overload
    ...
    def setRefPhase(
        self,
        phaseInterfaceArray: typing.Union[typing.List["PhaseInterface"], jpype.JArray],
    ) -> None: ...
...
class Phase(PhaseInterface):
    ...
    componentArray: typing.MutableSequence[
        jneqsim.thermo.component.ComponentInterface
    ] = ...
...
class PhaseHydrate(Phase):
    ...
    def getCavityOccupancy(
        self, string: typing.Union[java.lang.String, str], int: int, int2: int
    ) -> float: ...
    def getCpres(self) -> float: ...
    def getCvres(self) -> float: ...
    @typing.overload
...
class PhaseGERG2008Eos(PhaseEos):
    ...
    def setGergModelType(
        self, gERG2008Type: jneqsim.thermo.util.gerg.GERG2008Type
    ) -> None: ...
...
class PhaseBNS(PhasePrEos):
    def __init__(
        ...
        doubleArray7: typing.Union[typing.List[float], jpype.JArray],
    ): ...
    @typing.overload
    def addComponent(
        self, string: typing.Union[java.lang.String, str], double: float, int: int
...
class PhaseModifiedFurstElectrolyteEos(PhaseSrkEos):
    ...
    def getElectrolyteMixingRule(
        self,
    ) -> jneqsim.thermo.mixingrule.ElectrolyteMixingRulesInterface: ...
    ...
    def setDielectricMixingRule(
        self,
        dielectricMixingRule: "PhaseModifiedFurstElectrolyteEos.DielectricMixingRule",
    ) -> None: ...
    def setFurstIonicCoefficient(
        self, doubleArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> None: ...
    def volInit(self) -> None: ...

    class DielectricMixingRule(
        java.lang.Enum["PhaseModifiedFurstElectrolyteEos.DielectricMixingRule"]
    ):
        MOLAR_AVERAGE: typing.ClassVar[
            "PhaseModifiedFurstElectrolyteEos.DielectricMixingRule"
        ] = ...
        VOLUME_AVERAGE: typing.ClassVar[
            "PhaseModifiedFurstElectrolyteEos.DielectricMixingRule"
        ] = ...
        LOOYENGA: typing.ClassVar[
            "PhaseModifiedFurstElectrolyteEos.DielectricMixingRule"
        ] = ...
        _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
        @typing.overload
...
class PhasePCSAFT(PhaseSrkEos):
    ...
    def molarVolume22(
        self, double: float, double2: float, double3: float, double4: float, int: int
    ) -> float: ...
...
class PhasePrEosvolcor(PhasePrEos):
    ...
    def getcijTT(
        self,
        componentPRvolcor: jneqsim.thermo.component.ComponentPRvolcor,
        componentPRvolcor2: jneqsim.thermo.component.ComponentPRvolcor,
    ) -> float: ...
    @typing.overload
    def init(self) -> None: ...
    @typing.overload
...
class PhaseSrkEosvolcor(PhaseSrkEos):
    ...
    def getcijTT(
        self,
        componentSrkvolcor: jneqsim.thermo.component.ComponentSrkvolcor,
        componentSrkvolcor2: jneqsim.thermo.component.ComponentSrkvolcor,
    ) -> float: ...
    @typing.overload
    def init(self) -> None: ...
    @typing.overload
...
class PhaseElectrolyteCPAMM(PhaseSrkCPA):
    ...
    def calcSolventPermittivitydndn(
    ...
    def calcWij(
        self, int: int, int2: int, double: float, double2: float, int3: int
    ) -> float: ...
    ...
    def getDielectricMixingRule(
        self,
    ) -> "PhaseElectrolyteCPAMM.DielectricMixingRule": ...
    def getElectrolyteMixingRule(
        self,
    ) -> jneqsim.thermo.mixingrule.ElectrolyteMixingRulesInterface: ...
    def getF(self) -> float: ...
    ...
    def setDielectricMixingRule(
        self, dielectricMixingRule: "PhaseElectrolyteCPAMM.DielectricMixingRule"
    ) -> None: ...
    ...
    class DielectricMixingRule(
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["PhaseElectrolyteCPAMM.DielectricMixingRule"]
        ): ...
...
class __module_protocol__(Protocol):
    ...
    PhaseModifiedFurstElectrolyteEosMod2004: typing.Type[
