...
class BIPEstimationMethod(java.lang.Enum["BIPEstimationMethod"]):
    CHUEH_PRAUSNITZ: typing.ClassVar["BIPEstimationMethod"] = ...
    KATZ_FIROOZABADI: typing.ClassVar["BIPEstimationMethod"] = ...
    DEFAULT: typing.ClassVar["BIPEstimationMethod"] = ...
    ...
    @staticmethod
    def values() -> typing.MutableSequence["BIPEstimationMethod"]: ...

class BIPEstimator:
    DEFAULT_CHUEH_PRAUSNITZ_EXPONENT: typing.ClassVar[float] = ...
    @typing.overload
    @staticmethod
    def applyEstimatedBIPs(
        systemInterface: jneqsim.thermo.system.SystemInterface,
        bIPEstimationMethod: BIPEstimationMethod,
    ) -> None: ...
    @typing.overload
    @staticmethod
    def applyEstimatedBIPs(
    ...
    @staticmethod
    def applyMethaneC7PlusBIPs(
        systemInterface: jneqsim.thermo.system.SystemInterface,
    ) -> None: ...
    @staticmethod
    def calculateBIPMatrix(
        systemInterface: jneqsim.thermo.system.SystemInterface,
        bIPEstimationMethod: BIPEstimationMethod,
    ) -> typing.MutableSequence[typing.MutableSequence[float]]: ...
    @staticmethod
    def canEstimateMercuryHydrocarbonKij(
    ...
    @staticmethod
    def classifyHydrocarbonType(
        componentInterface: jneqsim.thermo.component.ComponentInterface,
    ) -> "BIPEstimator.MercuryHydrocarbonType": ...
    @staticmethod
    def estimate(
        componentInterface: jneqsim.thermo.component.ComponentInterface,
        componentInterface2: jneqsim.thermo.component.ComponentInterface,
    ...
    @staticmethod
    def estimateKatzFiroozabadi(
        componentInterface: jneqsim.thermo.component.ComponentInterface,
        componentInterface2: jneqsim.thermo.component.ComponentInterface,
    ) -> float: ...
    @staticmethod
    def estimateMercuryHydrocarbonKij(
        componentInterface: jneqsim.thermo.component.ComponentInterface,
        componentInterface2: jneqsim.thermo.component.ComponentInterface,
        boolean: bool,
    ) -> float: ...
    ...
    class MercuryHydrocarbonType(java.lang.Enum["BIPEstimator.MercuryHydrocarbonType"]):
        PARAFFINIC: typing.ClassVar["BIPEstimator.MercuryHydrocarbonType"] = ...
        NAPHTHENIC: typing.ClassVar["BIPEstimator.MercuryHydrocarbonType"] = ...
        AROMATIC: typing.ClassVar["BIPEstimator.MercuryHydrocarbonType"] = ...
        _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
        @typing.overload
        @staticmethod
        def valueOf(
        ...
        @staticmethod
        def values() -> (
            typing.MutableSequence["BIPEstimator.MercuryHydrocarbonType"]
        ): ...

class MixingRuleHandler(
    jneqsim.thermo.ThermodynamicConstantsInterface, java.lang.Cloneable
):
    def __init__(self): ...
...
class EosMixingRuleHandler(MixingRuleHandler):
    ...
    class ElectrolyteMixRule(ElectrolyteMixingRulesInterface):
        ...
        def gettWijT1Parameter(self, int: int, int2: int) -> float: ...
        def gettWijT2Parameter(self, int: int, int2: int) -> float: ...
        def isUsePredictiveModel(self) -> bool: ...
        def setUsePredictiveModel(self, boolean: bool) -> None: ...
        def setWijParameter(self, int: int, int2: int, double: float) -> None: ...
        def setWijT1Parameter(self, int: int, int2: int, double: float) -> None: ...
        def setWijT2Parameter(self, int: int, int2: int, double: float) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    BIPEstimationMethod: typing.Type[BIPEstimationMethod]
    BIPEstimator: typing.Type[BIPEstimator]
