...
class UNIFACgroup(
    jneqsim.thermo.ThermodynamicConstantsInterface, java.lang.Comparable["UNIFACgroup"]
):
    ...
    def calcQComp(
        self, componentGEUnifac: jneqsim.thermo.component.ComponentGEUnifac
    ) -> float: ...
    def calcQMix(self, phaseGEUnifac: jneqsim.thermo.phase.PhaseGEUnifac) -> float: ...
    def calcQMixdN(
        self, phaseGEUnifac: jneqsim.thermo.phase.PhaseGEUnifac
