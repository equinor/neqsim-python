...
class FlowNodeInterface(java.lang.Cloneable):
    ...
    def getFluidBoundary(self) -> jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.FluidBoundaryInterface: ...
    def getGeometry(self) -> jneqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface: ...
    ...
    def getInterphaseTransportCoefficient(self) -> jneqsim.fluidmechanics.flownode.fluidboundary.interphasetransportcoefficient.InterphaseTransportCoefficientInterface: ...
    ...
    def getOperations(self) -> jneqsim.thermodynamicoperations.ThermodynamicOperations: ...
    ...
    def setBulkSystem(self, systemInterface: jneqsim.thermo.system.SystemInterface) -> None: ...
    ...
    def setGeometryDefinitionInterface(self, geometryDefinitionInterface: jneqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface) -> None: ...
    def setInterphaseModelType(self, int: int) -> None: ...
    def setInterphaseSystem(self, systemInterface: jneqsim.thermo.system.SystemInterface) -> None: ...
    ...
    @typing.overload
    def setVelocityIn(self, int: int, doubleCloneable: jneqsim.util.util.DoubleCloneable) -> None: ...
    @typing.overload
    def setVelocityIn(self, double: float) -> None: ...
    @typing.overload
    def setVelocityIn(self, doubleCloneable: jneqsim.util.util.DoubleCloneable) -> None: ...
    @typing.overload
    def setVelocityOut(self, int: int, double: float) -> None: ...
    @typing.overload
    def setVelocityOut(self, int: int, doubleCloneable: jneqsim.util.util.DoubleCloneable) -> None: ...
    @typing.overload
    def setVelocityOut(self, double: float) -> None: ...
    @typing.overload
    def setVelocityOut(self, doubleCloneable: jneqsim.util.util.DoubleCloneable) -> None: ...
...
class FlowPatternDetector:
    @staticmethod
    def calculateLiquidHoldup(flowPattern: FlowPattern, double: float, double2: float, double3: float) -> float: ...
    @staticmethod
    def detectFlowPattern(flowPatternModel: 'FlowPatternModel', double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float, double9: float) -> FlowPattern: ...
...
class HeatTransferCoefficientCalculator:
    @staticmethod
    def calculateCondensationHTC(double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float) -> float: ...
    @staticmethod
    def calculateCondensationNusselt(double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def calculateDittusBoelterNusselt(double: float, double2: float, boolean: bool) -> float: ...
    @staticmethod
    def calculateEvaporationHTC(double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float) -> float: ...
    @staticmethod
    def calculateGasHeatTransferCoefficient(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def calculateGnielinskiNusselt(double: float, double2: float, double3: float) -> float: ...
    @staticmethod
    def calculateLaminarNusselt(boolean: bool) -> float: ...
    @staticmethod
    def calculateLiquidHeatTransferCoefficient(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float) -> float: ...
    @staticmethod
    def calculateOverallInterphaseCoefficient(double: float, double2: float) -> float: ...
    @staticmethod
    def calculateStantonNumber(double: float, double2: float, double3: float, double4: float) -> float: ...

class InterfacialAreaCalculator:
    @staticmethod
    def calculateAnnularArea(double: float, double2: float) -> float: ...
    @staticmethod
    def calculateAnnularAreaWithEntrainment(double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def calculateBubbleArea(double: float, double2: float, double3: float, double4: float, double5: float) -> float: ...
    @staticmethod
    def calculateChurnArea(double: float, double2: float) -> float: ...
    @staticmethod
    def calculateDropletArea(double: float, double2: float, double3: float, double4: float, double5: float) -> float: ...
    @staticmethod
    def calculateEnhancedInterfacialArea(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float, boolean: bool, boolean2: bool) -> float: ...
    @staticmethod
    def calculateInterfacialArea(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def calculateSauterDiameter(double: float, double2: float, double3: float, double4: float) -> float: ...
    @staticmethod
    def calculateSlugArea(double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def calculateStratifiedArea(double: float, double2: float) -> float: ...
    @staticmethod
    def calculateStratifiedWavyArea(double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def getExpectedInterfacialAreaRange(flowPattern: FlowPattern, double: float) -> typing.MutableSequence[float]: ...
...
class InterfacialAreaModel(java.lang.Enum['InterfacialAreaModel']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'InterfacialAreaModel': ...
    @staticmethod
    def values() -> typing.MutableSequence['InterfacialAreaModel']: ...

class MassTransferCoefficientCalculator:
    @staticmethod
    def applyMarangoniCorrection(double: float, double2: float, double3: float, double4: float) -> float: ...
    @staticmethod
    def calculateDittusBoelterSherwood(double: float, double2: float) -> float: ...
    @staticmethod
    def calculateEnhancedLiquidMassTransferCoefficient(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float, double9: float, boolean: bool, boolean2: bool) -> float: ...
    @staticmethod
    def calculateGasMassTransferCoefficient(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float) -> float: ...
    @staticmethod
    def calculateLiquidMassTransferCoefficient(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float) -> float: ...
    @staticmethod
    def calculateLiquidMassTransferCoefficientWithTurbulence(flowPattern: FlowPattern, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float) -> float: ...
    @staticmethod
    def calculateRanzMarshallSherwood(double: float, double2: float) -> float: ...
    @staticmethod
    def estimateTurbulentIntensity(flowPattern: FlowPattern, double: float) -> float: ...
    @staticmethod
    def getExpectedMassTransferCoefficientRange(flowPattern: FlowPattern, int: int) -> typing.MutableSequence[float]: ...
    @staticmethod
    def validateAgainstLiterature(double: float, flowPattern: FlowPattern, int: int) -> bool: ...
...
class WallHeatTransferModel(java.lang.Enum['WallHeatTransferModel']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'WallHeatTransferModel': ...
    @staticmethod
...
class FlowNode(FlowNodeInterface, jneqsim.thermo.ThermodynamicConstantsInterface):
    ...
    @typing.overload
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface, geometryDefinitionInterface: jneqsim.fluidmechanics.geometrydefinitions.GeometryDefinitionInterface, double: float, double2: float): ...
    def calcFluxes(self) -> None: ...
    def calcNusseltNumber(self, double: float, int: int) -> float: ...
    def calcSherwoodNumber(self, double: float, int: int) -> float: ...
    def calcStantonNumber(self, double: float, int: int) -> float: ...
    ...
    def setInterphaseSystem(self, systemInterface: jneqsim.thermo.system.SystemInterface) -> None: ...
    def setLengthOfNode(self, double: float) -> None: ...
    def setOperations(self, thermodynamicOperations: jneqsim.thermodynamicoperations.ThermodynamicOperations) -> None: ...
    def setPhaseFraction(self, int: int, double: float) -> None: ...
    @typing.overload
    def setVelocity(self, double: float) -> None: ...
    @typing.overload
