...
class FluidBoundaryInterface(java.lang.Cloneable):
    ...
    def getBulkSystemOpertions(self) -> jneqsim.thermodynamicoperations.ThermodynamicOperations: ...
    def getEffectiveMassTransferCoefficient(self, int: int, int2: int) -> float: ...
    def getEnhancementFactor(self) -> jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary.filmmodelboundary.reactivefilmmodel.enhancementfactor.EnhancementFactor: ...
...
class FluidBoundary(FluidBoundaryInterface, java.io.Serializable):
    ...
    def getInterphaseHeatFlux(self, int: int) -> float: ...
    def getInterphaseMolarFlux(self, int: int) -> float: ...
    def getInterphaseOpertions(self) -> jneqsim.thermodynamicoperations.ThermodynamicOperations: ...
    def getInterphaseSystem(self) -> jneqsim.thermo.system.SystemInterface: ...
    def getMassTransferCoefficientMatrix(self) -> typing.MutableSequence[Jama.Matrix]: ...
    def heatTransSolve(self) -> None: ...
    def init(self) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    equilibriumfluidboundary: jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.equilibriumfluidboundary.__module_protocol__
    finitevolumeboundary: jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.finitevolumeboundary.__module_protocol__
    nonequilibriumfluidboundary: jneqsim.fluidmechanics.flownode.fluidboundary.heatmasstransfercalc.nonequilibriumfluidboundary.__module_protocol__
