...
class SolidPhysicalPropertyMethod(jneqsim.physicalproperties.methods.PhysicalPropertyMethod):
...
class __module_protocol__(Protocol):
    ...
    conductivity: jneqsim.physicalproperties.methods.solidphysicalproperties.conductivity.__module_protocol__
    density: jneqsim.physicalproperties.methods.solidphysicalproperties.density.__module_protocol__
    diffusivity: jneqsim.physicalproperties.methods.solidphysicalproperties.diffusivity.__module_protocol__
    viscosity: jneqsim.physicalproperties.methods.solidphysicalproperties.viscosity.__module_protocol__
