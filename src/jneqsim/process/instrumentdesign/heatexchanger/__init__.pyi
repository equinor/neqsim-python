...
class HeatExchangerInstrumentDesign(jneqsim.process.instrumentdesign.InstrumentDesign):
    ...
    def getHeatExchangerType(self) -> 'HeatExchangerInstrumentDesign.HeatExchangerType': ...
    def setHeatExchangerType(self, heatExchangerType: 'HeatExchangerInstrumentDesign.HeatExchangerType') -> None: ...
    class HeatExchangerType(java.lang.Enum['HeatExchangerInstrumentDesign.HeatExchangerType']):
        ...
        ELECTRIC_HEATER: typing.ClassVar['HeatExchangerInstrumentDesign.HeatExchangerType'] = ...
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'HeatExchangerInstrumentDesign.HeatExchangerType': ...
        @staticmethod
        def values() -> typing.MutableSequence['HeatExchangerInstrumentDesign.HeatExchangerType']: ...
