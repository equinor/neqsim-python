...
class MassBalanceLeakDetector(java.io.Serializable):
    ...
    @staticmethod
    def fromPipe(pipeLineInterface: jneqsim.process.equipment.pipeline.PipeLineInterface) -> 'MassBalanceLeakDetector': ...
    ...
    def setFlowMeasurementUncertaintyFraction(self, double: float) -> 'MassBalanceLeakDetector': ...
    def setLinepackVolumeM3(self, double: float) -> 'MassBalanceLeakDetector': ...
    def setPressureUncertaintyBara(self, double: float) -> 'MassBalanceLeakDetector': ...
    def setTemperatureUncertaintyK(self, double: float) -> 'MassBalanceLeakDetector': ...
    class LeakDetectionSensitivityResult(java.io.Serializable):
        def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, double8: float, double9: float, double10: float): ...
