...
class SoftSensor(jneqsim.process.measurementdevice.StreamMeasurementDeviceBaseClass):
    def __init__(self, string: typing.Union[java.lang.String, str], streamInterface: jneqsim.process.equipment.stream.StreamInterface, propertyType: 'SoftSensor.PropertyType'): ...
    @typing.overload
    def estimate(self) -> float: ...
    @typing.overload
    def estimate(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> float: ...
    ...
    def getUncertaintyBounds(self, double: float, double2: float) -> 'UncertaintyBounds': ...
    def setInput(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    def setInputs(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], float], typing.Mapping[typing.Union[java.lang.String, str], float]]) -> None: ...
    ...
    class PropertyType(java.lang.Enum['SoftSensor.PropertyType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'SoftSensor.PropertyType': ...
        @staticmethod
...
class VFMResult(java.io.Serializable):
    ...
    class Builder:
        def __init__(self): ...
        def addProperty(self, string: typing.Union[java.lang.String, str], double: float) -> 'VFMResult.Builder': ...
        def build(self) -> 'VFMResult': ...
        @typing.overload
        def gasFlowRate(self, double: float, double2: float, string: typing.Union[java.lang.String, str]) -> 'VFMResult.Builder': ...
        @typing.overload
        def gasFlowRate(self, double: float, string: typing.Union[java.lang.String, str]) -> 'VFMResult.Builder': ...
        @typing.overload
        def oilFlowRate(self, double: float, double2: float, string: typing.Union[java.lang.String, str]) -> 'VFMResult.Builder': ...
        @typing.overload
        def oilFlowRate(self, double: float, string: typing.Union[java.lang.String, str]) -> 'VFMResult.Builder': ...
        def quality(self, quality: 'VFMResult.Quality') -> 'VFMResult.Builder': ...
        def timestamp(self, instant: typing.Union[java.time.Instant, datetime.datetime]) -> 'VFMResult.Builder': ...
        @typing.overload
        def waterFlowRate(self, double: float, double2: float, string: typing.Union[java.lang.String, str]) -> 'VFMResult.Builder': ...
        @typing.overload
        def waterFlowRate(self, double: float, string: typing.Union[java.lang.String, str]) -> 'VFMResult.Builder': ...
    class Quality(java.lang.Enum['VFMResult.Quality']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'VFMResult.Quality': ...
        @staticmethod
        def values() -> typing.MutableSequence['VFMResult.Quality']: ...

class VirtualFlowMeter(jneqsim.process.measurementdevice.StreamMeasurementDeviceBaseClass):
    ...
    @typing.overload
    def calculateFlowRates(self, double: float, double2: float, double3: float) -> VFMResult: ...
    def calibrate(self, list: java.util.List['VirtualFlowMeter.WellTestData']) -> None: ...
    ...
    class WellTestData:
        def __init__(self, instant: typing.Union[java.time.Instant, datetime.datetime], double: float, double2: float, double3: float, double4: float, double5: float, double6: float): ...
