...
class PredictionResult(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, duration: java.time.Duration, string: typing.Union[java.lang.String, str]): ...
    def addAssumption(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def addPredictedValue(self, string: typing.Union[java.lang.String, str], predictedValue: 'PredictionResult.PredictedValue') -> None: ...
    def addViolation(self, constraintViolation: 'PredictionResult.ConstraintViolation') -> None: ...
    ...
    def getValue(self, string: typing.Union[java.lang.String, str]) -> 'PredictionResult.PredictedValue': ...
    ...
    def setStatus(self, predictionStatus: 'PredictionResult.PredictionStatus') -> None: ...
    class ConstraintViolation(java.io.Serializable):
        def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], double: float, double2: float, string3: typing.Union[java.lang.String, str], duration: java.time.Duration, severity: 'PredictionResult.ConstraintViolation.Severity'): ...
        ...
        def setSuggestedAction(self, string: typing.Union[java.lang.String, str]) -> None: ...
        class Severity(java.lang.Enum['PredictionResult.ConstraintViolation.Severity']):
            ...
            CRITICAL: typing.ClassVar['PredictionResult.ConstraintViolation.Severity'] = ...
            ...
            @typing.overload
            @staticmethod
            def valueOf(string: typing.Union[java.lang.String, str]) -> 'PredictionResult.ConstraintViolation.Severity': ...
            @staticmethod
            def values() -> typing.MutableSequence['PredictionResult.ConstraintViolation.Severity']: ...
    class PredictedValue(java.io.Serializable):
        @typing.overload
        def __init__(self, double: float, double2: float, double3: float, string: typing.Union[java.lang.String, str], double4: float): ...
        @typing.overload
        def __init__(self, double: float, double2: float, string: typing.Union[java.lang.String, str]): ...
        @staticmethod
        def deterministic(double: float, string: typing.Union[java.lang.String, str]) -> 'PredictionResult.PredictedValue': ...
    ...
    class PredictionStatus(java.lang.Enum['PredictionResult.PredictionStatus']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'PredictionResult.PredictionStatus': ...
        @staticmethod
