...
from neqsim.process import (clearProcess, compressor, compressorChart,
                            compressorStoneWallCurve, compressorSurgeCurve,
                            runProcess, stream)
...
flow = [[453.2, 600.0, 750.0, 800.0], [453.2, 600.0, 750.0, 800.0],
        [453.2, 600.0, 750.0, 800.0], [453.2, 600.0, 750.0, 800.0]]
head = [[10000.0, 9000.0, 8000.0, 7500.0], [10000.0, 9000.0, 8000.0, 7500.0], [
    10000.0, 9000.0, 8000.0, 7500.0], [10000.0, 9000.0, 8000.0, 7500.0]]
polyEff = [[90.0, 91.0, 89.0, 88.0], [90.0, 91.0, 89.0, 88.0],
...
compressorStoneWallCurve(compressor2, curveConditions,
