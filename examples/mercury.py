...
gascondensateFluid = fluid_df(gascondensatedf, lastIsPlusFraction=True).setModel(
    "SRK-TwuCoon-EOS"
)
...
print(
    "T trip ",
    gascondensateFluid.getPhase(0).getComponent("mercury").getTriplePointTemperature(),
)
