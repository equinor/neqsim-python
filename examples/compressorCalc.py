...
from neqsim.process import clearProcess, stream,  compressor, runProcess , compressorChart
import pandas as pd
...
polytropicheadmeter = [[18882.3055, 18235.1912, 17531.6259, 16489.7195, 15037.1474, 13618.7919]]
polytropicefficiency = [[72.54, 74.44, 74.5 , 74.66, 72.66, 70.19]]

compressorChart(compressor2, curveConditions, speed, flow, polytropicheadmeter,  polytropicefficiency)
