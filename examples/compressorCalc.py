...
"""
import pandas as pd
from neqsim.process import (clearProcess, compressor, compressorChart,
                            runProcess, stream)
...
naturalgas = {'ComponentName':  ["nitrogen", "CO2", "methane", "ethane", "propane", "i-butane", "n-butane", "i-pentane", "n-pentane", "n-hexane"],
              'MolarComposition[-]':  [0.633, 1.371, 85.697, 6.914, 3.086, 0.475, 0.886, 0.242, 0.254, 0.016]
              }
...
polytropicheadmeter = [[18882.3055, 18235.1912,
                        17531.6259, 16489.7195, 15037.1474, 13618.7919]]
polytropicefficiency = [[72.54, 74.44, 74.5, 74.66, 72.66, 70.19]]

compressorChart(compressor2, curveConditions, speed, flow,
                polytropicheadmeter,  polytropicefficiency)
...
print('compressor speed ', compressor2.getCompressorChart().getSpeed(
    flowRate, polytropicHead))
...
polytropicHead = compressor2.getPolytropicHead()
flowRate = stream1.getThermoSystem().getFlowRate("m3/hr")
print('Method 2. Run calculation with given flow, T and P at inlet and P out (compressor curves are not used)')
print('pressure out ', compressor2.getOutletPressure())
print('temperature out ', compressor2.getOutTemperature()-273.15, " C")
print('polytropic head ', compressor2.getPolytropicHead(), " meter")
print('polytropic efficiency ', compressor2.getPolytropicEfficiency())
