...
CME(fluid1, pressure, temperature, saturationpressure, relativevolume,
...
CVD(fluid1, pressure, temperature, relativevolume,
...
difflib(fluid1.clone(), pressure, temperature, relativevolume, Bo, Bg,
        relativegravity, Zgas, gasstandardvolume, Rs, oildensity, relativegravity)
...
swellingtest(fluid1, injectiongas, temperature,
             molPercentInjected, pressure, relativeoilvolume)
